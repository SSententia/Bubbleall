...
public class NotificationCompat {
    ...
    public static class MediaStyle extends androidx.core.app.NotificationCompat.Style {
        ...
        RemoteViews generateContentView() {
            ...
            remoteViewsApplyStandardTemplate.removeAllViews(C0501R.id.media_actions);
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    if (i >= size) {
                        throw new IllegalArgumentException(String.format("setShowActionsInCompactView: action %d out of bounds (max %d)", Integer.valueOf(i), Integer.valueOf(size - 1)));
                    }
                    remoteViewsApplyStandardTemplate.addView(C0501R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0501R.id.end_padder, 8);
                remoteViewsApplyStandardTemplate.setViewVisibility(C0501R.id.cancel_action, 0);
                remoteViewsApplyStandardTemplate.setOnClickPendingIntent(C0501R.id.cancel_action, this.mCancelButtonIntent);
                remoteViewsApplyStandardTemplate.setInt(C0501R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0501R.integer.cancel_button_image_alpha));
            } else {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0501R.id.end_padder, 0);
                remoteViewsApplyStandardTemplate.setViewVisibility(C0501R.id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(androidx.core.app.NotificationCompat.Action action) {
            ...
            Api15Impl.setContentDescription(remoteViews, C0501R.id.action0, action.getTitle());
            return remoteViews;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0501R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0501R.id.cancel_action, 0);
        ...
        int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0501R.layout.notification_template_big_media_narrow;
            }
            return C0501R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0501R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0501R.layout.notification_template_big_media_narrow_custom;
            }
            return C0501R.layout.notification_template_big_media_custom;
        }
