...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARN: Code duplicated, block: B:106:0x0179 A[ADDED_TO_REGION] */
        ...
        /* JADX WARN: Code duplicated, block: B:126:0x01d8  */
        /* JADX WARN: Code duplicated, block: B:129:0x01e7  */
        /* JADX WARN: Code duplicated, block: B:130:0x01ee  */
        /* JADX WARN: Code duplicated, block: B:133:0x01f3  */
        /* JADX WARN: Code duplicated, block: B:136:0x01fd  */
        /* JADX WARN: Code duplicated, block: B:137:0x0204  */
        /* JADX WARN: Code duplicated, block: B:140:0x0209  */
        /* JADX WARN: Code duplicated, block: B:143:0x0213 A[ADDED_TO_REGION] */
        /* JADX WARN: Code duplicated, block: B:145:0x021d A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:146:0x021f A[ADDED_TO_REGION] */
        /* JADX WARN: Code duplicated, block: B:149:0x022a A[ADDED_TO_REGION] */
        /* JADX WARN: Code duplicated, block: B:153:0x0231  */
        /* JADX WARN: Code duplicated, block: B:155:0x0235  */
        /* JADX WARN: Code duplicated, block: B:157:0x023b  */
        /* JADX WARN: Code duplicated, block: B:160:0x0252  */
        /* JADX WARN: Code duplicated, block: B:161:0x0254  */
        /* JADX WARN: Code duplicated, block: B:164:0x025a  */
        /* JADX WARN: Code duplicated, block: B:168:0x0262  */
        /* JADX WARN: Code duplicated, block: B:171:0x0269  */
        /* JADX WARN: Code duplicated, block: B:172:0x026b  */
        /* JADX WARN: Code duplicated, block: B:174:0x026e  */
        /* JADX WARN: Code duplicated, block: B:42:0x00bf A[DONT_INVERT] */
        /* JADX WARN: Code duplicated, block: B:43:0x00c1 A[DONT_INVERT] */
        ...
        /* JADX WARN: Code duplicated, block: B:63:0x00fb A[ADDED_TO_REGION] */
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            int i9 = C02021.f50xdde91696[dimensionBehaviour.ordinal()];
            if (i9 == 1) {
                int iMakeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(i5, BasicMeasure.EXACTLY);
                ...
                if (i9 == 2) {
                    ...
                    iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i8 + constraintWidget.getHorizontalMargin(), -1);
                    ...
                    if (measure.useCurrentDimensions) {
                        ...
                        i = C02021.f50xdde91696[dimensionBehaviour2.ordinal()];
                        if (i == 1) {
                                ...
                                if (i == 3) {
                                    ...
                                    if (measure.useCurrentDimensions && z3 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z4 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                                        ...
                                        if (z2) {
                                            ...
                                            constraintWidget.wrapMeasure[1] = i2;
                                            constraintWidget.wrapMeasure[3] = i2;
                                        }
                                        if (constraintWidget.mMatchConstraintMinWidth > 0) {
                                            iMin = Math.max(constraintWidget.mMatchConstraintMinWidth, measuredWidth);
                                        } else {
                                            iMin = measuredWidth;
                                        }
                                        if (constraintWidget.mMatchConstraintMaxWidth > 0) {
                                            iMin = Math.min(constraintWidget.mMatchConstraintMaxWidth, iMin);
                                        }
                                        if (constraintWidget.mMatchConstraintMinHeight > 0) {
                                            iMin2 = Math.max(constraintWidget.mMatchConstraintMinHeight, measuredHeight);
                                        } else {
                                            iMin2 = measuredHeight;
                                        }
                                        if (constraintWidget.mMatchConstraintMaxHeight > 0) {
                                            iMin2 = Math.min(constraintWidget.mMatchConstraintMaxHeight, iMin2);
                                        }
                                        if (!z7 && z5) {
                                        ...
                                        if (measuredWidth == iMin || measuredHeight != iMin2) {
                                            if (measuredWidth != iMin) {
                                                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMin, BasicMeasure.EXACTLY);
                                            }
                                            if (measuredHeight != iMin2) {
                                                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(iMin2, BasicMeasure.EXACTLY);
                                            }
                                            view.measure(iMakeMeasureSpec, iMakeMeasureSpec2);
                                    ...
                                    measure.measuredNeedsSolverPass = z9;
                                    if (layoutParams.needsBaseline) {
                                        z10 = 1;
                                    } else {
                                        z10 = i4;
                                    }
                                    if (z10 != 0 && baseline != -1 && constraintWidget.getBaselineDistance() != baseline) {
    ...
    static /* synthetic */ class C02021 {
        ...
        static final /* synthetic */ int[] f50xdde91696;
        ...
        static {
            ...
            try {
                f50xdde91696[ConstraintWidget.DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f50xdde91696[ConstraintWidget.DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f50xdde91696[ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0203R.styleable.ConstraintLayout_Layout, i, i2);
 ...
 binds: [B:9:0x0027, B:5:0x0019] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0203R.styleable.ConstraintLayout_Layout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
