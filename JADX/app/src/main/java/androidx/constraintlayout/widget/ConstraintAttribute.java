...
public class ConstraintAttribute {
    ...
    static /* synthetic */ class C02011 {
        ...
        static {
            ...
            try {
                f49x66adad53[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49x66adad53[AttributeType.INT_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f49x66adad53[AttributeType.FLOAT_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f49x66adad53[AttributeType.STRING_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f49x66adad53[AttributeType.BOOLEAN_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f49x66adad53[AttributeType.DIMENSION_TYPE.ordinal()] = 7;
    ...
    public int noOfInterpValues() {
        int i = C02011.f49x66adad53[this.mType.ordinal()];
        return (i == 1 || i == 2) ? 4 : 1;
    }

    public float getValueToInterpolate() {
        switch (C02011.f49x66adad53[this.mType.ordinal()]) {
            case 1:
            case 2:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            String str2 = "set" + str;
            try {
                switch (C02011.f49x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    public static void parse(Context context, XmlPullParser xmlPullParser, HashMap<String, ConstraintAttribute> map) {
        ...
        Object string;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0203R.styleable.CustomAttribute);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0203R.styleable.CustomAttribute_attributeName) {
                ...
                } else if (index == C0203R.styleable.CustomAttribute_customStringValue) {
