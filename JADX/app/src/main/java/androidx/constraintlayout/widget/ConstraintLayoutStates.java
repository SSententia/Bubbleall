...
public class ConstraintLayoutStates {
    ...
    static class State {
        ...
        public State(Context context, XmlPullParser xmlPullParser) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0203R.styleable.State);
    ...
    static class Variant {
        ...
        public Variant(Context context, XmlPullParser xmlPullParser) {
            ...
            this.mConstraintID = -1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0203R.styleable.Variant);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            if (MediaConstants.MEDIA_URI_QUERY_ID.equals(xmlPullParser.getAttributeName(i))) {
                String attributeValue = xmlPullParser.getAttributeValue(i);
                int identifier = attributeValue.contains("/") ? context.getResources().getIdentifier(attributeValue.substring(attributeValue.indexOf(47) + 1), MediaConstants.MEDIA_URI_QUERY_ID, context.getPackageName()) : -1;
                if (identifier == -1) {
