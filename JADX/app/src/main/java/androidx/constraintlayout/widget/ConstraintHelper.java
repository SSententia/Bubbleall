...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0203R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
    ...
    private int findId(String str) {
        ...
        if (iFindId == 0) {
            try {
                iFindId = C0203R.id.class.getField(str).getInt(null);
            } catch (Exception unused) {
            }
        }
        return iFindId == 0 ? this.myContext.getResources().getIdentifier(str, MediaConstants.MEDIA_URI_QUERY_ID, this.myContext.getPackageName()) : iFindId;
    }
