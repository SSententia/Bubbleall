...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C01941 {
        ...
        static {
            ...
            try {
                f45xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f45xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i2;
        int i3 = C01941.f45xbf6f0c8e[this.mRunType.ordinal()];
        if (i3 == 1) {
