...
public class MotionController {
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        ...
        float f5 = this.mStartMotionPath.f32x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f33y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < i3; i18++) {
                ...
                dArr6[i18][0] = motionPathsArr[i18].f32x;
                dArr6[i18][1] = motionPathsArr[i18].f33y;
            }
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f2 = this.mStartMotionPath.f32x + ((this.mEndMotionPath.f32x - this.mStartMotionPath.f32x) * adjustedPosition);
            float f3 = this.mStartMotionPath.f33y + ((this.mEndMotionPath.f33y - this.mStartMotionPath.f33y) * adjustedPosition);
            float f4 = f2 + 0.5f;
            int i3 = (int) f4;
            float f5 = f3 + 0.5f;
            int i4 = (int) f5;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f32x - this.mStartMotionPath.f32x;
        float f6 = this.mEndMotionPath.f33y - this.mStartMotionPath.f33y;
