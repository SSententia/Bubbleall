...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    void setState(TransitionState transitionState) {
        ...
        int i = C01802.f30xabc7e4ac[transitionState2.ordinal()];
        if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C01802 {
        ...
        static {
            ...
            try {
                f30xabc7e4ac[TransitionState.SETUP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f30xabc7e4ac[TransitionState.MOVING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f30xabc7e4ac[TransitionState.FINISHED.ordinal()] = 4;
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintAnchor != null) {
                strConcat = RequestConfiguration.MAX_AD_CONTENT_RATING_T.concat(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "B");
            } else {
                strConcat = "__";
            }
            sb.append(strConcat);
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = constraintWidget.mTop.mTarget != null ? RequestConfiguration.MAX_AD_CONTENT_RATING_T : "_";
                StringBuilder sb = new StringBuilder();
                sb.append(str4);
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0203R.styleable.MotionLayout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0203R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, typedArrayObtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C0203R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = typedArrayObtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C0203R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = typedArrayObtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C0203R.styleable.MotionLayout_applyMotionScene) {
                    z = typedArrayObtainStyledAttributes.getBoolean(index, z);
                } else if (index == C0203R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = typedArrayObtainStyledAttributes.getBoolean(index, false) ? 2 : 0;
                    }
                } else if (index == C0203R.styleable.MotionLayout_motionDebug) {
