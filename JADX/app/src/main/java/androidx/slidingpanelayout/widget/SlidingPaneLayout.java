            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    ...
                    if (layoutParams.width == -2) {
                        ...
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, BasicMeasure.EXACTLY);
                    }
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(iMax3 - i12, BasicMeasure.EXACTLY), iMakeMeasureSpec3);
                        if (i11 != 0) {
