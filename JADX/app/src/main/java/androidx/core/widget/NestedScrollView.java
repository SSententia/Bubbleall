...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0207R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = Cea708CCParser.Const.CODE_C1_CW2;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, Cea708CCParser.Const.CODE_C1_CW2);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(Cea708CCParser.Const.CODE_C1_CW2)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (keyEvent.isAltPressed()) {
                return fullScroll(Cea708CCParser.Const.CODE_C1_CW2);
            }
            return arrowScroll(Cea708CCParser.Const.CODE_C1_CW2);
        }
        if (keyCode == 62) {
        ...
        pageScroll(Cea708CCParser.Const.CODE_C1_CW2);
        return false;
    }
