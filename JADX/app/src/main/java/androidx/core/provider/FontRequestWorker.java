...
class FontRequestWorker {
    ...
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, SessionCommand.COMMAND_CODE_PLAYER_PLAY);
