...
public final class MailTo {
    ...
    private static final String f62CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* JADX INFO: renamed from: TO */
    private static final String f63TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        mailTo.mHeaders.put(f63TO, strDecode);
        return mailTo;
    }
    ...
    public String getTo() {
        return this.mHeaders.get(f63TO);
    }

    public String getCc() {
        return this.mHeaders.get(f62CC);
    }
