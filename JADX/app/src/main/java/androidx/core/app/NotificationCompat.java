...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m13m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(SearchView$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(SearchView$$ExternalSyntheticApiModelOutline0.m$2().getName())) {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C0207R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0207R.id.icon, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0207R.dimen.notification_right_icon_size);
                    remoteViews.setImageViewBitmap(C0207R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(C0207R.dimen.notification_small_icon_background_padding) * 2), this.mBuilder.getColor()));
                    remoteViews.setViewVisibility(C0207R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0207R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0207R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0207R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0207R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0207R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0207R.id.title, this.mBuilder.mContentTitle);
            }
            boolean z5 = true;
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0207R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0207R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0207R.id.info, 0);
            } else {
                if (this.mBuilder.mNumber > 0) {
                    if (this.mBuilder.mNumber > resources.getInteger(C0207R.integer.status_bar_notification_info_maxnum)) {
                        remoteViews.setTextViewText(C0207R.id.info, resources.getString(C0207R.string.status_bar_notification_info_overflow));
                    } else {
                        remoteViews.setTextViewText(C0207R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                    }
                    remoteViews.setViewVisibility(C0207R.id.info, 0);
                } else {
                    remoteViews.setViewVisibility(C0207R.id.info, 8);
                    z4 = false;
                }
                if (this.mBuilder.mSubText != null) {
                    remoteViews.setTextViewText(C0207R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText != null) {
                        remoteViews.setTextViewText(C0207R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0207R.id.text2, 0);
                        if (z2) {
                            Api16Impl.setTextViewTextSize(remoteViews, C0207R.id.text, 0, resources.getDimensionPixelSize(C0207R.dimen.notification_subtext_size));
                        }
                        Api16Impl.setViewPadding(remoteViews, C0207R.id.line1, 0, 0, 0, 0);
                    } else {
                        remoteViews.setViewVisibility(C0207R.id.text2, 8);
                    }
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    z5 = z4;
                } else if (this.mBuilder.mUseChronometer) {
                    remoteViews.setViewVisibility(C0207R.id.chronometer, 0);
                    remoteViews.setLong(C0207R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(C0207R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                        Api24Impl.setChronometerCountDown(remoteViews, C0207R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    remoteViews.setViewVisibility(C0207R.id.time, 0);
                    remoteViews.setLong(C0207R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                int i3 = C0207R.id.right_side;
                if (z5) {
                    i2 = 0;
                } else {
                    i2 = 8;
                ...
                remoteViews.setViewVisibility(C0207R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
            z3 = true;
            z4 = true;
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0207R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0207R.id.notification_main_column);
            remoteViews.addView(C0207R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0207R.id.notification_main_column, 0);
            Api16Impl.setViewPadding(remoteViews, C0207R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0207R.id.title, 8);
            remoteViews.setViewVisibility(C0207R.id.text2, 8);
            remoteViews.setViewVisibility(C0207R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0207R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0207R.dimen.notification_top_pad_large_text);
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) messagingStyleCreateMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(SearchView$$ExternalSyntheticApiModelOutline0.m10m((Object) messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m13m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m13m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0207R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0207R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0207R.string.call_notification_screening_text);
        }

        private Action makeNegativeAction() {
            int i = C0207R.drawable.ic_call_decline_low;
            int i2 = C0207R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C0207R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0207R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C0207R.string.call_notification_decline_action, this.mDeclineButtonColor, C0207R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i;
            int i2 = C0207R.drawable.ic_call_answer_video_low;
            int i3 = C0207R.drawable.ic_call_answer_low;
            int i4 = C0207R.drawable.ic_call_answer_video;
            int i5 = C0207R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C0207R.string.call_notification_answer_video_action;
            } else {
                i = C0207R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C0207R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0207R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0207R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(C0207R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C0207R.id.actions, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0207R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0207R.layout.notification_action_tombstone;
            } else {
                i = C0207R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0207R.id.action_image, createColoredBitmap(iconCompat, C0207R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0207R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0207R.id.action_container, action.actionIntent);
            }
            Api15Impl.setContentDescription(remoteViews, C0207R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m648clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m649clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(SearchView$$ExternalSyntheticApiModelOutline0.m13m(it.next())));
                }
            }
        } else {
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0207R.dimen.compat_notification_large_icon_max_width);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0207R.dimen.compat_notification_large_icon_max_height);
