...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i) {
        if (Build.VERSION.SDK_INT >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).getShortcuts(i));
        }
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM106m = ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(shortcutManagerM106m.getManifestShortcuts());
            }
            if ((i & 2) != 0) {
                arrayList.addAll(shortcutManagerM106m.getDynamicShortcuts());
            }
            if ((i & 4) != 0) {
                arrayList.addAll(shortcutManagerM106m.getPinnedShortcuts());
            }
    ...
    public static boolean addDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).isRateLimitingActive();
        }
    ...
    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).getIconMaxWidth();
        }
    ...
    public static int getIconMaxHeight(Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).getIconMaxHeight();
        }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).reportShortcutUsed(str);
        }
    ...
    public static boolean setDynamicShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List dynamicShortcuts = ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m30m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void disableShortcuts(Context context, List<String> list, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(Context context, List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static void removeDynamicShortcuts(Context context, List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).removeAllDynamicShortcuts();
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(Context context, List<String> list) {
        ...
        ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManager shortcutManagerM106m = ColorKt$$ExternalSyntheticApiModelOutline0.m106m(context.getSystemService(ColorKt$$ExternalSyntheticApiModelOutline0.m129m()));
            if (shortcutManagerM106m.isRateLimitingActive()) {
                return false;
            }
            List dynamicShortcuts = shortcutManagerM106m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerM106m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerM106m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
