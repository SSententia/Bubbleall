...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        SearchView$$ExternalSyntheticApiModelOutline0.m50m();
        ShortcutInfo.Builder intents = SearchView$$ExternalSyntheticApiModelOutline0.m18m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m30m((Object) it.next())).build());
        }
        return arrayList;
    }
