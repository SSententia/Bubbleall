...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0207R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0207R.id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0207R.id.tag_window_insets_animation_callback, onApplyWindowInsetsListenerCreateProxyListener);
            if (tag == null) {
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            return view.getTag(C0207R.id.tag_on_apply_window_listener) != null ? windowInsets : view.onApplyWindowInsets(windowInsets);
        }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0207R.id.tag_window_insets_animation_callback);
    ...
    private static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(HalfKt$$ExternalSyntheticApiModelOutline0.m230m(i, interpolator, j));
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM231m = HalfKt$$ExternalSyntheticApiModelOutline0.m231m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM231m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM231m.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m666m$1();
            return HalfKt$$ExternalSyntheticApiModelOutline0.m229m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
