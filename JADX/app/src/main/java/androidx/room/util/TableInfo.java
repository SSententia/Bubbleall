...
public class TableInfo {
    ...
    private static Set<ForeignKey> readForeignKeys(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = cursorQuery.getColumnIndex(MediaConstants.MEDIA_URI_QUERY_ID);
    ...
    private static List<ForeignKeyWithSequence> readForeignKeyFieldMappings(Cursor cursor) {
        int columnIndex = cursor.getColumnIndex(MediaConstants.MEDIA_URI_QUERY_ID);
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            int columnIndex = cursorQuery.getColumnIndex(AppMeasurementSdk.ConditionalUserProperty.NAME);
            int columnIndex2 = cursorQuery.getColumnIndex(AppMeasurementSdk.ConditionalUserProperty.ORIGIN);
