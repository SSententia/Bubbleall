        ...
        */
        public void run() {
            ...
            L1b:
                ...
                r3 = r1
            L27:
                androidx.room.RoomTrackingLiveData r4 = androidx.room.RoomTrackingLiveData.this     // Catch: java.lang.Throwable -> L5f
                java.util.concurrent.atomic.AtomicBoolean r4 = r4.mInvalid     // Catch: java.lang.Throwable -> L5f
                boolean r4 = r4.compareAndSet(r2, r1)     // Catch: java.lang.Throwable -> L5f
                if (r4 == 0) goto L44
                androidx.room.RoomTrackingLiveData r0 = androidx.room.RoomTrackingLiveData.this     // Catch: java.lang.Exception -> L3b java.lang.Throwable -> L5f
                java.util.concurrent.Callable<T> r0 = r0.mComputeFunction     // Catch: java.lang.Exception -> L3b java.lang.Throwable -> L5f
                java.lang.Object r0 = r0.call()     // Catch: java.lang.Exception -> L3b java.lang.Throwable -> L5f
                r3 = r2
                goto L27
            L3b:
                r0 = move-exception
            ...
            L44:
                if (r3 == 0) goto L4b
                androidx.room.RoomTrackingLiveData r4 = androidx.room.RoomTrackingLiveData.this     // Catch: java.lang.Throwable -> L5f
                androidx.room.RoomTrackingLiveData.access$000(r4, r0)     // Catch: java.lang.Throwable -> L5f
            L4b:
                androidx.room.RoomTrackingLiveData r0 = androidx.room.RoomTrackingLiveData.this
                java.util.concurrent.atomic.AtomicBoolean r0 = r0.mComputing
                r0.set(r1)
            ...
            L68:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.room.RoomTrackingLiveData.RunnableC08991.run():void");
        }
    };
