...
import androidx.swiperefreshlayout.C0919R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(C0919R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = typedArrayObtainStyledAttributes.getColor(C0919R.styleable.f97xaa980688, DEFAULT_BACKGROUND_COLOR);
