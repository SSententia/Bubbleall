    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i15 = 0; i15 < i10; i15++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i12) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i17, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i12 - i16, BasicMeasure.EXACTLY);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i12 - i17, BasicMeasure.EXACTLY);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, BasicMeasure.EXACTLY, i16, layoutParams.height, false);
