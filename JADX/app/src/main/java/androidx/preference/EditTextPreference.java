...
public class EditTextPreference extends DialogPreference {
    ...
    public EditTextPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0834R.styleable.EditTextPreference, i, i2);
        if (TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.EditTextPreference_useSimpleSummaryProvider, C0834R.styleable.EditTextPreference_useSimpleSummaryProvider, false)) {
    ...
    public EditTextPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0834R.attr.editTextPreferenceStyle, android.R.attr.editTextPreferenceStyle));
    }
    ...
    public static final class SimpleSummaryProvider implements Preference.SummaryProvider<EditTextPreference> {
        ...
        public CharSequence provideSummary(EditTextPreference editTextPreference) {
            if (TextUtils.isEmpty(editTextPreference.getText())) {
                return editTextPreference.getContext().getString(C0834R.string.not_set);
            }
