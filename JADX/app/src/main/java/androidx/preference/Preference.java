...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLayoutResId = C0834R.layout.preference;
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0834R.styleable.Preference, i, i2);
        this.mIconResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_icon, C0834R.styleable.Preference_android_icon, 0);
        this.mKey = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_key, C0834R.styleable.Preference_android_key);
        this.mTitle = TypedArrayUtils.getText(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_title, C0834R.styleable.Preference_android_title);
        this.mSummary = TypedArrayUtils.getText(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_summary, C0834R.styleable.Preference_android_summary);
        this.mOrder = TypedArrayUtils.getInt(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_order, C0834R.styleable.Preference_android_order, Integer.MAX_VALUE);
        this.mFragment = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_fragment, C0834R.styleable.Preference_android_fragment);
        this.mLayoutResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_layout, C0834R.styleable.Preference_android_layout, C0834R.layout.preference);
        this.mWidgetLayoutResId = TypedArrayUtils.getResourceId(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_widgetLayout, C0834R.styleable.Preference_android_widgetLayout, 0);
        this.mEnabled = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_enabled, C0834R.styleable.Preference_android_enabled, true);
        this.mSelectable = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_selectable, C0834R.styleable.Preference_android_selectable, true);
        this.mPersistent = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_persistent, C0834R.styleable.Preference_android_persistent, true);
        this.mDependencyKey = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_dependency, C0834R.styleable.Preference_android_dependency);
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_allowDividerAbove, C0834R.styleable.Preference_allowDividerAbove, this.mSelectable);
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_allowDividerBelow, C0834R.styleable.Preference_allowDividerBelow, this.mSelectable);
        if (typedArrayObtainStyledAttributes.hasValue(C0834R.styleable.Preference_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_defaultValue);
        } else if (typedArrayObtainStyledAttributes.hasValue(C0834R.styleable.Preference_android_defaultValue)) {
            this.mDefaultValue = onGetDefaultValue(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_android_defaultValue);
        }
        this.mShouldDisableView = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_shouldDisableView, C0834R.styleable.Preference_android_shouldDisableView, true);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C0834R.styleable.Preference_singleLineTitle);
        this.mHasSingleLineTitleAttr = zHasValue;
        if (zHasValue) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_singleLineTitle, C0834R.styleable.Preference_android_singleLineTitle, true);
        }
        this.mIconSpaceReserved = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_iconSpaceReserved, C0834R.styleable.Preference_android_iconSpaceReserved, false);
        this.mVisible = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_isPreferenceVisible, C0834R.styleable.Preference_isPreferenceVisible, true);
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, C0834R.styleable.Preference_enableCopying, C0834R.styleable.Preference_enableCopying, false);
    ...
    public Preference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0834R.attr.preferenceStyle, android.R.attr.preferenceStyle));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        View viewFindViewById = preferenceViewHolder.findViewById(C0834R.id.icon_frame);
    ...
    private static class OnPreferenceCopyListener implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add(0, 0, 0, C0834R.string.copy).setOnMenuItemClickListener(this);
        }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            Toast.makeText(this.mPreference.getContext(), this.mPreference.getContext().getString(C0834R.string.preference_copied, summary), 0).show();
            return true;
        }
    }
}
