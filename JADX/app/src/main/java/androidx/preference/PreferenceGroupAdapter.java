...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes((AttributeSet) null, C0834R.styleable.BackgroundStyle);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(C0834R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
