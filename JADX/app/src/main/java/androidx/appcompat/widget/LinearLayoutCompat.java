...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mDividerId = propertyMapper.mapObject("divider", C0051R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt("dividerPadding", C0051R.attr.dividerPadding);
            this.mMeasureWithLargestChildId = propertyMapper.mapBoolean("measureWithLargestChild", C0051R.attr.measureWithLargestChild);
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", C0051R.attr.showDividers, new IntFunction<Set<String>>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.2
                @Override // java.util.function.IntFunction
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0051R.styleable.LinearLayoutCompat, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0051R.styleable.LinearLayoutCompat, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i, 0);
        ...
        boolean z = tintTypedArrayObtainStyledAttributes.getBoolean(C0051R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
                            ...
                            if (f4 > 0.0f) {
                                ...
                                if (layoutParams3.height == 0) {
                                    ...
                                    if (i34 == 1073741824) {
                                        ...
                                        virtualChildAt3.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(i40, BasicMeasure.EXACTLY));
                                    }
