...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        int resourceId = z ? typedArrayObtainStyledAttributes.getResourceId(C0051R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(C0051R.styleable.View_theme, 0)) != 0) {
