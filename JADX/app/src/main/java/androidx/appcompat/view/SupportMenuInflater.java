...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (tintTypedArrayObtainStyledAttributes.getInt(C0051R.styleable.MenuItem_android_menuCategory, this.groupCategory) & SupportMenu.CATEGORY_MASK) | (tintTypedArrayObtainStyledAttributes.getInt(C0051R.styleable.MenuItem_android_orderInCategory, this.groupOrder) & SupportMenu.USER_MASK);
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(C0051R.styleable.MenuItem_android_checkable)) {
                this.itemCheckable = tintTypedArrayObtainStyledAttributes.getBoolean(C0051R.styleable.MenuItem_android_checkable, false) ? 1 : 0;
            } else {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(C0051R.styleable.MenuItem_iconTintMode)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C0051R.styleable.MenuItem_iconTintMode, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            if (tintTypedArrayObtainStyledAttributes.hasValue(C0051R.styleable.MenuItem_iconTint)) {
                this.itemIconTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(C0051R.styleable.MenuItem_iconTint);
            } else {
