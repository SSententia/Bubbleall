...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo683clone = transition.mo683clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo683clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo683clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo683clone);
    }
    ...
    public static void m328go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* JADX INFO: renamed from: go */
    public static void m329go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo683clone = transition.mo683clone();
        sceneChangeSetup(viewGroup, transitionMo683clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo683clone);
    }
