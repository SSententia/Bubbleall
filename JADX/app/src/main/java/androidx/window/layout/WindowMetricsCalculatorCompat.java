    ...
    private final DisplayCutout getCutoutForDisplay(Display display) {
        try {
            ...
            if (Trace$$ExternalSyntheticApiModelOutline0.m$1(obj)) {
                return Trace$$ExternalSyntheticApiModelOutline0.m285m(obj);
            }
