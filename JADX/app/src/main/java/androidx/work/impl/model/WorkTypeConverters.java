...
public class WorkTypeConverters {
    ...
    public static int stateToInt(WorkInfo.State state) {
        switch (C10771.$SwitchMap$androidx$work$WorkInfo$State[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C10771.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C10771.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int outOfQuotaPolicyToInt(OutOfQuotaPolicy policy) {
        int i = C10771.$SwitchMap$androidx$work$OutOfQuotaPolicy[policy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
