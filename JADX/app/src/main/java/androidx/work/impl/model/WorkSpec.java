...
public final class WorkSpec {
    ...
    public int hashCode() {
        int iHashCode = ((((this.f102id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object o) {
            ...
            return this.f103id.equals(idAndState.f103id);
        }

        public int hashCode() {
            return (this.f103id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f104id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (str == null ? workInfoPojo.f104id != null : !str.equals(workInfoPojo.f104id)) {
                return false;
            }
