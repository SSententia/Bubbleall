...
class MediaControllerStub extends IMediaController.Stub {
    ...
    MediaControllerStub(MediaControllerImplBase mediaControllerImplBase) {
    ...
    public void onSessionResult(final int i, final ParcelImpl parcelImpl) {
        ...
        dispatchControllerTask(new ControllerTask() { // from class: androidx.media2.session.MediaControllerStub$$ExternalSyntheticLambda0
            @Override // androidx.media2.session.MediaControllerStub.ControllerTask
            public final void run(MediaControllerImplBase mediaControllerImplBase) {
                mediaControllerImplBase.setFutureResult(i, MediaParcelUtils.fromParcelable(parcelImpl));
            }
        });
    }
    ...
    public void onLibraryResult(final int i, final ParcelImpl parcelImpl) {
        ...
        dispatchBrowserTask(new BrowserTask() { // from class: androidx.media2.session.MediaControllerStub$$ExternalSyntheticLambda1
            ...
            public final void run(MediaBrowserImplBase mediaBrowserImplBase) {
                mediaBrowserImplBase.setFutureResult(i, MediaParcelUtils.fromParcelable(parcelImpl));
            }
        });
    }
    ...
    public void onPlayerStateChanged(int i, final long j, final long j2, final int i2) {
        dispatchControllerTask(new ControllerTask() { // from class: androidx.media2.session.MediaControllerStub.2
            @Override // androidx.media2.session.MediaControllerStub.ControllerTask
            public void run(MediaControllerImplBase mediaControllerImplBase) {
    ...
    public void onSearchResultChanged(int i, final String str, final int i2, final ParcelImpl parcelImpl) throws RuntimeException {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            dispatchBrowserTask(new BrowserTask() { // from class: androidx.media2.session.MediaControllerStub.20
                @Override // androidx.media2.session.MediaControllerStub.BrowserTask
    ...
    public void onChildrenChanged(int i, final String str, final int i2, final ParcelImpl parcelImpl) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            dispatchBrowserTask(new BrowserTask() { // from class: androidx.media2.session.MediaControllerStub.21
                @Override // androidx.media2.session.MediaControllerStub.BrowserTask
                public void run(MediaBrowserImplBase mediaBrowserImplBase) {
