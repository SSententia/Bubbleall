...
public final class SessionCommand implements VersionedParcelable {
    ...
    static {
        ...
        sparseArray.put(1, Arrays.asList(Integer.valueOf(COMMAND_CODE_PLAYER_PLAY), Integer.valueOf(COMMAND_CODE_PLAYER_PAUSE), Integer.valueOf(COMMAND_CODE_PLAYER_PREPARE), Integer.valueOf(COMMAND_CODE_PLAYER_SEEK_TO), Integer.valueOf(COMMAND_CODE_PLAYER_SET_SPEED), Integer.valueOf(COMMAND_CODE_PLAYER_SET_SURFACE), Integer.valueOf(COMMAND_CODE_PLAYER_SELECT_TRACK), Integer.valueOf(COMMAND_CODE_PLAYER_DESELECT_TRACK)));
