...
class MediaLibraryServiceLegacyStub extends MediaSessionServiceLegacyStub {
    ...
    MediaSession.ControllerInfo createControllerInfo(androidx.media.MediaSessionManager.RemoteUserInfo remoteUserInfo) {
    ...
    MediaSession.ControllerCb getBrowserLegacyCbForBroadcast() {
    ...
    private static class SearchRequest {
        ...
        public final androidx.media.MediaSessionManager.RemoteUserInfo mRemoteUserInfo;
        public final MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> mResult;

        SearchRequest(MediaSession.ControllerInfo controllerInfo, androidx.media.MediaSessionManager.RemoteUserInfo remoteUserInfo, String str, Bundle bundle, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> result) {
    ...
    private static abstract class BaseBrowserLegacyCb extends MediaSession.ControllerCb {
        ...
        final void onAllowedCommandsChanged(int i, SessionCommandGroup sessionCommandGroup) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onBufferingStateChanged(int i, MediaItem mediaItem, int i2, long j, long j2, long j3) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onCurrentMediaItemChanged(int i, MediaItem mediaItem, int i2, int i3, int i4) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onDisconnected(int i) throws RemoteException {
        }
        ...
        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlaybackCompleted(int i) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlaybackInfoChanged(int i, MediaController.PlaybackInfo playbackInfo) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlaybackSpeedChanged(int i, long j, long j2, float f) throws RemoteException {
        }
        ...
        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlayerStateChanged(int i, long j, long j2, int i2) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlaylistChanged(int i, List<MediaItem> list, MediaMetadata mediaMetadata, int i2, int i3, int i4) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onPlaylistMetadataChanged(int i, MediaMetadata mediaMetadata) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onRepeatModeChanged(int i, int i2, int i3, int i4, int i5) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onSeekCompleted(int i, long j, long j2, long j3) throws RemoteException {
        }
        ...
        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onShuffleModeChanged(int i, int i2, int i3, int i4, int i5) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onSubtitleData(int i, MediaItem mediaItem, SessionPlayer.TrackInfo trackInfo, SubtitleData subtitleData) {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onTrackDeselected(int i, SessionPlayer.TrackInfo trackInfo) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void onTrackSelected(int i, SessionPlayer.TrackInfo trackInfo) throws RemoteException {
        }
        ...
        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void sendCustomCommand(int i, SessionCommand sessionCommand, Bundle bundle) throws RemoteException {
        }

        @Override // androidx.media2.session.MediaSession.ControllerCb
        final void setCustomLayout(int i, List<MediaSession.CommandButton> list) throws RemoteException {
        }
    ...
    private final class BrowserLegacyCb extends BaseBrowserLegacyCb {
        ...
        BrowserLegacyCb(androidx.media.MediaSessionManager.RemoteUserInfo remoteUserInfo) {
            super();
                ...
                MediaLibraryServiceLegacyStub.this.mLibrarySessionImpl.getCallbackExecutor().execute(new Runnable() { // from class: androidx.media2.session.MediaLibraryServiceLegacyStub.BrowserLegacyCb.1
                    ...
                    public void run() {
                        ...
                        for (int i7 = 0; i7 < arrayList.size(); i7++) {
                            ...
                            if (searchRequest2.mExtras != null) {
                                try {
                                    searchRequest2.mExtras.setClassLoader(MediaLibraryServiceLegacyStub.this.mLibrarySessionImpl.getContext().getClassLoader());
        ...
        void registerSearchRequest(MediaSession.ControllerInfo controllerInfo, String str, Bundle bundle, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> result) {
            synchronized (this.mLock) {
