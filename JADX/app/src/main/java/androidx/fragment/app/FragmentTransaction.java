...
public abstract class FragmentTransaction {
    ...
    static final class C0407Op {
        ...
        C0407Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0407Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0407Op c0407Op) {
        this.mOps.add(c0407Op);
        c0407Op.mEnterAnim = this.mEnterAnim;
        c0407Op.mExitAnim = this.mExitAnim;
        c0407Op.mPopEnterAnim = this.mPopEnterAnim;
        c0407Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0407Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0407Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0407Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0407Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0407Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0407Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0407Op(10, fragment, state));
        return this;
    }
