...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            int i = C035910.f79xe493b431[operation3.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
    ...
    static /* synthetic */ class C035910 {
        ...
        static {
            ...
            try {
                f79xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f79xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f79xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
