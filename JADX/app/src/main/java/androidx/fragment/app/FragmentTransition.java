...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, FragmentTransaction.C0407Op c0407Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        int i2 = z ? INVERSE_OPS[c0407Op.mCmd] : c0407Op.mCmd;
        boolean z7 = false;
        boolean z8 = true;
        if (i2 == 1) {
            if (z2) {
