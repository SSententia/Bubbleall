...
public class BrowserActionsFallbackMenuView extends LinearLayout {
    ...
    public BrowserActionsFallbackMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mBrowserActionsMenuMinPaddingPx = getResources().getDimensionPixelOffset(C0150R.dimen.browser_actions_context_menu_min_padding);
        this.mBrowserActionsMenuMaxWidthPx = getResources().getDimensionPixelOffset(C0150R.dimen.browser_actions_context_menu_max_width);
    }
