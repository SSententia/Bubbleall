...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolderItem.mIcon = (ImageView) view.findViewById(C0150R.id.browser_actions_menu_item_icon);
            viewHolderItem.mText = (TextView) view.findViewById(C0150R.id.browser_actions_menu_item_text);
