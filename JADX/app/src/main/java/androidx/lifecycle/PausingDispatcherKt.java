...
public final class PausingDispatcherKt {
    ...
    /* JADX INFO: compiled from: PausingDispatcher.kt */
    @Metadata(m493bv = {1, 0, 3}, m494d1 = {"\u0000\f\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, m495d2 = {"<anonymous>", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, m496k = 3, m497mv = {1, 4, 1})
    @DebugMetadata(m511c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m512f = "PausingDispatcher.kt", m513i = {0}, m514l = {162}, m515m = "invokeSuspend", m516n = {"controller"}, m517s = {"L$0"})
    static final class C04472<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C04472(Lifecycle lifecycle, Lifecycle.State state, Function2 function2, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C04472 c04472 = new C04472(this.$this_whenStateAtLeast, this.$minState, this.$block, completion);
            c04472.L$0 = obj;
            return c04472;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Object obj) {
            return ((C04472) create(coroutineScope, (Continuation) obj)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C04472(lifecycle, state, function2, null), continuation);
    }
}
