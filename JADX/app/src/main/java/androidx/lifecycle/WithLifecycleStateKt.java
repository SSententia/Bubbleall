...
public final class WithLifecycleStateKt {
    public static final <R> Object withStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        return suspendWithStateAtLeastUnchecked(lifecycle, state, zIsDispatchNeeded, immediate, new C04592(function0), continuation);
    }
    ...
    /* JADX INFO: compiled from: WithLifecycleState.kt */
    @Metadata(m493bv = {1, 0, 3}, m494d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, m495d2 = {"<anonymous>", "R", "invoke", "()Ljava/lang/Object;"}, m496k = 3, m497mv = {1, 4, 1})
    public static final class C04592<R> extends Lambda implements Function0<R> {
        final /* synthetic */ Function0 $block;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C04592(Function0 function0) {
            super(0);
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.upTo(state)) {
                    ...
                    try {
                        ...
                        objM751constructorimpl = Result.m751constructorimpl(function1.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM751constructorimpl = Result.m751constructorimpl(ResultKt.createFailure(th));
                    }
                    cancellableContinuation.resumeWith(objM751constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    cancellableContinuation2.resumeWith(Result.m751constructorimpl(ResultKt.createFailure(lifecycleDestroyedException)));
                }
            }
        };
        if (z) {
            coroutineDispatcher.mo2307dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$2
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3
            ...
            public final void invoke2(Throwable th) {
                if (coroutineDispatcher.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    coroutineDispatcher.mo2307dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$3.1
                        @Override // java.lang.Runnable
                        public final void run() {
