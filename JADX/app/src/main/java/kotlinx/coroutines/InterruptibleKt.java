...
public final class InterruptibleKt {
    ...
    /* JADX INFO: compiled from: Interruptible.kt */
    @Metadata(m494d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m495d2 = {"<anonymous>", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/CoroutineScope;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m512f = "Interruptible.kt", m513i = {}, m514l = {}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C17912<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C17912(Function0<? extends T> function0, Continuation<? super C17912> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C17912 c17912 = new C17912(this.$block, continuation);
            c17912.L$0 = obj;
            return c17912;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C17912) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C17912(function0, null), continuation);
    }
