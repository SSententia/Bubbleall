...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
        ...
        while (!select.isSelected()) {
            ...
            if (obj instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    C0176xc40028dd.m82m(_state$FU, this, obj, new LockedQueue(empty.locked));
                } else {
    ...
    /* JADX INFO: compiled from: Mutex.kt */
    @Metadata(m494d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0002\u0018\u00002\u00020\u0001:\u0001\rB\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0002\u0010\u0006J\u001e\u0010\u0007\u001a\u00020\b2\n\u0010\t\u001a\u0006\u0012\u0002\b\u00030\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0005H\u0016J\u0016\u0010\f\u001a\u0004\u0018\u00010\u00052\n\u0010\t\u001a\u0006\u0012\u0002\b\u00030\nH\u0016R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u0004\u0018\u00010\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, m495d2 = {"Lkotlinx/coroutines/sync/MutexImpl$TryLockDesc;", "Lkotlinx/coroutines/internal/AtomicDesc;", "mutex", "Lkotlinx/coroutines/sync/MutexImpl;", "owner", "", "(Lkotlinx/coroutines/sync/MutexImpl;Ljava/lang/Object;)V", "complete", "", "op", "Lkotlinx/coroutines/internal/AtomicOp;", "failure", "prepare", "PrepareOp", "kotlinx-coroutines-core"}, m496k = 1, m497mv = {1, 6, 0}, m499xi = 48)
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public Object perform(Object affected) {
                ...
                C0176xc40028dd.m82m(MutexImpl._state$FU, (MutexImpl) affected, this, atomicOp);
                return null;
            }
        }
        ...
        public Object prepare(AtomicOp<?> op) {
            ...
            if (!C0176xc40028dd.m82m(MutexImpl._state$FU, this.mutex, MutexKt.EMPTY_UNLOCKED, prepareOp)) {
        ...
        public void complete(AtomicOp<?> op, Object failure) {
            ...
            C0176xc40028dd.m82m(MutexImpl._state$FU, this.mutex, op, empty);
        }
    }
    ...
    /* JADX INFO: compiled from: Mutex.kt */
    @Metadata(m494d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0005\u001a\u00020\u0006H\u0016R\u0012\u0010\u0002\u001a\u00020\u00038\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0007"}, m495d2 = {"Lkotlinx/coroutines/sync/MutexImpl$LockedQueue;", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "owner", "", "(Ljava/lang/Object;)V", "toString", "", "kotlinx-coroutines-core"}, m496k = 1, m497mv = {1, 6, 0}, m499xi = 48)
    ...
    /* JADX INFO: compiled from: Mutex.kt */
    @Metadata(m494d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u001a\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u00022\b\u0010\t\u001a\u0004\u0018\u00010\nH\u0016J\u0012\u0010\u000b\u001a\u0004\u0018\u00010\n2\u0006\u0010\b\u001a\u00020\u0002H\u0016R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, m495d2 = {"Lkotlinx/coroutines/sync/MutexImpl$UnlockOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "Lkotlinx/coroutines/sync/MutexImpl;", "queue", "Lkotlinx/coroutines/sync/MutexImpl$LockedQueue;", "(Lkotlinx/coroutines/sync/MutexImpl$LockedQueue;)V", "complete", "", "affected", "failure", "", "prepare", "kotlinx-coroutines-core"}, m496k = 1, m497mv = {1, 6, 0}, m499xi = 48)
    private static final class UnlockOp extends AtomicOp<MutexImpl> {
        ...
        public void complete(MutexImpl affected, Object failure) {
            C0176xc40028dd.m82m(MutexImpl._state$FU, affected, this, failure == null ? MutexKt.EMPTY_UNLOCKED : this.queue);
        }
    }
    ...
    public boolean tryLock(Object owner) {
        while (true) {
            ...
            if (obj instanceof Empty) {
                ...
                if (C0176xc40028dd.m82m(_state$FU, this, obj, owner == null ? MutexKt.EMPTY_LOCKED : new Empty(owner))) {
                    return true;
                }
            } else {
                if (obj instanceof LockedQueue) {
    ...
    public final Object lockSuspend(final Object obj, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (empty.locked != MutexKt.UNLOCKED) {
                    C0176xc40028dd.m82m(_state$FU, this, obj2, new LockedQueue(empty.locked));
                } else {
                    if (C0176xc40028dd.m82m(_state$FU, this, obj2, obj == null ? MutexKt.EMPTY_LOCKED : new Empty(obj))) {
    ...
    public void unlock(Object owner) {
        while (true) {
            ...
            if (obj instanceof Empty) {
                ...
                if (C0176xc40028dd.m82m(_state$FU, this, obj, MutexKt.EMPTY_UNLOCKED)) {
                    return;
                }
                ...
                if (lockFreeLinkedListNodeRemoveFirstOrNull == null) {
                    ...
                    if (C0176xc40028dd.m82m(_state$FU, this, obj, unlockOp) && unlockOp.perform(this) == null) {
                        return;
                    }
                } else {
