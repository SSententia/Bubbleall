...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    public void execute(Runnable command) {
        mo2307dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo2307dispatch(CoroutineContext context, Runnable block) {
        default.mo2307dispatch(context, block);
    }
