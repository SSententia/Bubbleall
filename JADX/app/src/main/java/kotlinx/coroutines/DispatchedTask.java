...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        Object objM751constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m751constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m751constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m751constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    objM751constructorimpl2 = Result.m751constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM751constructorimpl2 = Result.m751constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m754exceptionOrNullimpl(objM751constructorimpl2));
            } catch (Throwable th2) {
                if (undispatchedCoroutineUpdateUndispatchedCompletion == null || undispatchedCoroutineUpdateUndispatchedCompletion.clearThreadContext()) {
                    ThreadContextKt.restoreThreadContext(context, objUpdateThreadContext);
                }
            ...
            try {
                ...
                objM751constructorimpl = Result.m751constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException(th3, Result.m754exceptionOrNullimpl(objM751constructorimpl));
        }
    }
