...
public final class TimeoutKt {
    ...
    static final class C17931<T> extends ContinuationImpl {
        ...
        C17931(Continuation<? super C17931> continuation) {
            super(continuation);
        }
    ...
    public static final <T> Object m2254withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2246toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object withTimeoutOrNull(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C17931) {
            c17931 = (C17931) continuation;
            if ((c17931.label & Integer.MIN_VALUE) != 0) {
                c17931.label -= Integer.MIN_VALUE;
            } else {
                c17931 = new C17931(continuation);
            }
        } else {
            c17931 = new C17931(continuation);
        }
        Object obj = c17931.result;
        ...
        if (i == 0) {
            ...
            try {
                c17931.L$0 = function2;
                c17931.L$1 = objectRef2;
                c17931.J$0 = j;
                c17931.label = 1;
                ?? r4 = (T) new TimeoutCoroutine(j, c17931);
                objectRef2.element = r4;
                Object obj2 = setupTimeout(r4, function2);
                if (obj2 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c17931);
                }
            ...
            long j2 = c17931.J$0;
            objectRef = (Ref.ObjectRef) c17931.L$1;
            try {
                ResultKt.throwOnFailure(obj);
                return obj;
    ...
    public static final <T> Object m2255withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2246toDelayMillisLRDsOJo(j), function2, continuation);
    }
