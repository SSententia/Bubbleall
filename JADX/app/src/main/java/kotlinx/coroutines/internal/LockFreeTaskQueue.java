    ...
    public final void close() {
        while (true) {
            ...
            if (lockFreeTaskQueueCore.close()) {
                ...
                C0176xc40028dd.m82m(_cur$FU, this, lockFreeTaskQueueCore, lockFreeTaskQueueCore.next());
            }
        }
    }
