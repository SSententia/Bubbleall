...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM751constructorimpl = Result.m751constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM751constructorimpl = Result.m751constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m754exceptionOrNullimpl(objM751constructorimpl) == null) {
            obj2 = objM751constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM751constructorimpl2 = Result.m751constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM751constructorimpl2 = Result.m751constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m754exceptionOrNullimpl(objM751constructorimpl2) == null) {
            obj = objM751constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            while (i < length) {
                ...
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m502to(cause, stackTrace);
                }
            }
            return TuplesKt.m502to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m502to(e, new StackTraceElement[0]);
    }
