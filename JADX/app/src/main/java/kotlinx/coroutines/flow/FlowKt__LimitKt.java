...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__LimitKt", m512f = "Limit.kt", m513i = {0}, m514l = {Cea708CCParser.Const.CODE_C1_DSW}, m515m = "collectWhile", m516n = {"collector"}, m517s = {"L$0"})
    static final class C18951<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C18951(Continuation<? super C18951> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: Limit.kt */
    @Metadata(m494d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m512f = "Limit.kt", m513i = {0}, m514l = {Cea708CCParser.Const.CODE_C1_DF1}, m515m = "invokeSuspend", m516n = {"collector$iv"}, m517s = {"L$0"})
    static final class C18991<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        C18991(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C18991> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C18991 c18991 = new C18991(this.$this_transformWhile, this.$transform, continuation);
            c18991.L$0 = obj;
            return c18991;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C18991) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Type inference incomplete: some casts might be missing */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) throws Throwable {
            C1900xdf1aa1b6 c1900xdf1aa1b6;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = this.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                ...
                C1900xdf1aa1b6 c1900xdf1aa1b7 = new C1900xdf1aa1b6(this.$transform, flowCollector);
                try {
                    this.L$0 = c1900xdf1aa1b7;
                    this.label = 1;
                    if (flow.collect(c1900xdf1aa1b7, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } catch (AbortFlowException e) {
                    e = e;
                    c1900xdf1aa1b6 = c1900xdf1aa1b7;
                    FlowExceptions_commonKt.checkOwnership(e, c1900xdf1aa1b6);
                }
            } else {
                if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                c1900xdf1aa1b6 = (C1900xdf1aa1b6) this.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C18991(flow, function3, null));
    }
    ...
    public static final <T> Object collectWhile(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C18951) {
            ...
            if ((c18951.label & Integer.MIN_VALUE) != 0) {
                c18951.label -= Integer.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            try {
                c18951.L$0 = flowKt__LimitKt$collectWhile$collector$1;
                c18951.label = 1;
                if (flow.collect(flowKt__LimitKt$collectWhile$collector$1, c18951) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (AbortFlowException e) {
                e = e;
            ...
            flowCollector = (FlowKt__LimitKt$collectWhile$collector$1) c18951.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e2) {
                e = e2;
