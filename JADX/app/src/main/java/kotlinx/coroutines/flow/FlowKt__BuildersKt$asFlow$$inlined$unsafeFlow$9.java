...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9 implements Flow<Integer> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9", m512f = "Builders.kt", m513i = {0}, m514l = {115}, m515m = "collect", m516n = {"$this$asFlow_u24lambda_u2d17"}, m517s = {"L$0"})
    public static final class C18671 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C18671(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super Integer> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator<Integer> it;
        if (continuation instanceof C18671) {
            c18671 = (C18671) continuation;
            if ((c18671.label & Integer.MIN_VALUE) != 0) {
                c18671.label -= Integer.MIN_VALUE;
            } else {
                c18671 = new C18671(continuation);
            }
        } else {
            c18671 = new C18671(continuation);
        }
        Object obj = c18671.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c18671.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c18671.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Integer numBoxInt = Boxing.boxInt(((IntIterator) it).nextInt());
            c18671.L$0 = flowCollector2;
            c18671.L$1 = it;
            c18671.label = 1;
            if (flowCollector2.emit(numBoxInt, c18671) == coroutine_suspended) {
