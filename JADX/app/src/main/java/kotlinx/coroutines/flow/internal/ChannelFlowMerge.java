...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object objCollect = this.flow.collect(new C19652((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    /* JADX INFO: compiled from: Merge.kt */
    @Metadata(m494d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    static final class C19652<T> implements FlowCollector, SuspendFunction {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C19652(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, SendingCollector<T> sendingCollector) {
            this.$job = job;
        ...
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                c19652 = (C19652) channelFlowMerge$collectTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
            BuildersKt__Builders_commonKt.launch$default(c19652.$scope, null, null, new AnonymousClass1(flow, c19652.$collector, c19652.$semaphore, null), 3, null);
        ...
        @DebugMetadata(m511c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m512f = "Merge.kt", m513i = {}, m514l = {69}, m515m = "invokeSuspend", m516n = {}, m517s = {})
