...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m512f = "Reduce.kt", m513i = {0, 0}, m514l = {143}, m515m = "emit", m516n = {"this", "it"}, m517s = {"L$0", "L$1"})
    public static final class C19121 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C19121(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C19121) {
            c19121 = (C19121) continuation;
            if ((c19121.label & Integer.MIN_VALUE) != 0) {
                c19121.label -= Integer.MIN_VALUE;
            } else {
                c19121 = new C19121(continuation);
            }
        } else {
            c19121 = new C19121(continuation);
        }
        Object objInvoke = c19121.result;
        ...
        if (i == 0) {
            ...
            c19121.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(t, c19121);
            InlineMarker.mark(7);
            ...
            t = (T) c19121.L$1;
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c19121.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
