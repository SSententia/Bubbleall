...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                if (C0176xc40028dd.m82m(_state$FU, this, obj, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (C0176xc40028dd.m82m(_state$FU, this, obj, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) obj).resumeWith(Result.m751constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!C0176xc40028dd.m82m(_state$FU, this, StateFlowKt.NONE, cancellableContinuationImpl2)) {
