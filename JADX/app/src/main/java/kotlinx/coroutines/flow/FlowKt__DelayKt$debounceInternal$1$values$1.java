...
@Metadata(m494d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u00020\u00040\u0003H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/channels/ProducerScope;", ""}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
@DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m512f = "Delay.kt", m513i = {}, m514l = {211}, m515m = "invokeSuspend", m516n = {}, m517s = {})
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C18801<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C18801(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C18801 c18801 = new C18801(producerScope);
            this.label = 1;
            if (flow.collect(c18801, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
