...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", m512f = "Builders.kt", m513i = {0}, m514l = {115}, m515m = "collect", m516n = {"$this$asFlow_u24lambda_u2d3"}, m517s = {"L$0"})
    public static final class C18611 extends ContinuationImpl {
        ...
        public C18611(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C18611) {
            ...
            if ((c18611.label & Integer.MIN_VALUE) != 0) {
                c18611.label -= Integer.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            it = (Iterator) c18611.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c18611.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c18611.L$0 = flowCollector2;
            c18611.L$1 = it;
            c18611.label = 1;
            if (flowCollector2.emit(next, c18611) == coroutine_suspended) {
