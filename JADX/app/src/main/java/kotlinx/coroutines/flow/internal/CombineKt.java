...
public final class CombineKt {
    ...
    static final class C19682 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C19682(Flow<? extends T>[] flowArr, Function0<T[]> function0, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector, Continuation<? super C19682> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C19682 c19682 = new C19682(this.$flows, this.$arrayFactory, this.$transform, this.$this_combineInternal, continuation);
            c19682.L$0 = obj;
            return c19682;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C19682) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Code duplicated, block: B:22:0x00c4 A[RETURN] */
        /* JADX WARN: Code duplicated, block: B:23:0x00c5  */
        /* JADX WARN: Code duplicated, block: B:26:0x00ce  */
        /* JADX WARN: Code duplicated, block: B:28:0x00d1 A[LOOP:0: B:28:0x00d1->B:49:?, LOOP_START, PHI: r6 r10
  ...
  0x00d1: PHI (r10v5 kotlin.collections.IndexedValue) = (r10v4 kotlin.collections.IndexedValue), (r10v18 kotlin.collections.IndexedValue) binds: [B:25:0x00cc, B:49:?] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        /* JADX WARN: Code duplicated, block: B:41:0x0119 A[RETURN] */
        /* JADX WARN: Code duplicated, block: B:42:0x011a  */
        /* JADX WARN: Code duplicated, block: B:44:0x013c A[RETURN] */
        /* JADX WARN: Code duplicated, block: B:47:0x00f7 A[EDGE_INSN: B:47:0x00f7->B:36:0x00f7 BREAK  A[LOOP:0: B:28:0x00d1->B:49:?], SYNTHETIC] */
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r25) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt.C19682.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        /* JADX INFO: renamed from: kotlinx.coroutines.flow.internal.CombineKt$combineInternal$2$1, reason: invalid class name */
        /* JADX INFO: compiled from: Combine.kt */
        @Metadata(m494d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m495d2 = {"<anonymous>", "", "R", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/CoroutineScope;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
        @DebugMetadata(m511c = "kotlinx.coroutines.flow.internal.CombineKt$combineInternal$2$1", m512f = "Combine.kt", m513i = {}, m514l = {34}, m515m = "invokeSuspend", m516n = {}, m517s = {})
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            final /* synthetic */ Flow<T>[] $flows;

            /* JADX INFO: renamed from: $i */
            final /* synthetic */ int f256$i;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new AnonymousClass1(this.$flows, this.f256$i, this.$nonClosed, this.$resultChannel, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                try {
                    if (i == 0) {
                        ...
                        int i2 = this.f256$i;
                        this.label = 1;
                        if (flowArr[i2].collect(new C20011(this.$resultChannel, i2), this) == coroutine_suspended) {
            ...
            /* JADX INFO: compiled from: Combine.kt */
            @Metadata(m494d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m495d2 = {"<anonymous>", "", "R", RequestConfiguration.MAX_AD_CONTENT_RATING_T, AppMeasurementSdk.ConditionalUserProperty.VALUE, "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
            static final class C20011<T> implements FlowCollector, SuspendFunction {

                /* JADX INFO: renamed from: $i */
                final /* synthetic */ int f257$i;
                final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

                C20011(Channel<IndexedValue<Object>> channel, int i) {
                    this.$resultChannel = channel;
                    this.f257$i = i;
                }
                ...
                public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
                    ...
                    if (i == 0) {
                        ...
                        IndexedValue<Object> indexedValue = new IndexedValue<>(this.f257$i, t);
    ...
    public static final <R, T> Object combineInternal(FlowCollector<? super R> flowCollector, Flow<? extends T>[] flowArr, Function0<T[]> function0, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super Unit> continuation) {
        Object objFlowScope = FlowCoroutineKt.flowScope(new C19682(flowArr, function0, function3, flowCollector, null), continuation);
