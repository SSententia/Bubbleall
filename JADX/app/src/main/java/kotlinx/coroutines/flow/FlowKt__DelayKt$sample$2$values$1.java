...
@DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m512f = "Delay.kt", m513i = {}, m514l = {280}, m515m = "invokeSuspend", m516n = {}, m517s = {})
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C18831<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C18831(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C18831 c18831 = new C18831(producerScope);
            this.label = 1;
            if (flow.collect(c18831, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
