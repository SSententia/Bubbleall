...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class C19342<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ Function2 $predicate$inlined;
        ...
        @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2", m512f = "Transform.kt", m513i = {0, 0}, m514l = {223, 223}, m515m = "emit", m516n = {AppMeasurementSdk.ConditionalUserProperty.VALUE, "$this$filterNot_u24lambda_u2d1"}, m517s = {"L$0", "L$1"})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C19342.this.emit(null, this);
            }
        }

        public C19342(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C19342(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C19342 c19342 = new C19342(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c19342, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
