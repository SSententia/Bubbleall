...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", m512f = "Limit.kt", m513i = {0}, m514l = {115}, m515m = "collect", m516n = {"$this$take_u24lambda_u2d4"}, m517s = {"L$0"})
    public static final class C18961 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C18961(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        C18961 c18961;
        if (continuation instanceof C18961) {
            c18961 = (C18961) continuation;
            if ((c18961.label & Integer.MIN_VALUE) != 0) {
                c18961.label -= Integer.MIN_VALUE;
            } else {
                c18961 = new C18961(continuation);
            }
        } else {
            c18961 = new C18961(continuation);
        }
        Object obj = c18961.result;
        ...
        try {
            if (i == 0) {
                ...
                c18961.L$0 = flowCollector;
                c18961.label = 1;
                Object objCollect = flow.collect(flowKt__LimitKt$take$2$1, c18961);
                ...
                boolean z = (FlowCollector<? super T>) ((FlowCollector) c18961.L$0);
                ResultKt.throwOnFailure(obj);
                flowCollector = z;
            }
