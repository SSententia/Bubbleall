...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public final Object collectWithContextUndispatched(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext, Continuation<? super Unit> continuation) {
        Object objWithContextUndispatched$default = ChannelFlowKt.withContextUndispatched$default(coroutineContext, ChannelFlowKt.withUndispatchedContextCollector(flowCollector, continuation.get$context()), null, new C19662(this, null), continuation, 4, null);
    ...
    /* JADX INFO: compiled from: ChannelFlow.kt */
    @Metadata(m494d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0005H\u008a@"}, m495d2 = {"<anonymous>", "", "S", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "it", "Lkotlinx/coroutines/flow/FlowCollector;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", m512f = "ChannelFlow.kt", m513i = {}, m514l = {Cea708CCParser.Const.CODE_C1_DF0}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C19662 extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        /* synthetic */ Object L$0;
        int label;
        final /* synthetic */ ChannelFlowOperator<S, T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19662(ChannelFlowOperator<S, T> channelFlowOperator, Continuation<? super C19662> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C19662 c19662 = new C19662(this.this$0, continuation);
            c19662.L$0 = obj;
            return c19662;
        }
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C19662) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
