...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m512f = "Builders.kt", m513i = {0}, m514l = {115}, m515m = "collect", m516n = {"$this$asFlow_u24lambda_u2d19"}, m517s = {"L$0"})
    public static final class C18591 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C18591(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator<Long> it;
        if (continuation instanceof C18591) {
            c18591 = (C18591) continuation;
            if ((c18591.label & Integer.MIN_VALUE) != 0) {
                c18591.label -= Integer.MIN_VALUE;
            } else {
                c18591 = new C18591(continuation);
            }
        } else {
            c18591 = new C18591(continuation);
        }
        Object obj = c18591.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c18591.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c18591.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Long lBoxLong = Boxing.boxLong(((LongIterator) it).nextLong());
            c18591.L$0 = flowCollector2;
            c18591.L$1 = it;
            c18591.label = 1;
            if (flowCollector2.emit(lBoxLong, c18591) == coroutine_suspended) {
