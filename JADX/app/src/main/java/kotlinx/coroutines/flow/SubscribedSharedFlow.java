...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m512f = "Share.kt", m513i = {}, m514l = {409}, m515m = "collect", m516n = {}, m517s = {})
    static final class C19631 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C19631(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C19631> continuation) {
            super(continuation);
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<?> continuation) throws Throwable {
        C19631 c19631;
        if (continuation instanceof C19631) {
            c19631 = (C19631) continuation;
            if ((c19631.label & Integer.MIN_VALUE) != 0) {
                c19631.label -= Integer.MIN_VALUE;
            } else {
                c19631 = new C19631(this, continuation);
            }
        } else {
            c19631 = new C19631(this, continuation);
        }
        Object obj = c19631.result;
        ...
        if (i == 0) {
            ...
            c19631.label = 1;
            if (sharedFlow.collect(subscribedFlowCollector, c19631) == coroutine_suspended) {
