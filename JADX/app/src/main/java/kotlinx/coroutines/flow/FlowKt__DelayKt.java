...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2288debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2246toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m2246toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    /* JADX INFO: compiled from: Delay.kt */
    @Metadata(m494d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0005H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/CoroutineScope;", "downstream", "Lkotlinx/coroutines/flow/FlowCollector;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", m512f = "Delay.kt", m513i = {0, 0, 0, 0}, m514l = {352}, m515m = "invokeSuspend", m516n = {"downstream", "values", "lastValue", "ticker"}, m517s = {"L$0", "L$1", "L$2", "L$3"})
    static final class C18822<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C18822(long j, Flow<? extends T> flow, Continuation<? super C18822> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C18822 c18822 = new C18822(this.$periodMillis, this.$this_sample, continuation);
            c18822.L$0 = coroutineScope;
            c18822.L$1 = flowCollector;
            return c18822.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                ...
                this.label = 1;
                C18822<T> c18822 = this;
                SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(c18822);
                try {
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c18822);
                }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C18822(j, flow, null));
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C18813(j2, j, null), 1, null);
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3 */
    /* JADX INFO: compiled from: Delay.kt */
    @Metadata(m494d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H\u008a@"}, m495d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3", m512f = "Delay.kt", m513i = {0, 1, 2}, m514l = {314, 316, 317}, m515m = "invokeSuspend", m516n = {"$this$produce", "$this$produce", "$this$produce"}, m517s = {"L$0", "L$0", "L$0"})
    static final class C18813 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C18813(long j, long j2, Continuation<? super C18813> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C18813 c18813 = new C18813(this.$initialDelayMillis, this.$delayMillis, continuation);
            c18813.L$0 = obj;
            return c18813;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C18813) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L56:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C18813.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m2289sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2246toDelayMillisLRDsOJo(j));
    }
}
