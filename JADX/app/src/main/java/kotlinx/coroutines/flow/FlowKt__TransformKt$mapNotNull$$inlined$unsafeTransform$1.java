...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C19392<T> implements FlowCollector, SuspendFunction {
        ...
        @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", m512f = "Transform.kt", m513i = {0}, m514l = {223, 224}, m515m = "emit", m516n = {"$this$mapNotNull_u24lambda_u2d5"}, m517s = {"L$0"})
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C19392.this.emit(null, this);
            }
        }

        public C19392(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C19392(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C19392 c19392 = new C19392(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c19392, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
