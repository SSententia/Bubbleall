...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    /* JADX INFO: compiled from: SharingStarted.kt */
    @Metadata(m494d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u00022\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@"}, m495d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlinx/coroutines/flow/SharingCommand;", "count", ""}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", m512f = "SharingStarted.kt", m513i = {1, 2, 3}, m514l = {178, 180, 182, 183, 185}, m515m = "invokeSuspend", m516n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, m517s = {"L$0", "L$0", "L$0"})
    static final class C19591 extends SuspendLambda implements Function3<FlowCollector<? super SharingCommand>, Integer, Continuation<? super Unit>, Object> {
        /* synthetic */ int I$0;
        private /* synthetic */ Object L$0;
        int label;

        C19591(Continuation<? super C19591> continuation) {
        ...
        public final Object invoke(FlowCollector<? super SharingCommand> flowCollector, int i, Continuation<? super Unit> continuation) {
            C19591 c19591 = StartedWhileSubscribed.this.new C19591(continuation);
            c19591.L$0 = flowCollector;
            c19591.I$0 = i;
            return c19591.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Flow<SharingCommand> command(StateFlow<Integer> subscriptionCount) {
        return FlowKt.distinctUntilChanged(FlowKt.dropWhile(FlowKt.transformLatest(subscriptionCount, new C19591(null)), new C19602(null)));
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.StartedWhileSubscribed$command$2 */
    /* JADX INFO: compiled from: SharingStarted.kt */
    @Metadata(m494d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, m495d2 = {"<anonymous>", "", "it", "Lkotlinx/coroutines/flow/SharingCommand;"}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$2", m512f = "SharingStarted.kt", m513i = {}, m514l = {}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C19602 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Boolean>, Object> {
        /* synthetic */ Object L$0;
        int label;

        C19602(Continuation<? super C19602> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C19602 c19602 = new C19602(continuation);
            c19602.L$0 = obj;
            return c19602;
        }
        ...
        public final Object invoke(SharingCommand sharingCommand, Continuation<? super Boolean> continuation) {
            return ((C19602) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public int hashCode() {
        return (UByte$$ExternalSyntheticBackport0.m505m(this.stopTimeout) * 31) + UByte$$ExternalSyntheticBackport0.m505m(this.replayExpiration);
    }
}
