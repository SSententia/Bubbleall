...
public final class FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1", m512f = "Errors.kt", m513i = {0, 0}, m514l = {113, 114}, m515m = "collect", m516n = {"this", "$this$catch_u24lambda_u2d0"}, m517s = {"L$0", "L$1"})
    public static final class C18891 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C18891(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C18891) {
            ...
            if ((c18891.label & Integer.MIN_VALUE) != 0) {
                c18891.label -= Integer.MIN_VALUE;
            } else {
        ...
        Object objCatchImpl = c18891.result;
        ...
        if (i == 0) {
            ...
            c18891.L$0 = this;
            c18891.L$1 = flowCollector;
            c18891.label = 1;
            objCatchImpl = FlowKt.catchImpl(flow, flowCollector, c18891);
            ...
            if (i == 1) {
                flowCollector = (FlowCollector) c18891.L$1;
                flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1 = (FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1) c18891.L$0;
                ResultKt.throwOnFailure(objCatchImpl);
            } else {
                if (i != 2) {
        ...
        if (th != null) {
            ...
            c18891.label = 2;
            InlineMarker.mark(6);
            Object objInvoke = function3.invoke(flowCollector, th, c18891);
            InlineMarker.mark(7);
