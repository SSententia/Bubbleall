...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1", m512f = "Emitters.kt", m513i = {0, 0, 0}, m514l = {116, 120}, m515m = "collect", m516n = {"this", "$this$onStart_u24lambda_u2d1", "safeCollector"}, m517s = {"L$0", "L$1", "L$2"})
    public static final class C18861 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C18861(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C18861) {
            ...
            if ((c18861.label & Integer.MIN_VALUE) != 0) {
                c18861.label -= Integer.MIN_VALUE;
            } else {
        ...
        if (i == 0) {
            ...
            SafeCollector safeCollector2 = new SafeCollector(flowCollector, c18861.getContext());
            try {
                Function2 function2 = this.$action$inlined;
                c18861.L$0 = this;
                c18861.L$1 = flowCollector;
                c18861.L$2 = safeCollector2;
                c18861.label = 1;
                InlineMarker.mark(6);
                Object objInvoke = function2.invoke(safeCollector2, c18861);
                InlineMarker.mark(7);
                ...
                c18861.L$2 = null;
                c18861.label = 2;
                if (flow.collect(flowCollector2, c18861) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } catch (Throwable th2) {
                th = th2;
            ...
            safeCollector = (SafeCollector) c18861.L$2;
            flowCollector2 = (FlowCollector) c18861.L$1;
            flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 = (FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1) c18861.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                safeCollector.releaseIntercepted();
                flow = flowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.$this_onStart$inlined;
