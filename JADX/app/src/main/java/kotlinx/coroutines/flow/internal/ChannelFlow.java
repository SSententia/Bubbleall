...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
  ...
  0x0023: PHI (r4v9 int) = (r4v2 int), (r4v2 int), (r4v7 int) binds: [B:15:0x0021, B:20:0x0029, B:36:0x004f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m512f = "ChannelFlow.kt", m513i = {}, m514l = {123}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C19642 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C19642(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C19642> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C19642 c19642 = new C19642(this.$collector, this.this$0, continuation);
            c19642.L$0 = obj;
            return c19642;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C19642) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlow channelFlow, FlowCollector flowCollector, Continuation continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C19642(flowCollector, channelFlow, null), continuation);
