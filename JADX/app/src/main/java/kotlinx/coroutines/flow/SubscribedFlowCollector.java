...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.SubscribedFlowCollector", m512f = "Share.kt", m513i = {0, 0}, m514l = {419, 423}, m515m = "onSubscription", m516n = {"this", "safeCollector"}, m517s = {"L$0", "L$1"})
    static final class C19621 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C19621(SubscribedFlowCollector<T> subscribedFlowCollector, Continuation<? super C19621> continuation) {
            super(continuation);
    ...
    public final Object onSubscription(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C19621) {
            c19621 = (C19621) continuation;
            if ((c19621.label & Integer.MIN_VALUE) != 0) {
                c19621.label -= Integer.MIN_VALUE;
            } else {
                c19621 = new C19621(this, continuation);
            }
        } else {
            c19621 = new C19621(this, continuation);
        }
        Object obj = c19621.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r2 = c19621.label;
        try {
            if (r2 == 0) {
                ResultKt.throwOnFailure(obj);
                safeCollector = new SafeCollector(this.collector, c19621.getContext());
                Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> function2 = this.action;
                c19621.L$0 = this;
                c19621.L$1 = safeCollector;
                c19621.label = 1;
                if (function2.invoke(safeCollector, c19621) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                subscribedFlowCollector = this;
            } else {
                if (r2 == 1) {
                    safeCollector = (SafeCollector) c19621.L$1;
                    subscribedFlowCollector = (SubscribedFlowCollector) c19621.L$0;
                    ResultKt.throwOnFailure(obj);
                } else {
                    if (r2 != 2) {
            ...
            c19621.L$1 = null;
            c19621.label = 2;
            if (((SubscribedFlowCollector) flowCollector).onSubscription(c19621) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        } catch (Throwable th) {
