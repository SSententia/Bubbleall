...
@DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1", m512f = "Share.kt", m513i = {}, m514l = {340}, m515m = "invokeSuspend", m516n = {}, m517s = {})
final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                C19281 c19281 = new C19281(objectRef, coroutineScope, this.$result);
                this.label = 1;
                if (flow.collect(c19281, this) == coroutine_suspended) {
    ...
    static final class C19281<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ CoroutineScope $$this$launch;
        final /* synthetic */ CompletableDeferred<StateFlow<T>> $result;
        final /* synthetic */ Ref.ObjectRef<MutableStateFlow<T>> $state;

        C19281(Ref.ObjectRef<MutableStateFlow<T>> objectRef, CoroutineScope coroutineScope, CompletableDeferred<StateFlow<T>> completableDeferred) {
