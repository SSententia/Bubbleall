...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", m512f = "Errors.kt", m513i = {0}, m514l = {Cea708CCParser.Const.CODE_C1_DF4}, m515m = "catchImpl", m516n = {"fromDownstream"}, m517s = {"L$0"})
    static final class C18901<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C18901(Continuation<? super C18901> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m494d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "it", ""}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m512f = "Errors.kt", m513i = {}, m514l = {}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C18921 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        C18921(Continuation<? super C18921> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C18921(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C18921) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m494d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", ""}, m496k = 3, m497mv = {1, 6, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m512f = "Errors.kt", m513i = {}, m514l = {95}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C18933<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        C18933(long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super C18933> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C18933 c18933 = new C18933(this.$retries, this.$predicate, continuation);
            c18933.L$0 = th;
            c18933.J$0 = j;
            return c18933.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C18933(j, function2, null));
    }
    ...
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        if (continuation instanceof C18901) {
            c18901 = (C18901) continuation;
            if ((c18901.label & Integer.MIN_VALUE) != 0) {
                c18901.label -= Integer.MIN_VALUE;
            } else {
                c18901 = new C18901(continuation);
            }
        } else {
            c18901 = new C18901(continuation);
        }
        Object obj = c18901.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c18901.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                FlowCollector<? super Object> c18912 = new C18912<>(flowCollector, objectRef2);
                c18901.L$0 = objectRef2;
                c18901.label = 1;
                if (flow.collect(c18912, c18901) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return null;
            } catch (Throwable th) {
            ...
            objectRef = (Ref.ObjectRef) c18901.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                return null;
            } catch (Throwable th2) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, c18901.getContext())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    static final class C18912<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ FlowCollector<T> $collector;
        final /* synthetic */ Ref.ObjectRef<Throwable> $fromDownstream;

        /* JADX WARN: Multi-variable type inference failed */
        C18912(FlowCollector<? super T> flowCollector, Ref.ObjectRef<Throwable> objectRef) {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i != 0) {
                if (i == 1) {
                    c18912 = (C18912) flowKt__ErrorsKt$catchImpl$2$emit$1.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                    ...
                    L19:
                        ...
                        kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 r5 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C18912) r5
                    ...
                    L4d:
                        ...
                        throw r6
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.C18912.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
            ...
            public static final <T> Flow<T> m2292catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
