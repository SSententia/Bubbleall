...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m512f = "Builders.kt", m513i = {0}, m514l = {336}, m515m = "collectTo", m516n = {"scope"}, m517s = {"L$0"})
    static final class C18561 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C18561(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C18561> continuation) {
            super(continuation);
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) throws Throwable {
        C18561 c18561;
        if (continuation instanceof C18561) {
            c18561 = (C18561) continuation;
            if ((c18561.label & Integer.MIN_VALUE) != 0) {
                c18561.label -= Integer.MIN_VALUE;
            } else {
                c18561 = new C18561(this, continuation);
            }
        } else {
            c18561 = new C18561(this, continuation);
        }
        Object obj = c18561.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c18561.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c18561.L$0 = producerScope;
            c18561.label = 1;
            if (super.collectTo(producerScope, c18561) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c18561.L$0;
            ResultKt.throwOnFailure(obj);
        }
