...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM751constructorimpl = Result.m751constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM751constructorimpl = Result.m751constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m757isFailureimpl(objM751constructorimpl) ? null : objM751constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2307dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m2257postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m2257postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
