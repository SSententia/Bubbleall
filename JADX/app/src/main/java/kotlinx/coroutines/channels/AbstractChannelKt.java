...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.INSTANCE.m2279closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m2281successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m2279closedJP2dKIU(closed.closeCause);
    }
}
