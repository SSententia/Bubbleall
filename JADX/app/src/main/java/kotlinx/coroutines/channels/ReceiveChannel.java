...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(m511c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", m512f = "Channel.kt", m513i = {}, m514l = {354}, m515m = "receiveOrNull", m516n = {}, m517s = {})
    static final class C18441<E> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C18441(Continuation<? super C18441> continuation) {
            super(continuation);
        }
    ...
    Object mo2259receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2260tryReceivePtdJZtk = receiveChannel.mo2260tryReceivePtdJZtk();
            if (ChannelResult.m2276isSuccessimpl(objMo2260tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2272getOrThrowimpl(objMo2260tryReceivePtdJZtk);
            }
            Throwable thM2270exceptionOrNullimpl = ChannelResult.m2270exceptionOrNullimpl(objMo2260tryReceivePtdJZtk);
            if (thM2270exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2270exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (continuation instanceof C18441) {
                c18441 = (C18441) continuation;
                if ((c18441.label & Integer.MIN_VALUE) != 0) {
                    c18441.label -= Integer.MIN_VALUE;
                } else {
                    c18441 = new C18441(continuation);
                }
            } else {
                c18441 = new C18441(continuation);
            }
            Object obj = c18441.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = c18441.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                c18441.label = 1;
                objMo2259receiveCatchingJP2dKIU = receiveChannel.mo2259receiveCatchingJP2dKIU(c18441);
            ...
            return ChannelResult.m2271getOrNullimpl(objMo2259receiveCatchingJP2dKIU);
        }
