...
public interface SendChannel<E> {
    ...
    Object mo2261trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2276isSuccessimpl(objMo2261trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2270exceptionOrNullimpl = ChannelResult.m2270exceptionOrNullimpl(objMo2261trySendJP2dKIU);
