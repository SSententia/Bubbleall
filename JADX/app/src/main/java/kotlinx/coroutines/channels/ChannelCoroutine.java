...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2259receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2259receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2261trySendJP2dKIU(E element) {
        return this._channel.mo2261trySendJP2dKIU(element);
    }
