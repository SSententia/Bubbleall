                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        ...
                        if (send2 instanceof AbstractSendChannel.SendBuffered) {
                            ...
                            undeliveredElementExceptionCallUndeliveredElementCatchingException2 = function2 == null ? null : OnUndeliveredElementKt.callUndeliveredElementCatchingException(function2, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementExceptionCallUndeliveredElementCatchingException2);
                        } else {
