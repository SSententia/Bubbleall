...
public final class ProduceKt {
    ...
    public static final Object awaitClose(ProducerScope<?> producerScope, Function0<Unit> function0, Continuation<? super Unit> continuation) throws Throwable {
        C18421 c18421;
        if (continuation instanceof C18421) {
            c18421 = (C18421) continuation;
            if ((c18421.label & Integer.MIN_VALUE) != 0) {
                c18421.label -= Integer.MIN_VALUE;
            } else {
                c18421 = new C18421(continuation);
            }
        } else {
            c18421 = new C18421(continuation);
        }
        Object obj = c18421.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c18421.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (c18421.get$context().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context".toString());
                }
                c18421.L$0 = producerScope;
                c18421.L$1 = function0;
                c18421.label = 1;
                CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c18421), 1);
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c18421);
                }
                ...
                function0 = (Function0) c18421.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
