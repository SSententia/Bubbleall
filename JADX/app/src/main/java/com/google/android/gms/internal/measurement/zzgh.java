...
final class zzgh extends zzgd<Boolean> implements RandomAccess, zzhy, zzjd {
    ...
    static {
        zzgh zzghVar = new zzgh(new boolean[0], 0);
        zza = zzghVar;
        zzghVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        ...
        System.arraycopy(zzghVar.zzb, 0, this.zzb, this.zzc, zzghVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzghVar.zzc) {
            return false;
        }
        boolean[] zArr = zzghVar.zzb;
    ...
    public final int hashCode() {
        int iZzf = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzf = (iZzf * 31) + zzhz.zzf(this.zzb[i]);
        }
        return iZzf;
    }
