...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C1218R.attr.colorError, C1218R.attr.colorOnError, C1218R.attr.colorErrorContainer, C1218R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C1218R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
