    ...
    public final synchronized void zzh() {
        ...
        try {
            ...
            for (final zzcml zzcmlVar : this.zzc) {
                this.zze.execute(new Runnable(zzcmlVar, jSONObjectZza) { // from class: com.google.android.gms.internal.ads.zzcto
                    private final zzcml zza;
                    private final JSONObject zzb;

                    {
                        this.zza = zzcmlVar;
                        this.zzb = jSONObjectZza;
                    }
            ...
            zzchj.zzb(this.zzd.zzb(jSONObjectZza), "ActiveViewListener.callActiveViewJs");
        } catch (Exception e) {
