                        ...
                        try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    ...
                                    zzcgt.zzd(strValueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(strValueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                }
                            } else {
