...
public final class zzctm implements zzbtz<zzctp> {
    ...
    public final JSONObject zzb(zzctp zzctpVar) throws JSONException {
        ...
        if (zzawcVar == null) {
            ...
            JSONObject jSONObjectPut = jSONObject3.put("afmaVersion", this.zzb.zzb()).put("activeViewJSON", this.zzb.zzc()).put("timestamp", zzctpVar.zzd).put("adFormat", this.zzb.zza()).put("hashCode", this.zzb.zzd()).put("isMraid", false);
            boolean z2 = zzctpVar.zzc;
            jSONObjectPut.put("isStopped", false).put("isPaused", zzctpVar.zzb).put("isNative", this.zzb.zze()).put("isScreenOn", this.zzc.isInteractive()).put("appMuted", com.google.android.gms.ads.internal.zzt.zzh().zzd()).put("appVolume", com.google.android.gms.ads.internal.zzt.zzh().zzb()).put("deviceVolume", com.google.android.gms.ads.internal.util.zzae.zze(this.zza.getApplicationContext()));
