...
final class zzawv implements Application.ActivityLifecycleCallbacks {
    ...
    static /* synthetic */ boolean zzc(zzawv zzawvVar, boolean z) {
        zzawvVar.zzd = false;
        return false;
    }
    ...
    public final void onActivityResumed(Activity activity) {
        ...
        synchronized (this.zzc) {
            ...
            if (z) {
                Iterator<zzaww> it2 = this.zzf.iterator();
                while (it2.hasNext()) {
                    try {
                        it2.next().zza(true);
                    } catch (Exception e2) {
