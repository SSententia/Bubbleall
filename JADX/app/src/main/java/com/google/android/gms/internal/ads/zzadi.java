...
public final class zzadi extends zzgga<zzadi, zzadh> implements zzghj {
    ...
    static /* synthetic */ void zzl(zzadi zzadiVar, String str) {
        str.getClass();
        zzadiVar.zzb |= 1;
        zzadiVar.zze = str;
    }

    static /* synthetic */ void zzm(zzadi zzadiVar, String str) {
        str.getClass();
        zzadiVar.zzb |= 2;
        zzadiVar.zzf = str;
    }

    static /* synthetic */ void zzn(zzadi zzadiVar, long j) {
        zzadiVar.zzb |= 4;
        zzadiVar.zzg = j;
    }

    static /* synthetic */ void zzo(zzadi zzadiVar, long j) {
        zzadiVar.zzb |= 8;
        zzadiVar.zzh = j;
    }

    static /* synthetic */ void zzp(zzadi zzadiVar, long j) {
        zzadiVar.zzb |= 16;
        zzadiVar.zzi = j;
    }
