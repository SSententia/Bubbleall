...
public final class zzexa<R extends zzdal<AdT>, AdT extends zzcxg> implements zzexo<R, zzewz<R, AdT>> {
    ...
    final /* synthetic */ zzfsm zzb(zzdal zzdalVar, zzexj zzexjVar) throws Exception {
        zzfcm zzfcmVar = zzexjVar.zzb;
        zzcbj zzcbjVar = zzexjVar.zza;
        zzfcl<?, ?> zzfclVarZza = zzfcmVar != null ? this.zza.zza(zzfcmVar) : null;
        if (zzfcmVar == null) {
            return zzfsd.zza(null);
        }
        if (zzfclVarZza != null && zzcbjVar != null) {
            zzfsd.zzp(zzdalVar.zzP().zzg(zzcbjVar), this.zzc, this.zzb);
        }
        return zzfsd.zza(new zzewz(zzfcmVar, zzcbjVar, zzfclVarZza));
    }
