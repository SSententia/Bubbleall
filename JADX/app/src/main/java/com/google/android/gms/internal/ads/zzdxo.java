...
public final class zzdxo implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgy)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) zzbet.zzc().zzc(zzbjl.zzgA)).intValue()) < jCurrentTimeMillis) {
                this.zzf = 0;
            ...
            this.zzd = fValueOf;
            if (fValueOf.floatValue() > this.zzc + ((Float) zzbet.zzc().zzc(zzbjl.zzgz)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else {
