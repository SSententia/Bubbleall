...
public final class zzbdm implements Parcelable.Creator<zzbdl> {
    ...
    public final /* bridge */ /* synthetic */ zzbdl createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    zzbdlVarArr = (zzbdl[]) SafeParcelReader.createTypedArray(parcel, header, zzbdl.CREATOR);
                    break;
                case 9:
        ...
        return new zzbdl(strCreateString, i, i2, z, i3, i4, zzbdlVarArr, z2, z3, z4, z5, z6, z7, z8, z9);
    }
