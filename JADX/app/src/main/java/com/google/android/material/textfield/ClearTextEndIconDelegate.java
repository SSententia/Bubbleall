...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(this.customEndIcon == 0 ? C1218R.drawable.mtrl_ic_cancel : this.customEndIcon);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1218R.string.clear_text_end_icon_content_description));
