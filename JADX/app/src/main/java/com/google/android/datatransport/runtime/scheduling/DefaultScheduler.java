...
public class DefaultScheduler implements Scheduler {
    ...
    public void schedule(final TransportContext transportContext, final EventInternal eventInternal, final TransportScheduleCallback transportScheduleCallback) {
        this.executor.execute(new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m442x41d0caed(transportContext, transportScheduleCallback, eventInternal);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$schedule$1$com-google-android-datatransport-runtime-scheduling-DefaultScheduler */
    /* synthetic */ void m442x41d0caed(final TransportContext transportContext, TransportScheduleCallback transportScheduleCallback, EventInternal eventInternal) {
        try {
            ...
            if (transportBackend == null) {
                ...
                this.guard.runCriticalSection(new SynchronizationGuard.CriticalSection() { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda1
                    ...
                    public final Object execute() {
                        return this.f$0.m441x8f06a4e(transportContext, eventInternalDecorate);
                    }
                });
    ...
    /* JADX INFO: renamed from: lambda$schedule$0$com-google-android-datatransport-runtime-scheduling-DefaultScheduler */
    /* synthetic */ Object m441x8f06a4e(TransportContext transportContext, EventInternal eventInternal) {
