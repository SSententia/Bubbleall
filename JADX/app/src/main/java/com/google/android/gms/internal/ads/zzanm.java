...
public final class zzanm implements Parcelable {
    ...
    public final int hashCode() {
        ...
        int iHashCode6 = (iHashCode5 + (zzapkVar == null ? 0 : zzapkVar.hashCode())) * 31;
        zzaru zzaruVar = this.zzd;
        int iHashCode7 = iHashCode6 + (zzaruVar != null ? zzaruVar.hashCode() : 0);
        this.zzA = iHashCode7;
        return iHashCode7;
    }

    zzanm(String str, String str2, String str3, String str4, int i, int i2, int i3, int i4, float f, int i5, float f2, byte[] bArr, int i6, zzavh zzavhVar, int i7, int i8, int i9, int i10, int i11, int i12, String str5, int i13, long j, List<byte[]> list, zzapk zzapkVar, zzaru zzaruVar) {
        this.zza = str;
        this.zze = str2;
        this.zzf = str3;
        this.zzc = str4;
