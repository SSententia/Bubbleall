...
public final class zzoh {
    ...
    public zzoh(byte[] bArr, int i) {
        ...
        int iZzh = zzameVar.zzh(20);
        this.zze = iZzh;
        this.zzf = zzh(iZzh);
        this.zzg = zzameVar.zzh(3) + 1;
        int iZzh2 = zzameVar.zzh(5) + 1;
        this.zzh = iZzh2;
        this.zzi = zzi(iZzh2);
    ...
    private static zzaiv zzj(List<String> list, List<zzajc> list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String[] strArrZzu = zzamq.zzu(str, "=");
            if (strArrZzu.length != 2) {
                ...
                arrayList.add(new zzaje(strArrZzu[0], strArrZzu[1]));
            }
        }
    ...
    public final long zzb(long j) {
        return zzamq.zzy((j * ((long) this.zze)) / 1000000, 0L, this.zzj - 1);
    }
    ...
    public final zzafv zzc(byte[] bArr, zzaiv zzaivVar) {
        ...
        zzaiv zzaivVarZzd = zzd(zzaivVar);
