...
public final class zzakv {
    ...
    public static String zzb(zzamg zzamgVar) {
        zzamgVar.zzc(24);
        int iZze = zzamgVar.zze(2);
        boolean zZzd = zzamgVar.zzd();
        int iZze2 = zzamgVar.zze(5);
        int i = 0;
        ...
        objArr[0] = zzc[iZze];
        objArr[1] = Integer.valueOf(iZze2);
        objArr[2] = Integer.valueOf(i);
        objArr[3] = Character.valueOf(true != zZzd ? 'L' : 'H');
        objArr[4] = Integer.valueOf(iZze3);
