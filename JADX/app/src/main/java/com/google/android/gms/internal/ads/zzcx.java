...
final class zzcx {
    ...
    private static zzhf zzl(zzahp zzahpVar, zzfoj<zzhf> zzfojVar, zzhf zzhfVar, zzain zzainVar) {
        ...
        int iZzu = zzahpVar.zzu();
        Object objZzj = zzaiqVarZzF.zzt() ? null : zzaiqVarZzF.zzj(iZzu);
        int iZzf = (zzahpVar.zzA() || zzaiqVarZzF.zzt()) ? -1 : zzaiqVarZzF.zzh(iZzu, zzainVar, false).zzf(zzadx.zzb(zzahpVar.zzx()));
        for (int i = 0; i < zzfojVar.size(); i++) {
            zzhf zzhfVar2 = zzfojVar.get(i);
            if (zzm(zzhfVar2, objZzj, zzahpVar.zzA(), zzahpVar.zzB(), zzahpVar.zzC(), iZzf)) {
                return zzhfVar2;
            }
        }
        if (zzfojVar.isEmpty() && zzhfVar != null) {
            if (zzm(zzhfVar, objZzj, zzahpVar.zzA(), zzahpVar.zzB(), zzahpVar.zzC(), iZzf)) {
                return zzhfVar;
            }
        }
        return null;
