...
public final class zzbus<I, O> implements zzfrk<I, O> {
    ...
    zzbus(zzfsm<zzbtt> zzfsmVar, String str, zzbtz<I> zzbtzVar, zzbty<O> zzbtyVar) {
        this.zzd = zzfsmVar;
        this.zzb = zzbtzVar;
        this.zza = zzbtyVar;
    }
    ...
    final /* synthetic */ zzfsm zzc(Object obj, zzbtt zzbttVar) throws Exception {
        zzchl zzchlVar = new zzchl();
        com.google.android.gms.ads.internal.zzt.zzc();
        String string = UUID.randomUUID().toString();
        zzbpq.zzo.zzb(string, new zzbur(this, zzchlVar));
