...
public final class zzfgt {
    ...
    static /* synthetic */ void zzf(zzfgt zzfgtVar, boolean z) {
        if (zzfgtVar.zze != z) {
            zzfgtVar.zze = z;
            if (zzfgtVar.zzd) {
                zzfgtVar.zzh();
    ...
    private final void zzh() {
        ...
        while (it.hasNext()) {
            zzfhe zzfheVarZzg = it.next().zzg();
            if (zzfheVarZzg.zze()) {
                zzfgx.zza().zzg(zzfheVarZzg.zzd(), "setState", true != z ? "foregrounded" : "backgrounded");
            }
        }
    }
