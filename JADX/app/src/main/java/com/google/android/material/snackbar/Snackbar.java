...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1218R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1218R.attr.snackbarButtonStyle, C1218R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i2 = C1218R.layout.mtrl_layout_snackbar_include;
        } else {
            i2 = C1218R.layout.design_layout_snackbar_include;
        }
