...
public final class zzewd extends zzbfm implements com.google.android.gms.ads.internal.overlay.zzo, zzaxq {
    ...
    private final synchronized void zzS(int i) {
        if (this.zzd.compareAndSet(false, true)) {
            ...
            if (this.zza != null) {
                ...
                if (this.zzh != -1) {
                    jElapsedRealtime = com.google.android.gms.ads.internal.zzt.zzj().elapsedRealtime() - this.zzh;
                }
    ...
    public final synchronized void zzbp() {
        ...
        this.zzi = zzcucVar;
        zzcucVar.zzb(iZzc, new Runnable(this) { // from class: com.google.android.gms.internal.ads.zzewa
