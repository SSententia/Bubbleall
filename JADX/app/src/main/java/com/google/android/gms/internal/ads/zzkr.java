...
public final class zzkr implements zzki, zzay {
    ...
    public final synchronized void zzh(int i) {
        ...
        if (i2 == 0 || this.zzm) {
            ...
            if (i != 1 && i != 0 && i != 8) {
                ...
                zzj(this.zzn > 0 ? (int) (jElapsedRealtime - this.zzo) : 0, this.zzp, this.zzt);
                this.zzo = jElapsedRealtime;
                this.zzp = 0L;
                this.zzs = 0L;
                this.zzr = 0L;
                this.zzk.zza();
    ...
    public final synchronized void zzd(zzaj zzajVar, zzan zzanVar, boolean z) {
        if (zzl(zzanVar, z)) {
            ...
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            int i = (int) (jElapsedRealtime - this.zzo);
            this.zzr += (long) i;
            long j = this.zzs;
            long j2 = this.zzp;
            this.zzs = j + j2;
    ...
    public static synchronized zzkr zzg(Context context) {
        if (zzh == null) {
            ...
            zzfoj<Integer> zzfojVarZza = zza.zza(zzamq.zzX(context));
            if (zzfojVarZza.isEmpty()) {
                zzfojVarZza = zzfoj.zzn(2, 2, 2, 2, 2, 2);
            }
            HashMap map = new HashMap(8);
            map.put(0, 1000000L);
            zzfoj<Long> zzfojVar = zzb;
            map.put(2, zzfojVar.get(zzfojVarZza.get(0).intValue()));
            map.put(3, zzc.get(zzfojVarZza.get(1).intValue()));
            map.put(4, zzd.get(zzfojVarZza.get(2).intValue()));
            map.put(5, zze.get(zzfojVarZza.get(3).intValue()));
            map.put(10, zzf.get(zzfojVarZza.get(4).intValue()));
            map.put(9, zzg.get(zzfojVarZza.get(5).intValue()));
            map.put(7, zzfojVar.get(zzfojVarZza.get(0).intValue()));
            zzh = new zzkr(applicationContext, map, 2000, zzaku.zza, true, null);
        }
        return zzh;
    }
    ...
    /* synthetic */ zzkr(Context context, Context context2, Map<Integer, Long> map, int i, zzaku zzakuVar, boolean z) {
        ...
        this.zzm = true;
        if (context != null) {
            zzamd zzamdVarZza = zzamd.zza(context);
            int iZzc = zzamdVarZza.zzc();
            this.zzq = iZzc;
            this.zzt = zzk(iZzc);
            zzamdVarZza.zzb(new zzalz(this) { // from class: com.google.android.gms.internal.ads.zzkp
