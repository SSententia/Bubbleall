...
public final class zzeqy implements zzery<zzeqz> {
    ...
    private final zzfsm<JSONObject> zze(String str, List<Bundle> list, Bundle bundle, boolean z, boolean z2) throws RemoteException {
        ...
        if (z2) {
            this.zzg.zza(str);
            zzbxnVarZzc = this.zzg.zzb(str);
        } else {
            try {
                zzbxnVarZzc = this.zzh.zzc(str);
            } catch (RemoteException e) {
                com.google.android.gms.ads.internal.util.zze.zzg("Couldn't create RTB adapter : ", e);
                zzbxnVarZzc = null;
            }
        }
        zzbxn zzbxnVar = zzbxnVarZzc;
        zzbxnVar.getClass();
    ...
    final /* synthetic */ zzfsm zzb(String str, zzeki zzekiVar, Bundle bundle) throws Exception {
        return zze(str, Collections.singletonList(zzekiVar.zzd), bundle, zzekiVar.zzb, zzekiVar.zzc);
    }

    final /* synthetic */ zzfsm zzc(String str, List list, Bundle bundle) throws Exception {
        return zze(str, list, bundle, true, true);
    }

    final /* bridge */ /* synthetic */ zzfsm zzd() {
        Map<String, List<Bundle>> mapZzc = this.zzd.zzc(this.zza, this.zzf.zzf);
        final ArrayList arrayList = new ArrayList();
        Iterator<E> it = ((zzfon) mapZzc).entrySet().iterator();
        while (true) {
            ...
            arrayList.add(zzfsd.zzf((zzfru) zzfsd.zzh(zzfru.zzw(zzfsd.zze(new zzfrj(this, str, list, bundle) { // from class: com.google.android.gms.internal.ads.zzeqt
                ...
                public final Object apply(Object obj) {
                    ...
                    com.google.android.gms.ads.internal.util.zze.zzf(strValueOf.length() != 0 ? "Error calling adapter: ".concat(strValueOf) : new String("Error calling adapter: "));
                    return null;
                }
            }, this.zzb));
        }
        Iterator<E> it2 = ((zzfon) this.zzd.zzb()).entrySet().iterator();
        while (it2.hasNext()) {
