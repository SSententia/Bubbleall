...
public final class zzcjc {
    ...
    public final void zzc() {
        ...
        for (com.google.android.gms.ads.internal.util.zzbf zzbfVar : this.zzf.zzb()) {
            String strValueOf = String.valueOf(zzbfVar.zza);
            bundle.putString(strValueOf.length() != 0 ? "fps_c_".concat(strValueOf) : new String("fps_c_"), Integer.toString(zzbfVar.zze));
            String strValueOf2 = String.valueOf(zzbfVar.zza);
            bundle.putString(strValueOf2.length() != 0 ? "fps_p_".concat(strValueOf2) : new String("fps_p_"), Double.toString(zzbfVar.zzd));
        }
        int i = 0;
        while (true) {
            long[] jArr = this.zzg;
    ...
    public final void zzd(zzcii zzciiVar) {
        ...
        long jNanoTime = com.google.android.gms.ads.internal.zzt.zzj().nanoTime();
        if (this.zzm && this.zzp && this.zzq != -1) {
            this.zzf.zza(TimeUnit.SECONDS.toNanos(1L) / (jNanoTime - this.zzq));
        }
        this.zzp = this.zzm;
        this.zzq = jNanoTime;
        long jLongValue = ((Long) zzbet.zzc().zzc(zzbjl.zzw)).longValue();
        ...
        while (true) {
            ...
            if (strArr[i] == null && jLongValue > Math.abs(jZzk - this.zzg[i])) {
