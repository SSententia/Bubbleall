...
public final class zzaxm {
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zzaxl> priorityQueue) {
        ...
        while (true) {
            ...
            jZze = ((((((jZze + 1073807359) - ((((((long) zzaxi.zza(strArr[i3 - 1])) + 2147483647L) % 1073807359) * jZzd) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzaxi.zza(strArr[i3 + 5])) + 2147483647L) % 1073807359)) % 1073807359;
            zzb(i, jZze, zzc(strArr, i3, 6), length2, priorityQueue);
            i3++;
        }
    }
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long jZza = (((long) zzaxi.zza(strArr[0])) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            jZza = (((jZza * 16785407) % 1073807359) + ((((long) zzaxi.zza(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZza;
    }
}
