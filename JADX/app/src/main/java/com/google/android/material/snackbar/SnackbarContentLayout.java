...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C1218R.id.snackbar_text);
        this.actionView = (Button) findViewById(C1218R.id.snackbar_action);
    }
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C1218R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1218R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C1218R.dimen.design_snackbar_padding_vertical);
