...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    DropdownMenuEndIconDelegate(TextInputLayout textInputLayout, int i) {
        ...
        this.dropdownMenuOnEditTextAttachedListener = new TextInputLayout.OnEditTextAttachedListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.4
            ...
            public void onEditTextAttached(TextInputLayout textInputLayout2) {
                ...
                if (!DropdownMenuEndIconDelegate.isEditable(autoCompleteTextViewCastAutoCompleteTextViewOrThrow) && DropdownMenuEndIconDelegate.this.accessibilityManager.isTouchExplorationEnabled()) {
    ...
    void initialize() {
        int i;
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C1218R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C1218R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C1218R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        if (this.customEndIcon == 0) {
            i = IS_LOLLIPOP ? C1218R.drawable.mtrl_dropdown_arrow : C1218R.drawable.mtrl_ic_arrow_drop_down;
        } else {
            i = this.customEndIcon;
        }
        this.textInputLayout.setEndIconDrawable(i);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1218R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1218R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C1218R.attr.colorSurface);
    ...
    private ValueAnimator getAlphaAnimator(int i, float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate.11
