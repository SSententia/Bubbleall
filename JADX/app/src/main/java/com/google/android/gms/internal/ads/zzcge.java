...
public final class zzcge {
        ...
        if (PlatformVersion.isAtLeastJellyBean() && this.zze != null) {
            if (!((Boolean) zzbet.zzc().zzc(zzbjl.zzbN)).booleanValue()) {
                synchronized (this.zzk) {
                    ...
                    zzfsm<ArrayList<String>> zzfsmVarZzb = zzchg.zza.zzb(new Callable(this) { // from class: com.google.android.gms.internal.ads.zzcga
    ...
    final /* synthetic */ ArrayList zzt() throws Exception {
        Context contextZza = zzcbx.zza(this.zze);
