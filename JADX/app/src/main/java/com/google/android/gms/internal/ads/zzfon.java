...
public abstract class zzfon<K, V> implements Map<K, V>, Serializable {
    ...
    public static <K, V> zzfon<K, V> zzb(Map<? extends K, ? extends V> map) {
        ...
        zzfom zzfomVar = new zzfom(setEntrySet instanceof Collection ? setEntrySet.size() : 4);
        zzfomVar.zzb(setEntrySet);
        return zzfomVar.zzc();
    }
    ...
    public final /* bridge */ /* synthetic */ Set keySet() {
        ...
        zzfot<K> zzfotVarZze = zze();
        this.zzb = zzfotVarZze;
        return zzfotVarZze;
    }
    ...
    public final zzfot<Map.Entry<K, V>> entrySet() {
        ...
        zzfot<Map.Entry<K, V>> zzfotVarZzd = zzd();
        this.zza = zzfotVarZzd;
        return zzfotVarZzd;
    }
    ...
    public final zzfoe<V> values() {
        ...
        zzfoe<V> zzfoeVarZzg = zzg();
        this.zzc = zzfoeVarZzg;
        return zzfoeVarZzg;
    }
