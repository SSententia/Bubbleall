...
public final class zzcip extends FrameLayout implements zzcih {
    ...
    public zzcip(Context context, zzcjb zzcjbVar, int i, boolean z, zzbka zzbkaVar, zzcja zzcjaVar) {
        ...
        if (applicationInfo == null || applicationInfo.targetSdkVersion >= 11) {
            zzcjsVar = i == 2 ? new zzcjs(context, new zzcjc(context, zzcjbVar.zzt(), zzcjbVar.zzm(), zzbkaVar, zzcjbVar.zzi()), zzcjbVar, z, zzcit.zza(zzcjbVar), zzcjaVar) : new zzcig(context, zzcjbVar, z, zzcit.zza(zzcjbVar), zzcjaVar, new zzcjc(context, zzcjbVar.zzt(), zzcjbVar.zzm(), zzbkaVar, zzcjbVar.zzi()));
        } else {
            zzcjsVar = null;
        }
        this.zzg = zzcjsVar;
        ...
        boolean zBooleanValue = ((Boolean) zzbet.zzc().zzc(zzbjl.zzz)).booleanValue();
        this.zzk = zBooleanValue;
        if (zzbkaVar != null) {
            zzbkaVar.zzd("spinner_used", true != zBooleanValue ? "0" : "1");
        }
    ...
    public final void zzC() {
        ...
        String strValueOf = String.valueOf(this.zzg.zzd());
    ...
    final void zzE() {
        ...
        long jZzk = zzciiVar.zzk();
        if (this.zzl == jZzk || jZzk <= 0) {
            return;
        }
        float f = jZzk / 1000.0f;
    ...
    public final void zzi() {
        ...
        long jElapsedRealtime2 = com.google.android.gms.ads.internal.zzt.zzj().elapsedRealtime() - jElapsedRealtime;
        ...
        if (jElapsedRealtime2 > this.zzf) {
            ...
            if (zzbkaVar != null) {
                zzbkaVar.zzd("spinner_jank", Long.toString(jElapsedRealtime2));
            }
        }
    }
    ...
    public final void zzj(int i, int i2) {
        if (this.zzk) {
            int iMax = Math.max(i / ((Integer) zzbet.zzc().zzc(zzbjl.zzB)).intValue(), 1);
            int iMax2 = Math.max(i2 / ((Integer) zzbet.zzc().zzc(zzbjl.zzB)).intValue(), 1);
