...
public final class zze {
    ...
    final void zzc(Context context, zzcgz zzcgzVar, boolean z, zzcfz zzcfzVar, String str, String str2, Runnable runnable) {
        ...
        zzbtw zzbtwVarZza = zzt.zzp().zzb(this.zza, zzcgzVar).zza("google.afma.config.fetchAppSettings", zzbud.zza, zzbud.zza);
        try {
            ...
            zzfsm zzfsmVarZzb = zzbtwVarZza.zzb(jSONObject);
            zzfsm zzfsmVarZzi = zzfsd.zzi(zzfsmVarZzb, zzd.zza, zzchg.zzf);
            if (runnable != null) {
                zzfsmVarZzb.zze(runnable, zzchg.zzf);
            }
            zzchj.zza(zzfsmVarZzi, "ConfigLoader.maybeFetchNewAppSettings");
        } catch (Exception e) {
