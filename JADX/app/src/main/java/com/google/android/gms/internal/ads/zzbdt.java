...
import com.google.android.gms.ads.C1204R;
...
public final class zzbdt {
    ...
    public zzbdt(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainAttributes = context.getResources().obtainAttributes(attributeSet, C1204R.styleable.AdsAttrs);
        String string = typedArrayObtainAttributes.getString(C1204R.styleable.AdsAttrs_adSize);
        String string2 = typedArrayObtainAttributes.getString(C1204R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = typedArrayObtainAttributes.getString(C1204R.styleable.AdsAttrs_adUnitId);
        this.zzb = string3;
        typedArrayObtainAttributes.recycle();
