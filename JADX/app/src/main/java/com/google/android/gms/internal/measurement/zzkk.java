    ...
    static String zze(byte[] bArr, int i, int i2) throws zzib {
        ...
        while (i < i3) {
            ...
            if (zzkg.zza(b2)) {
                ...
                int i6 = i + 2;
                i += 3;
                zzkg.zzc(b2, bArr[i5], bArr[i6], cArr, i4);
                i4++;
            } else {
                if (i5 >= i3 - 2) {
                    throw zzib.zzf();
                ...
                int i8 = i + 3;
                i += 4;
                zzkg.zzd(b2, bArr[i5], bArr[i7], bArr[i8], cArr, i4);
                i4 += 2;
            }
        }
