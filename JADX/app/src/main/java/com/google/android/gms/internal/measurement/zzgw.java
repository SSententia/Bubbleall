...
final class zzgw extends zzgy {
    ...
    @Override // com.google.android.gms.internal.measurement.zzgy
    public final void zzi(int i, zzgr zzgrVar) throws IOException {
        zzl((i << 3) | 2);
        zzl(zzgrVar.zzc());
        zzgrVar.zzf(this);
    }
    ...
    public final void zzl(int i) throws IOException {
        ...
        while ((i & (-128)) != 0) {
            try {
                ...
                throw new zzgx(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
            }
        }
        byte[] bArr2 = this.zzb;
        int i4 = this.zzd;
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (iZzw2 != iZzw) {
                ...
                byte[] bArr = this.zzb;
                int i2 = this.zzd;
                this.zzd = zzkk.zzd(str, bArr, i2, this.zzc - i2);
                return;
            }
            int i3 = i + iZzw2;
            this.zzd = i3;
            int iZzd = zzkk.zzd(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((iZzd - i) - iZzw2);
            this.zzd = iZzd;
        } catch (zzkj e) {
    ...
    public final void zzp(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgx(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzn(long j) throws IOException {
        if (zzgy.zzc && this.zzc - this.zzd >= 10) {
            while ((j & (-128)) != 0) {
                ...
                int i = this.zzd;
                this.zzd = i + 1;
                zzkf.zzp(bArr, i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i2 = this.zzd;
            this.zzd = i2 + 1;
            zzkf.zzp(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
