...
public final class zzefr implements zzeec<zzdji> {
    ...
    public final zzfsm<zzdji> zzb(final zzfal zzfalVar, final zzezz zzezzVar) {
        String strZzd = zzd(zzezzVar);
        final Uri uri = strZzd != null ? Uri.parse(strZzd) : null;
        return zzfsd.zzi(zzfsd.zza(null), new zzfrk(this, uri, zzfalVar, zzezzVar) { // from class: com.google.android.gms.internal.ads.zzefp
    ...
    final /* synthetic */ zzfsm zzc(Uri uri, zzfal zzfalVar, zzezz zzezzVar, Object obj) throws Exception {
        try {
            ...
            zzdjj zzdjjVarZzQ = this.zzb.zzQ(new zzcxv(zzfalVar, zzezzVar, null), new zzdjm(new zzdkn(zzchlVar) { // from class: com.google.android.gms.internal.ads.zzefq
            ...
            zzchlVar.zzc(new AdOverlayInfoParcel(zzcVar, null, zzdjjVarZzQ.zzi(), null, new zzcgz(0, 0, false, false, false), null, null));
            this.zzd.zzd();
            return zzfsd.zza(zzdjjVarZzQ.zzh());
        } catch (Throwable th) {
