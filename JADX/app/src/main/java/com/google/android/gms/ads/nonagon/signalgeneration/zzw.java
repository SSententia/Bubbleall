...
public final class zzw implements zzgla<zzv> {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        zzfbj<zzdrh> zzfbjVarZzb = this.zzd.zzb();
        zzfsn zzfsnVar = zzchg.zza;
        zzgli.zzb(zzfsnVar);
        return new zzv(zzcojVarZzb, contextZza, zzaasVarZzb, zzfbjVarZzb, zzfsnVar, this.zzf.zzb(), this.zzg.zzb(), this.zzh.zzb(), this.zzi.zzb(), ((zzcox) this.zzj).zza());
    }
}
