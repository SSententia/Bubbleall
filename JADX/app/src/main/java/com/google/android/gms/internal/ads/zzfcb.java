...
final class zzfcb {
    ...
    private final void zzi() {
        while (!this.zza.isEmpty()) {
            if (com.google.android.gms.ads.internal.zzt.zzj().currentTimeMillis() - this.zza.getFirst().zzd < this.zzc) {
                return;
            }
            this.zzd.zzc();
            this.zza.remove();
    ...
    public final zzfcl<?, ?> zzb() {
        ...
        zzfcl<?, ?> zzfclVarRemove = this.zza.remove();
        if (zzfclVarRemove != null) {
            this.zzd.zzb();
        }
        return zzfclVarRemove;
    }
