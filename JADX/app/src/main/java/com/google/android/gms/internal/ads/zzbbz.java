...
public final class zzbbz extends zzgga<zzbbz, zzbby> implements zzghj {
    ...
    static /* synthetic */ void zzd(zzbbz zzbbzVar, int i) {
        zzbbzVar.zzb |= 1;
        zzbbzVar.zze = i;
    }

    static /* synthetic */ void zze(zzbbz zzbbzVar, int i) {
        zzbbzVar.zzb |= 2;
        zzbbzVar.zzf = i;
    }

    static /* synthetic */ void zzf(zzbbz zzbbzVar, int i) {
        zzbbzVar.zzb |= 4;
        zzbbzVar.zzg = i;
    }
