...
public final class zzeuk implements zzgla<zzeui> {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzcge zzcgeVarZzb = this.zza.zzb();
        boolean zBooleanValue = ((zzeua) this.zzb).zzb().booleanValue();
        zzcfu zzcfuVar = new zzcfu();
        zzfsn zzfsnVar = zzchg.zza;
        zzgli.zzb(zzfsnVar);
        return new zzeui(zzcgeVarZzb, zBooleanValue, zzcfuVar, zzfsnVar, ((zzety) this.zze).zza(), this.zzf.zzb(), null);
    }
}
