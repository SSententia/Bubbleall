...
final class zzbiz extends zzbjd<Long> {
    zzbiz(int i, String str, Long l) {
        super(1, str, l, null);
    }
    ...
    public final /* bridge */ /* synthetic */ Long zza(Bundle bundle) {
        ...
        String strZze2 = zze();
        return Long.valueOf(bundle.getLong(strZze2.length() != 0 ? "com.google.android.gms.ads.flag.".concat(strZze2) : new String("com.google.android.gms.ads.flag.")));
    }
