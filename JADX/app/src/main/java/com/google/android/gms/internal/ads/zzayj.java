...
public final class zzayj {
    ...
    static /* synthetic */ zzaym zzc(zzayj zzayjVar, zzaym zzaymVar) {
        zzayjVar.zzc = null;
        return null;
    }

    static /* synthetic */ void zzj(zzayj zzayjVar) {
    ...
    public final void zzl() {
        synchronized (this.zzb) {
            if (this.zzd != null && this.zzc == null) {
                zzaym zzaymVarZzi = zzi(new zzayh(this), new zzayi(this));
                this.zzc = zzaymVarZzi;
                zzaymVarZzi.checkAvailabilityAndConnect();
            }
        }
    }
