...
public final class zzbhl {
    ...
    public final boolean zzA(zzbfn zzbfnVar) {
        try {
            IObjectWrapper iObjectWrapperZzi = zzbfnVar.zzi();
            if (iObjectWrapperZzi == null || ((View) ObjectWrapper.unwrap(iObjectWrapperZzi)).getParent() != null) {
                return false;
            }
            this.zzm.addView((View) ObjectWrapper.unwrap(iObjectWrapperZzi));
            this.zzj = zzbfnVar;
            return true;
    ...
    public final AdSize zzd() {
        ...
        try {
            zzbfn zzbfnVar = this.zzj;
            if (zzbfnVar != null && (zzbdlVarZzu = zzbfnVar.zzu()) != null) {
                return com.google.android.gms.ads.zza.zza(zzbdlVarZzu.zze, zzbdlVarZzu.zzb, zzbdlVarZzu.zza);
            }
        } catch (RemoteException e) {
            zzcgt.zzl("#007 Could not call remote method.", e);
        }
    ...
    public final void zzh(zzbhj zzbhjVar) {
        try {
            if (this.zzj == null) {
                ...
                zzbdl zzbdlVarZzB = zzB(context, this.zzh, this.zzn);
                zzbfn zzbfnVarZzd = "search_v2".equals(zzbdlVarZzB.zza) ? new zzbee(zzber.zzb(), context, zzbdlVarZzB, this.zzl).zzd(context, false) : new zzbec(zzber.zzb(), context, zzbdlVarZzB, this.zzl, this.zzb).zzd(context, false);
                this.zzj = zzbfnVarZzd;
                zzbfnVarZzd.zzo(new zzbdb(this.zza));
    ...
    public final ResponseInfo zzt() {
        zzbgz zzbgzVarZzA = null;
        try {
            zzbfn zzbfnVar = this.zzj;
            if (zzbfnVar != null) {
                zzbgzVarZzA = zzbfnVar.zzA();
            }
        } catch (RemoteException e) {
            zzcgt.zzl("#007 Could not call remote method.", e);
        }
        return ResponseInfo.zzb(zzbgzVarZzA);
    }
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    zzcgm zzcgmVarZza = zzber.zza();
                    AdSize adSize = this.zzh[0];
                    int i2 = this.zzn;
                    if (adSize.equals(AdSize.INVALID)) {
                        zzbdlVarZze = zzbdl.zze();
                    } else {
                        zzbdl zzbdlVar = new zzbdl(context, adSize);
                        zzbdlVar.zzj = zzC(i2);
                        zzbdlVarZze = zzbdlVar;
                    }
                    zzcgmVarZza.zzc(viewGroup, zzbdlVarZze, "Ads by Google");
                }
