...
public final class zzcmk extends WebChromeClient {
    ...
    private static final Context zzb(WebView webView) {
        ...
        Activity activityZzj = zzcmlVar.zzj();
        return activityZzj != null ? activityZzj : zzcmlVar.getContext();
    }
    ...
    public final void onCloseWindow(WebView webView) {
        ...
        com.google.android.gms.ads.internal.overlay.zzl zzlVarZzN = ((zzcml) webView).zzN();
        if (zzlVarZzN == null) {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        if (i == 1) {
            com.google.android.gms.ads.internal.util.zze.zzf(string);
        } else if (i == 2) {
            com.google.android.gms.ads.internal.util.zze.zzi(string);
        } else if (i == 3 || i == 4 || i != 5) {
            com.google.android.gms.ads.internal.util.zze.zzh(string);
        } else {
            com.google.android.gms.ads.internal.util.zze.zzd(string);
        }
        return super.onConsoleMessage(consoleMessage);
    }
    ...
    public final void onHideCustomView() {
        com.google.android.gms.ads.internal.overlay.zzl zzlVarZzN = this.zza.zzN();
        if (zzlVarZzN == null) {
    ...
    public final void onShowCustomView(View view, int i, WebChromeClient.CustomViewCallback customViewCallback) {
        ...
        if (zzlVarZzN == null) {
            ...
            zzlVarZzN.zzx(view, customViewCallback);
            zzlVarZzN.zzw(i);
        }
    }
    ...
    protected final boolean zza(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        com.google.android.gms.ads.internal.zzb zzbVarZzc;
        try {
            zzcml zzcmlVar = this.zza;
            if (zzcmlVar != null && zzcmlVar.zzR() != null && this.zza.zzR().zzc() != null && (zzbVarZzc = this.zza.zzR().zzc()) != null && !zzbVarZzc.zzb()) {
            ...
            if (z) {
                ...
                builder.setView(linearLayout).setPositiveButton(R.string.ok, new zzcmi(jsPromptResult, editText)).setNegativeButton(R.string.cancel, new zzcmh(jsPromptResult)).setOnCancelListener(new zzcmg(jsPromptResult)).create().show();
            } else {
                builder.setMessage(str3).setPositiveButton(R.string.ok, new zzcmf(jsResult)).setNegativeButton(R.string.cancel, new zzcme(jsResult)).setOnCancelListener(new zzcmd(jsResult)).create().show();
            }
            return true;
