...
import com.google.android.gms.base.C1209R;
import com.google.android.gms.common.C1210R;
...
public final class zac {
    ...
    public static String zab(Context context, int i) {
        ...
        if (i != 2) {
            return i != 3 ? resources.getString(R.string.ok) : resources.getString(C1209R.string.common_google_play_services_enable_button);
        }
    ...
    public static String zac(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C1209R.string.common_google_play_services_install_text, strZaa);
        }
        if (i == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C1209R.string.common_google_play_services_wear_update_text) : resources.getString(C1209R.string.common_google_play_services_update_text, strZaa);
        }
        if (i == 3) {
            return resources.getString(C1209R.string.common_google_play_services_enable_text, strZaa);
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(C1209R.string.common_google_play_services_unsupported_text, strZaa);
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(C1209R.string.common_google_play_services_updating_text, strZaa);
            default:
                return resources.getString(C1210R.string.common_google_play_services_unknown_issue, strZaa);
        }
    }

    public static String zae(Context context, int i) {
        String strZah = i == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i);
        return strZah == null ? context.getResources().getString(C1209R.string.common_google_play_services_notification_ticker) : strZah;
    }
    ...
    private static String zag(Context context, String str, String str2) {
        ...
        if (strZah == null) {
            strZah = resources.getString(C1210R.string.common_google_play_services_unknown_issue);
        }
