...
public final class zzcdb extends RewardedAd {
    ...
    public final ResponseInfo getResponseInfo() {
        zzbgz zzbgzVarZzm = null;
        try {
            zzccs zzccsVar = this.zzb;
            if (zzccsVar != null) {
                zzbgzVarZzm = zzccsVar.zzm();
            }
        } catch (RemoteException e) {
            zzcgt.zzl("#007 Could not call remote method.", e);
        }
        return ResponseInfo.zzc(zzbgzVarZzm);
    }
    ...
    public final RewardItem getRewardItem() {
        try {
            zzccs zzccsVar = this.zzb;
            zzccp zzccpVarZzl = zzccsVar != null ? zzccsVar.zzl() : null;
            return zzccpVarZzl == null ? RewardItem.DEFAULT_REWARD : new zzcdc(zzccpVarZzl);
        } catch (RemoteException e) {
            zzcgt.zzl("#007 Could not call remote method.", e);
