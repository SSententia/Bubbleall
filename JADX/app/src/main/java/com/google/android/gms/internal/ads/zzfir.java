...
final class zzfir implements BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void onConnected(Bundle bundle) {
        ...
        if (zzfjuVarZzd != null) {
            try {
                zzfkb zzfkbVarZzg = zzfjuVarZzd.zzg(new zzfjz(1, this.zzh, this.zzb, this.zzc));
                zze(5011, this.zzg, null);
                this.zzd.put(zzfkbVarZzg);
            } catch (Throwable th) {
                try {
    ...
    public final zzfkb zza(int i) {
        zzfkb zzfkbVarPoll;
        try {
            zzfkbVarPoll = this.zzd.poll(50000L, TimeUnit.MILLISECONDS);
        } catch (InterruptedException e) {
            zze(2009, this.zzg, e);
            zzfkbVarPoll = null;
        }
        zze(3004, this.zzg, null);
        if (zzfkbVarPoll != null) {
            if (zzfkbVarPoll.zzc == 7) {
                zzfii.zzg(3);
            } else {
                zzfii.zzg(2);
            }
        }
        return zzfkbVarPoll == null ? zzc() : zzfkbVarPoll;
    }
