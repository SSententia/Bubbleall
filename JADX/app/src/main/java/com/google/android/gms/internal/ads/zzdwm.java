...
public final class zzdwm {
    ...
    zzdwm(zzbqm zzbqmVar) {
        this.zza = zzbqmVar;
    }

    private final void zzs(zzdwk zzdwkVar) throws RemoteException {
        String strZzf = zzdwk.zzf(zzdwkVar);
        com.google.android.gms.ads.internal.util.zze.zzh(strZzf.length() != 0 ? "Dispatching AFMA event on publisher webview: ".concat(strZzf) : new String("Dispatching AFMA event on publisher webview: "));
        this.zza.zzb(strZzf);
    }
