...
public final class zzxz extends zzgga<zzxz, zzxv> implements zzghj {
    ...
    static /* synthetic */ void zzd(zzxz zzxzVar, String str) {
        str.getClass();
        zzxzVar.zzb |= 1;
        zzxzVar.zze = str;
    }

    static /* synthetic */ void zze(zzxz zzxzVar, long j) {
        zzxzVar.zzb |= 2;
        zzxzVar.zzf = j;
    }

    static /* synthetic */ void zzf(zzxz zzxzVar, String str) {
        str.getClass();
        zzxzVar.zzb |= 4;
        zzxzVar.zzg = str;
    }

    static /* synthetic */ void zzg(zzxz zzxzVar, String str) {
        str.getClass();
        zzxzVar.zzb |= 8;
        zzxzVar.zzh = str;
    }

    static /* synthetic */ void zzh(zzxz zzxzVar, String str) {
        zzxzVar.zzb |= 16;
        zzxzVar.zzi = str;
    }
    ...
    static /* synthetic */ void zzj(zzxz zzxzVar, int i) {
        zzxzVar.zzq = i - 1;
        zzxzVar.zzb |= 2048;
    }
