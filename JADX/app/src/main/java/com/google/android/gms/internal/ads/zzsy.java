...
public final class zzsy implements zzum {
    ...
    private final List<zzafv> zzd(zzul zzulVar) {
        ...
        List<zzafv> arrayList = this.zza;
        while (zzamfVar.zzd() > 0) {
            int iZzn = zzamfVar.zzn();
            int iZzg = zzamfVar.zzg() + zzamfVar.zzn();
            if (iZzn == 134) {
                arrayList = new ArrayList<>();
                int iZzn2 = zzamfVar.zzn() & 31;
                for (int i2 = 0; i2 < iZzn2; i2++) {
                    String strZzE = zzamfVar.zzE(3, zzfll.zzc);
                    ...
                    byte bZzn = (byte) zzamfVar.zzn();
                    zzamfVar.zzk(1);
                    if (i3 != 0) {
                        int i4 = zzakv.zza;
                        listSingletonList = Collections.singletonList((bZzn & 64) != 0 ? new byte[]{1} : new byte[]{0});
                    } else {
                    ...
                    zzaftVar.zzG(strZzE);
                    zzaftVar.zzaf(i);
                    zzaftVar.zzP(listSingletonList);
