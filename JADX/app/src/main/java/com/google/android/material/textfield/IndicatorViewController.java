...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = context.getResources().getDimensionPixelSize(C1218R.dimen.design_textinput_caption_translate_y);
    }
    ...
    void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            ViewCompat.setPaddingRelative(this.indicatorArea, getIndicatorPadding(zIsFontScaleAtLeast1_3, C1218R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingStart(editText)), getIndicatorPadding(zIsFontScaleAtLeast1_3, C1218R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(C1218R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(zIsFontScaleAtLeast1_3, C1218R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.getPaddingEnd(editText)), 0);
        }
    }
    ...
    void setErrorEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C1218R.id.textinput_error);
    ...
    void setHelperTextEnabled(boolean z) {
        ...
        if (z) {
            ...
            appCompatTextView.setId(C1218R.id.textinput_helper_text);
