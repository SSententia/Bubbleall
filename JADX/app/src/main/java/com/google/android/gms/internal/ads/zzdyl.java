...
public final class zzdyl implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgt)).booleanValue()) {
            ...
            if (this.zzd + ((long) ((Integer) zzbet.zzc().zzc(zzbjl.zzgv)).intValue()) > jCurrentTimeMillis) {
                return;
            }
            if (this.zzd + ((long) ((Integer) zzbet.zzc().zzc(zzbjl.zzgw)).intValue()) < jCurrentTimeMillis) {
                this.zze = 0;
            }
        ...
        synchronized (this) {
            if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgt)).booleanValue()) {
                ...
                if (!this.zzg && (sensorManager = this.zzb) != null && (sensor = this.zzc) != null) {
                    ...
                    this.zzd = com.google.android.gms.ads.internal.zzt.zzj().currentTimeMillis() - ((long) ((Integer) zzbet.zzc().zzc(zzbjl.zzgv)).intValue());
                    this.zzg = true;
