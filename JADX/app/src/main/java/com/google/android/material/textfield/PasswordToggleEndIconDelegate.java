...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(this.customEndIcon == 0 ? C1218R.drawable.design_password_eye : this.customEndIcon);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C1218R.string.password_toggle_content_description));
