...
public abstract class zzgy extends zzgi {
    ...
    /* synthetic */ zzgy(zzgv zzgvVar) {
    }

    public static int zzA(zzgr zzgrVar) {
        int iZzc = zzgrVar.zzc();
        return zzw(iZzc) + iZzc;
    }

    static int zzB(zziw zziwVar, zzjh zzjhVar) {
    ...
    @Deprecated
    static int zzE(int i, zziw zziwVar, zzjh zzjhVar) {
        int iZzw = zzw(i << 3);
        int i2 = iZzw + iZzw;
        zzgc zzgcVar = (zzgc) zziwVar;
        int iZzbq = zzgcVar.zzbq();
    ...
    public static int zzy(String str) {
        ...
        try {
            ...
            length = str.getBytes(zzhz.zza).length;
        }
        return zzw(length) + length;
    }

    public static int zzz(zzie zzieVar) {
    ...
    final void zzD(String str, zzkj zzkjVar) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzkjVar);
    ...
    public abstract void zzi(int i, zzgr zzgrVar) throws IOException;
