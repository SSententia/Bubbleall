...
public final class AdSize {
    ...
    public static AdSize getInlineAdaptiveBannerAdSize(int i, int i2) {
        ...
        adSize.zzf = true;
        if (i2 < 32) {
            StringBuilder sb = new StringBuilder(Cea708CCParser.Const.CODE_C1_CW1);
