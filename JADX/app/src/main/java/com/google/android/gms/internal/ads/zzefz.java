...
public final class zzefz extends zzccj implements zzdcm {
    ...
    public final synchronized void zze(IObjectWrapper iObjectWrapper) throws RemoteException {
        ...
        if (zzdizVar != null) {
            Executor executor = ((zzeir) zzdizVar).zzd.zzb;
    ...
    public final synchronized void zzf(IObjectWrapper iObjectWrapper, int i) throws RemoteException {
        zzdiz zzdizVar = this.zzc;
        if (zzdizVar != null) {
            String strValueOf = String.valueOf(((zzeir) zzdizVar).zzc.zza);
            com.google.android.gms.ads.internal.util.zze.zzi(strValueOf.length() != 0 ? "Fail to initialize adapter ".concat(strValueOf) : new String("Fail to initialize adapter "));
        }
    }
