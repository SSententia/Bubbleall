...
public final class MaterialFade extends MaterialVisibility<FadeProvider> {
    ...
    private static final int DEFAULT_THEMED_INCOMING_DURATION_ATTR = C1218R.attr.motionDurationShort2;
    private static final int DEFAULT_THEMED_OUTGOING_DURATION_ATTR = C1218R.attr.motionDurationShort1;
    private static final int DEFAULT_THEMED_EASING_ATTR = C1218R.attr.motionEasingLinear;
