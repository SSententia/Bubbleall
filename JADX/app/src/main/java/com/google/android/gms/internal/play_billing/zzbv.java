...
final class zzbv extends zzby {
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzbw(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            int i3 = i + iZzw2;
            this.zzd = i3;
            int iZzb = zzfu.zzb(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzq((iZzb - i) - iZzw2);
            this.zzd = iZzb;
        } catch (zzft e) {
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzbw(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e);
        }
    }
