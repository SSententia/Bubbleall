...
final class zzciy implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (rotation == 1) {
            SensorManager.remapCoordinateSystem(this.zzd, 2, Cea708CCParser.Const.CODE_C1_CW1, this.zze);
        } else if (rotation == 2) {
            SensorManager.remapCoordinateSystem(this.zzd, Cea708CCParser.Const.CODE_C1_CW1, Cea708CCParser.Const.CODE_C1_CW2, this.zze);
        } else if (rotation != 3) {
            System.arraycopy(this.zzd, 0, this.zze, 0, 9);
        } else {
            SensorManager.remapCoordinateSystem(this.zzd, Cea708CCParser.Const.CODE_C1_CW2, 1, this.zze);
        }
