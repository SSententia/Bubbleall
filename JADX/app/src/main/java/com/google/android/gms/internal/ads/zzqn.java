...
final class zzqn implements zzqs {
    ...
    public static zzqn zza(long j, zzakb zzakbVar, long j2) {
        ...
        for (int i2 = 1; i2 <= length; i2++) {
            int i3 = i2 - 1;
            j += (long) (zzakbVar.zzb + zzakbVar.zzd[i3]);
            j3 += (long) (zzakbVar.zzc + zzakbVar.zze[i3]);
            jArr[i2] = j;
            jArr2[i2] = j3;
        }
    ...
    private static Pair<Long, Long> zzd(long j, long[] jArr, long[] jArr2) {
        int iZzD = zzamq.zzD(jArr, j, true, true);
        long j2 = jArr[iZzD];
        long j3 = jArr2[iZzD];
        int i = iZzD + 1;
        if (i == jArr.length) {
    ...
    public final zzor zzf(long j) {
        Pair<Long, Long> pairZzd = zzd(zzadx.zza(zzamq.zzy(j, 0L, this.zzc)), this.zzb, this.zza);
        zzou zzouVar = new zzou(zzadx.zzb(((Long) pairZzd.first).longValue()), ((Long) pairZzd.second).longValue());
