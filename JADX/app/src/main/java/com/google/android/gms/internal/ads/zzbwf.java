...
public final class zzbwf extends zzbvi {
    ...
    private final Bundle zzR(String str, zzbdg zzbdgVar, String str2) throws RemoteException {
        ...
        zzcgt.zzd(strValueOf.length() != 0 ? "Server parameters: ".concat(strValueOf) : new String("Server parameters: "));
        try {
    ...
    public final zzbvv zzC() {
        ...
        UnifiedNativeAdMapper unifiedNativeAdMapperZzd;
        Object obj = this.zza;
        ...
        if (zzbwhVar == null || (unifiedNativeAdMapperZzd = zzbwhVar.zzd()) == null) {
            return null;
        }
        return new zzbwy(unifiedNativeAdMapperZzd);
    }
    ...
    public final void zzj(IObjectWrapper iObjectWrapper, zzbdl zzbdlVar, zzbdg zzbdgVar, String str, String str2, zzbvm zzbvmVar) throws RemoteException {
        ...
        AdSize adSizeZzb = zzbdlVar.zzn ? com.google.android.gms.ads.zza.zzb(zzbdlVar.zze, zzbdlVar.zzb) : com.google.android.gms.ads.zza.zza(zzbdlVar.zze, zzbdlVar.zzb, zzbdlVar.zza);
        Object obj2 = this.zza;
        if (!(obj2 instanceof MediationBannerAdapter)) {
            if (obj2 instanceof Adapter) {
                try {
                    ((Adapter) obj2).loadBannerAd(new MediationBannerAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), "", zzR(str, zzbdgVar, str2), zzS(zzbdgVar), zzT(zzbdgVar), zzbdgVar.zzk, zzbdgVar.zzg, zzbdgVar.zzt, zzU(str, zzbdgVar), adSizeZzb, this.zzj), new zzbwb(this, zzbvmVar));
                    return;
                } catch (Throwable th) {
                    zzcgt.zzg("", th);
                    throw new RemoteException();
        ...
        try {
            ...
            mediationBannerAdapter.requestBannerAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzbwh(zzbvmVar), zzR(str, zzbdgVar, str2), adSizeZzb, zzbvyVar, bundle != null ? bundle.getBundle(mediationBannerAdapter.getClass().getName()) : null);
        } catch (Throwable th2) {
            zzcgt.zzg("", th2);
            throw new RemoteException();
        }
    ...
    public final zzbnb zzz() {
        ...
        NativeCustomTemplateAd nativeCustomTemplateAdZze = zzbwhVar.zze();
        if (nativeCustomTemplateAdZze instanceof zzbnc) {
            return ((zzbnc) nativeCustomTemplateAdZze).zza();
        }
        return null;
    }
