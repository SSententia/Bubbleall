...
public final class zzil extends zzgi implements zzic {
    ...
    /* synthetic */ zzil(zzagk zzagkVar, zzai zzaiVar, zzhw zzhwVar, zzff zzffVar, zzku zzkuVar, int i, zzik zzikVar, byte[] bArr) {
    ...
    public final zzhe zzC(zzhf zzhfVar, zzko zzkoVar, long j) {
        zzaj zzajVarZza = this.zzc.zza();
        zzay zzayVar = this.zzk;
        if (zzayVar != null) {
            zzajVarZza.zza(zzayVar);
        }
        Uri uri = this.zzb.zza;
        zzhx zzhxVarZza = this.zzd.zza();
        zzff zzffVar = this.zze;
        zzfa zzfaVarZzh = zzh(zzhfVar);
        zzku zzkuVar = this.zzl;
        zzho zzhoVarZzf = zzf(zzhfVar);
        String str = this.zzb.zzf;
        return new zzig(uri, zzajVarZza, zzhxVarZza, zzffVar, zzfaVarZzh, zzkuVar, zzhoVarZzf, this, zzkoVar, null, this.zzf, null);
    }
