    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i2, new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.JobInfoSchedulerService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m443x1ff6a938(jobParameters);
            }
        });
        return true;
    }

    /* JADX INFO: renamed from: lambda$onStartJob$0$com-google-android-datatransport-runtime-scheduling-jobscheduling-JobInfoSchedulerService */
    /* synthetic */ void m443x1ff6a938(JobParameters jobParameters) {
