...
final class zzr {
    ...
    public final void zzf(zzbdg zzbdgVar, zzcgz zzcgzVar) {
        ...
        String strZze = zzbkp.zzc.zze();
        for (String str : bundle2.keySet()) {
            if (strZze.equals(str)) {
        ...
        if (zzbkp.zza.zze().booleanValue()) {
            try {
                Bundle bundleZzb = zzerv.zzb(this.zza, new JSONArray(zzbkp.zzb.zze()));
                for (String str2 : bundleZzb.keySet()) {
                    this.zzc.put(str2, bundleZzb.get(str2).toString());
                }
