...
final class zzfqu<V, X extends Throwable> extends zzfqv<V, X, zzfln<? super X, ? extends V>, V> {
    zzfqu(zzfsm<? extends V> zzfsmVar, Class<X> cls, zzfln<? super X, ? extends V> zzflnVar) {
