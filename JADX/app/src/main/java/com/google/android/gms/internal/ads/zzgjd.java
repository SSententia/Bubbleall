...
final class zzgjd {
    ...
    static int zzg(CharSequence charSequence) {
    ...
    static int zzh(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        char cCharAt;
        int length = charSequence.length();
    ...
    static String zzi(ByteBuffer byteBuffer, int i, int i2) throws zzggm {
        zzgja zzgjaVar = zza;
        if (byteBuffer.hasArray()) {
            return zzgjaVar.zzc(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? zzgjb.zzd(byteBuffer, i, i2) : zzgja.zzd(byteBuffer, i, i2);
    }

    static String zzj(byte[] bArr, int i, int i2) throws zzggm {
