...
public abstract class zzatq extends zzatu {
    ...
    public final zzatv zzd(zzans[] zzansVarArr, zzatg zzatgVar) throws zzamy {
        ...
        while (i5 < zzatgVar.zzb) {
            zzatf zzatfVarZza = zzatgVar.zza(i5);
            int i6 = i3;
            int i7 = 0;
            int i8 = 0;
            while (true) {
                ...
                int i9 = 0;
                while (true) {
                    int i10 = zzatfVarZza.zza;
                    if (i9 <= 0) {
                        int iZzG = zzansVar.zzG(zzatfVarZza.zza(i9)) & 3;
                        if (iZzG > i8) {
                            if (iZzG == 3) {
                                break;
                            }
            ...
            if (i7 == 2) {
                int i11 = zzatfVarZza.zza;
                iArr = new int[1];
            } else {
                zzans zzansVar2 = zzansVarArr[i7];
                int i12 = zzatfVarZza.zza;
                int[] iArr5 = new int[1];
                int i13 = 0;
                while (true) {
                    int i14 = zzatfVarZza.zza;
                    if (i13 > 0) {
                        break;
                    }
                    iArr5[i13] = zzansVar2.zzG(zzatfVarZza.zza(i13));
                    i13++;
                }
                iArr = iArr5;
            }
            int i15 = iArr2[i7];
            zzatfVarArr[i7][i15] = zzatfVarZza;
            iArr3[i7][i15] = iArr;
            iArr2[i7] = i15 + 1;
            i5++;
            i3 = 2;
        ...
        zzatk[] zzatkVarArrZzb = zzb(zzansVarArr, zzatgVarArr, iArr3);
        int i20 = 0;
        while (i20 < i19) {
            if (this.zzb.get(i20)) {
                zzatkVarArrZzb[i20] = null;
            } else {
        ...
        for (int i21 = 0; i21 < 2; i21++) {
            zzantVarArr[i21] = zzatkVarArrZzb[i21] != null ? zzant.zza : null;
        }
        return new zzatv(zzatgVar, new zzats(zzatkVarArrZzb, null), zzatoVar, zzantVarArr);
    }
