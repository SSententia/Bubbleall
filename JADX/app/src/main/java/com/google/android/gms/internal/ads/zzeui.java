...
public final class zzeui implements zzery<zzeuj> {
    ...
    zzeui(zzcge zzcgeVar, boolean z, zzcfu zzcfuVar, zzfsn zzfsnVar, String str, ScheduledExecutorService scheduledExecutorService, byte[] bArr) {
        this.zza = zzcgeVar;
        this.zzb = z;
        this.zzf = zzcfuVar;
        this.zzd = zzfsnVar;
    ...
    final /* synthetic */ zzeuj zzb(Exception exc) {
