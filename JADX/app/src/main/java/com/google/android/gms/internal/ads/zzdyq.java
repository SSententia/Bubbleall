...
public final class zzdyq {
    ...
    public final zzfsm<InputStream> zza(final zzcbj zzcbjVar) {
        ...
        zzfsm zzfsmVarZzc = com.google.android.gms.ads.internal.util.zzs.zzF(str) ? zzfsd.zzc(new zzeap(1)) : zzfsd.zzg(this.zza.zzb(new Callable(this, zzcbjVar) { // from class: com.google.android.gms.internal.ads.zzdyn
        ...
        return zzfsd.zzg(zzfsmVarZzc, zzeap.class, new zzfrk(this, zzcbjVar, callingUid) { // from class: com.google.android.gms.internal.ads.zzdyp
            private final zzdyq zza;
            private final zzcbj zzb;
    ...
    final /* synthetic */ zzfsm zzb(zzcbj zzcbjVar, int i, zzeap zzeapVar) throws Exception {
        return this.zzd.zzb().zzb(zzcbjVar, i);
    }

    final /* synthetic */ InputStream zzc(zzcbj zzcbjVar) throws Exception {
