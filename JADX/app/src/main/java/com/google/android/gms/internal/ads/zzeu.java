...
final class zzeu {
    ...
    private final void zzh(short[] sArr, int i, int i2) {
        ...
        this.zzl = sArrZzg;
        int i3 = this.zzb;
        System.arraycopy(sArr, i * i3, sArrZzg, this.zzm * i3, i3 * i2);
        this.zzm += i2;
    }
    ...
    public final void zzb(ShortBuffer shortBuffer) {
        ...
        this.zzj = sArrZzg;
        shortBuffer.get(sArrZzg, this.zzk * this.zzb, (i3 + i3) / 2);
        this.zzk += i2;
        zzk();
    }
    ...
    private final void zzk() {
                ...
                while (true) {
                    ...
                    if (i12 > 0) {
                        ...
                        if (this.zzb == i9 && i14 == i9) {
                            iZzj = zzj(sArr, i11, this.zzf, this.zzg);
                        } else {
                            zzi(sArr, i11, i14);
                            int iZzj2 = zzj(this.zzi, 0, this.zzf / i14, this.zzg / i14);
                            if (i14 != i9) {
                                int i15 = iZzj2 * i14;
                                int i16 = i14 * 4;
                                int i17 = i15 - i16;
                                ...
                                if (this.zzb == i9) {
                                    iZzj = zzj(sArr, i11, i17, i18);
                                } else {
                                    zzi(sArr, i11, i9);
                                    iZzj = zzj(this.zzi, 0, i17, i18);
                                }
                            } else {
                                iZzj = iZzj2;
                            }
                        ...
                        int i21 = this.zzu;
                        int i22 = (i21 == 0 || (i3 = this.zzs) == 0 || this.zzv > i21 * 3 || i21 + i21 <= this.zzt * 3) ? iZzj : i3;
                        this.zzt = i21;
                        this.zzs = iZzj;
                        if (d > 1.0d) {
                            ...
                            this.zzl = sArrZzg;
                            int i23 = i2;
                            zzl(i2, this.zzb, sArrZzg, this.zzm, sArr2, i11, sArr2, i11 + i22);
                            this.zzm += i23;
                            i11 += i22 + i23;
                        } else {
                            int i24 = i22;
                            ...
                            int i25 = i24 + i;
                            short[] sArrZzg2 = zzg(this.zzl, this.zzm, i25);
                            this.zzl = sArrZzg2;
                            int i26 = this.zzb;
                            System.arraycopy(sArr3, i11 * i26, sArrZzg2, this.zzm * i26, i26 * i24);
                            zzl(i, this.zzb, this.zzl, this.zzm + i24, sArr3, i11 + i24, sArr3, i11);
                            this.zzm += i25;
                            i11 += i;
                        }
                    }
        ...
        int i31 = this.zzm - i8;
        short[] sArrZzg3 = zzg(this.zzn, this.zzo, i31);
        this.zzn = sArrZzg3;
        short[] sArr5 = this.zzl;
        int i32 = this.zzb;
        System.arraycopy(sArr5, i8 * i32, sArrZzg3, this.zzo * i32, i32 * i31);
        this.zzm = i8;
        this.zzo += i31;
        int i33 = 0;
        while (true) {
        ...
        if (i5 != 0) {
            ...
            int i43 = this.zzb;
            System.arraycopy(sArr8, i5 * i43, sArr8, 0, (i4 - i5) * i43);
            this.zzo -= i5;
        }
    }
}
