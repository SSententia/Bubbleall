...
public final class zzj implements zzg {
    ...
    final /* synthetic */ void zzM(Context context, String str) {
    ...
    public final void zza(final Context context) {
        synchronized (this.zza) {
            ...
            this.zzd = zzchg.zza.zza(new Runnable(this, context, str) { // from class: com.google.android.gms.ads.internal.util.zzh
                private final zzj zza;
    ...
    public final void zzm(String str) {
        ...
        synchronized (this.zza) {
            ...
            if (str != null && !str.equals(this.zzl.zzd())) {
                this.zzl = new zzcfz(str, jCurrentTimeMillis);
                SharedPreferences.Editor editor = this.zzg;
                if (editor != null) {
            ...
            this.zzl.zza(jCurrentTimeMillis);
        }
    }
