...
public final class zzbts {
    ...
    protected final zzbtr zzf(zzaas zzaasVar) {
    ...
    public final zzbtm zzg(zzaas zzaasVar) {
        synchronized (this.zza) {
            ...
            this.zzh = 2;
            zzbtr zzbtrVarZzf = zzf(null);
            this.zzg = zzbtrVarZzf;
            return zzbtrVarZzf.zza();
        }
    }

    final /* synthetic */ void zzh(zzbsn zzbsnVar) {
        if (zzbsnVar.zzj()) {
            this.zzh = 1;
        }
    }

    final /* synthetic */ void zzi(zzaas zzaasVar, final zzbtr zzbtrVar) {
        try {
    ...
    final /* synthetic */ void zzj(zzbtr zzbtrVar, zzbsn zzbsnVar) {
        synchronized (this.zza) {
