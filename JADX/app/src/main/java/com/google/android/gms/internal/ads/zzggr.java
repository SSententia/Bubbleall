...
public final class zzggr extends zzgeh<String> implements RandomAccess, zzggs {
    ...
    private static String zzj(Object obj) {
        ...
        return obj instanceof zzgex ? ((zzgex) obj).zzA(zzggk.zza) : zzggk.zzd((byte[]) obj);
    }
    ...
    public final String get(int i) {
        ...
        if (obj instanceof zzgex) {
            ...
            String strZzA = zzgexVar.zzA(zzggk.zza);
            if (zzgexVar.zzm()) {
    ...
    public final /* bridge */ /* synthetic */ zzggj zze(int i) {
        ...
        return new zzggr((ArrayList<Object>) arrayList);
    }
