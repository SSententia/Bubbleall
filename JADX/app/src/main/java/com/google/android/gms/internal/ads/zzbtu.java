...
public final class zzbtu implements zzbsk, zzbtt {
    ...
    public final void zzc() {
        for (AbstractMap.SimpleEntry<String, zzbpr<? super zzbtt>> simpleEntry : this.zzb) {
            String strValueOf = String.valueOf(simpleEntry.getValue().toString());
            com.google.android.gms.ads.internal.util.zze.zza(strValueOf.length() != 0 ? "Unregistering eventhandler: ".concat(strValueOf) : new String("Unregistering eventhandler: "));
