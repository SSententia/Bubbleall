...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    private static final int DEFAULT_THEMED_DURATION_ATTR = C1218R.attr.motionDurationLong1;
    private static final int DEFAULT_THEMED_EASING_ATTR = C1218R.attr.motionEasingStandard;

    /* JADX INFO: renamed from: X */
    public static final int f230X = 0;

    /* JADX INFO: renamed from: Y */
    public static final int f231Y = 1;

    /* JADX INFO: renamed from: Z */
    public static final int f232Z = 2;
