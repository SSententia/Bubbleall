...
public final class zzaa {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            ...
            strZza = zzab.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static void zzd(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                ...
                strZze = (i2 < 0 || i2 > i3) ? zze(i2, i3, "end index") : zzab.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            }
