...
public final class zzdpl {
    ...
    public static final List<zzbhu> zzj(JSONObject jSONObject) {
        ...
        for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
            zzbhu zzbhuVarZzr = zzr(jSONArrayOptJSONArray.optJSONObject(i));
            if (zzbhuVarZzr != null) {
                arrayList.add(zzbhuVarZzr);
            }
        }
    ...
    private final zzfsm<zzblr> zzl(JSONObject jSONObject, boolean z) {
        ...
        if (z) {
            return zzfsd.zza(new zzblr(null, Uri.parse(strOptString), dOptDouble, iOptInt, iOptInt2));
        }
        return zzp(jSONObject.optBoolean("require"), zzfsd.zzj(this.zzb.zza(strOptString, dOptDouble, zOptBoolean), new zzfln(strOptString, dOptDouble, iOptInt, iOptInt2) { // from class: com.google.android.gms.internal.ads.zzdpc
    ...
    private final zzfsm<zzcml> zzn(JSONObject jSONObject, zzezz zzezzVar, zzfac zzfacVar) {
        final zzfsm<zzcml> zzfsmVarZzb = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString("html"), zzezzVar, zzfacVar, zzq(jSONObject.optInt("width", 0), jSONObject.optInt("height", 0)));
        return zzfsd.zzi(zzfsmVarZzb, new zzfrk(zzfsmVarZzb) { // from class: com.google.android.gms.internal.ads.zzdph
            private final zzfsm zza;

            {
                this.zza = zzfsmVarZzb;
            }

            @Override // com.google.android.gms.internal.ads.zzfrk
            public final zzfsm zza(Object obj) throws zzehs {
    ...
    private static <T> zzfsm<T> zzo(zzfsm<T> zzfsmVar, T t) {
        ...
        return zzfsd.zzg(zzfsmVar, Exception.class, new zzfrk(obj) { // from class: com.google.android.gms.internal.ads.zzdpi
            @Override // com.google.android.gms.internal.ads.zzfrk
    ...
    private static final zzbhu zzr(JSONObject jSONObject) {
        ...
        return new zzbhu(strOptString, strOptString2);
    }
    ...
    public final zzfsm<List<zzblr>> zzb(JSONObject jSONObject, String str) {
        ...
        return zzk(jSONArrayOptJSONArray, zzblvVar.zzb, zzblvVar.zzd);
    }
    ...
    public final zzfsm<zzcml> zzc(JSONObject jSONObject, String str, final zzezz zzezzVar, final zzfac zzfacVar) {
        ...
        final zzbdl zzbdlVarZzq = zzq(jSONObjectOptJSONObject.optInt("width", 0), jSONObjectOptJSONObject.optInt("height", 0));
        if (TextUtils.isEmpty(strOptString2)) {
            return zzfsd.zza(null);
        }
        final zzfsm zzfsmVarZzi = zzfsd.zzi(zzfsd.zza(null), new zzfrk(this, zzbdlVarZzq, zzezzVar, zzfacVar, strOptString, strOptString2) { // from class: com.google.android.gms.internal.ads.zzdpd
            ...
            {
                this.zza = this;
                this.zzb = zzbdlVarZzq;
                this.zzc = zzezzVar;
                this.zzd = zzfacVar;
                this.zze = strOptString;
                this.zzf = strOptString2;
            }
        ...
        return zzfsd.zzi(zzfsmVarZzi, new zzfrk(zzfsmVarZzi) { // from class: com.google.android.gms.internal.ads.zzdpe
            private final zzfsm zza;

            {
                this.zza = zzfsmVarZzi;
            }
    ...
    public final zzfsm<zzblo> zzd(JSONObject jSONObject, String str) {
        ...
        return zzp(jSONObjectOptJSONObject.optBoolean("require"), zzfsd.zzj(zzk(jSONArrayOptJSONArray, false, true), new zzfln(this, jSONObjectOptJSONObject) { // from class: com.google.android.gms.internal.ads.zzdpf
            private final zzdpl zza;
            private final JSONObject zzb;

            {
                this.zza = this;
                this.zzb = jSONObjectOptJSONObject;
            }
    ...
    public final zzfsm<zzcml> zze(JSONObject jSONObject, zzezz zzezzVar, zzfac zzfacVar) {
        zzfsm<zzcml> zzfsmVarZza;
        JSONObject jSONObjectZzh = com.google.android.gms.ads.internal.util.zzbx.zzh(jSONObject, "html_containers", "instream");
        if (jSONObjectZzh != null) {
            return zzn(jSONObjectZzh, zzezzVar, zzfacVar);
        }
        ...
        boolean z = false;
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgN)).booleanValue() && jSONObjectOptJSONObject.has("html")) {
            z = true;
        }
        if (!TextUtils.isEmpty(strOptString)) {
            if (!z) {
                zzfsmVarZza = this.zzi.zza(jSONObjectOptJSONObject);
            }
            return zzo(zzfsd.zzh(zzfsmVarZza, ((Integer) zzbet.zzc().zzc(zzbjl.zzcl)).intValue(), TimeUnit.SECONDS, this.zzk), null);
        }
        if (!z) {
            com.google.android.gms.ads.internal.util.zze.zzi("Required field 'vast_xml' or 'html' is missing");
            return zzfsd.zza(null);
        }
        zzfsmVarZza = zzn(jSONObjectOptJSONObject, zzezzVar, zzfacVar);
        return zzo(zzfsd.zzh(zzfsmVarZza, ((Integer) zzbet.zzc().zzc(zzbjl.zzcl)).intValue(), TimeUnit.SECONDS, this.zzk), null);
    }

    final /* synthetic */ zzfsm zzf(String str, Object obj) throws Exception {
        com.google.android.gms.ads.internal.zzt.zzd();
        zzcml zzcmlVarZza = zzcmx.zza(this.zza, zzcob.zzb(), "native-omid", false, false, this.zzc, null, this.zzd, null, null, this.zze, this.zzf, null, null);
        final zzchk zzchkVarZza = zzchk.zza(zzcmlVarZza);
        zzcmlVarZza.zzR().zzy(new zzcnx(zzchkVarZza) { // from class: com.google.android.gms.internal.ads.zzdpk
            private final zzchk zza;

            {
                this.zza = zzchkVarZza;
            }
        ...
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzdx)).booleanValue()) {
            zzcmlVarZza.loadData(Base64.encodeToString(str.getBytes(), 1), "text/html", "base64");
        } else {
            zzcmlVarZza.loadData(str, "text/html", Key.STRING_CHARSET_NAME);
        }
        return zzchkVarZza;
    }

    final /* synthetic */ zzblo zzg(JSONObject jSONObject, List list) {
        if (list == null || list.isEmpty()) {
            return null;
        }
        String strOptString = jSONObject.optString("text");
        Integer numZzm = zzm(jSONObject, "bg_color");
        Integer numZzm2 = zzm(jSONObject, "text_color");
        ...
        return new zzblo(strOptString, list, numZzm, numZzm2, iOptInt > 0 ? Integer.valueOf(iOptInt) : null, jSONObject.optInt("presentation_ms", 4000) + iOptInt2, this.zzh.zze, zOptBoolean);
    }

    final /* synthetic */ zzfsm zzh(zzbdl zzbdlVar, zzezz zzezzVar, zzfac zzfacVar, String str, String str2, Object obj) throws Exception {
        zzcml zzcmlVarZzb = this.zzj.zzb(zzbdlVar, zzezzVar, zzfacVar);
        final zzchk zzchkVarZza = zzchk.zza(zzcmlVarZzb);
        zzdrk zzdrkVarZzb = this.zzl.zzb();
        zzcmlVarZzb.zzR().zzL(zzdrkVarZzb, zzdrkVarZzb, zzdrkVarZzb, zzdrkVarZzb, zzdrkVarZzb, false, null, new com.google.android.gms.ads.internal.zzb(this.zza, null, null), null, null, this.zzp, this.zzo, this.zzm, this.zzn, null, zzdrkVarZzb);
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzck)).booleanValue()) {
            zzcmlVarZzb.zzab("/getNativeAdViewSignals", zzbpq.zzs);
        }
        zzcmlVarZzb.zzab("/getNativeClickMeta", zzbpq.zzt);
        zzcmlVarZzb.zzR().zzy(new zzcnx(zzchkVarZza) { // from class: com.google.android.gms.internal.ads.zzdpb
            private final zzchk zza;
        ...
        zzcmlVarZzb.zzat(str, str2, null);
        return zzchkVarZza;
    }
