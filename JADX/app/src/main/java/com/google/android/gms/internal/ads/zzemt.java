...
public final class zzemt implements zzerx<Bundle> {
    ...
    public final /* bridge */ /* synthetic */ void zzf(Bundle bundle) {
        ...
        zzfbd.zzb(bundle2, "smart_h", DebugKt.DEBUG_PROPERTY_VALUE_AUTO, this.zza.zzb == -2);
        ...
        String str = this.zzd;
        zzfbd.zzb(bundle2, "sz", str, !TextUtils.isEmpty(str));
        bundle2.putFloat("u_sd", this.zze);
        bundle2.putInt("sw", this.zzf);
        bundle2.putInt("sh", this.zzg);
        String str2 = this.zzh;
        zzfbd.zzb(bundle2, "sc", str2, !TextUtils.isEmpty(str2));
