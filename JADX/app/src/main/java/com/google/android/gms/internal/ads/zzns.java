...
public final class zzns {
    ...
    public static zzafv zza(byte[] bArr, String str, String str2, zzn zznVar) {
        ...
        if (bArr[0] == 127) {
            ...
            zzameVar = new zzame(bArrCopyOf, length);
            if (bArrCopyOf[0] == 31) {
                zzame zzameVar2 = new zzame(bArrCopyOf, length);
                while (zzameVar2.zzb() >= 16) {
                    zzameVar2.zzf(2);
                    zzameVar.zzl(zzameVar2.zzh(14), 14);
                }
            }
            zzameVar.zza(bArrCopyOf, bArrCopyOf.length);
        }
        zzameVar.zzf(60);
        int i3 = zzb[zzameVar.zzh(6)];
        int i4 = zzc[zzameVar.zzh(4)];
        int iZzh = zzameVar.zzh(5);
        int i5 = iZzh < 29 ? (zzd[iZzh] * 1000) / 2 : -1;
        zzameVar.zzf(10);
