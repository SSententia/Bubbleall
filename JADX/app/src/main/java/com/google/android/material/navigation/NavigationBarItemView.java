...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C1218R.id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C1218R.id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C1218R.id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C1218R.id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C1218R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C1218R.id.navigation_bar_item_large_label_view);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1218R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1218R.attr.motionDurationLong1, getResources().getInteger(C1218R.integer.material_motion_duration_long_1)));
    ...
    protected int getItemBackgroundResId() {
        return C1218R.drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C1218R.dimen.mtrl_navigation_bar_item_default_margin;
    }
