...
final class zzht implements zzhe, zzhd {
    ...
    public final zzhe zza(int i) {
        zzhe zzheVar = this.zza[i];
        return zzheVar instanceof zzhr ? ((zzhr) zzheVar).zza : zzheVar;
    }
    ...
    public final long zzg() {
        ...
        for (zzhe zzheVar : this.zzf) {
            long jZzg = zzheVar.zzg();
            if (jZzg == -9223372036854775807L) {
                if (j != -9223372036854775807L && zzheVar.zzi(j) != j) {
    ...
    public final void zzn(zzhe zzheVar) {
        ...
        if (this.zzc.isEmpty()) {
            ...
            for (zzhe zzheVar3 : this.zza) {
                zzs zzsVarZzd = zzheVar3.zzd();
                int i3 = zzsVarZzd.zzb;
                int i4 = 0;
                while (i4 < i3) {
                    zzqVarArr[i2] = zzsVarZzd.zza(i4);
                    i4++;
                    i2++;
                }
            }
    ...
    public final long zzq(zzjg[] zzjgVarArr, boolean[] zArr, zziu[] zziuVarArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            if (zzjgVar != null) {
                ...
                while (true) {
                    ...
                    if (zzheVarArr[i2].zzd().zzb(zzqVarZzb) != -1) {
                        iArr2[i] = i2;
                        break;
                    }
                    i2++;
        ...
        while (i3 < this.zza.length) {
            ...
            long jZzq = this.zza[i3].zzq(zzjgVarArr2, zArr, zziuVarArr3, zArr2, j2);
            if (i5 == 0) {
                j2 = jZzq;
            } else if (jZzq != j2) {
