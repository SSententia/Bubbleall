...
public final class zzamd {
    ...
    static /* synthetic */ void zzd(zzamd zzamdVar, int i) {
        synchronized (zzamdVar.zzd) {
            if (zzamdVar.zze == i) {
                return;
            }
            zzamdVar.zze = i;
            for (WeakReference<zzalz> weakReference : zzamdVar.zzc) {
                zzalz zzalzVar = weakReference.get();
                if (zzalzVar != null) {
                    zzalzVar.zza(i);
                } else {
                    zzamdVar.zzc.remove(weakReference);
                }
            }
        }
    }
    ...
    public final void zzb(final zzalz zzalzVar) {
        for (WeakReference<zzalz> weakReference : this.zzc) {
