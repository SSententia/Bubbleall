...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C1218R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    public static ColorRoles getColorRoles(Context context, int i) {
        return getColorRoles(i, MaterialAttributes.resolveBoolean(context, C1218R.attr.isLightTheme, true));
    }
