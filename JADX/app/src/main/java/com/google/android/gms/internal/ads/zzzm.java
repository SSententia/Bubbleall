...
public final class zzzm extends zzgga<zzzm, zzzl> implements zzghj {
    ...
    static /* synthetic */ void zzd(zzzm zzzmVar, zzgex zzgexVar) {
    ...
    static /* synthetic */ void zze(zzzm zzzmVar, zzgex zzgexVar) {
        zzzmVar.zzb |= 1;
        zzzmVar.zzf = zzgexVar;
    }

    static /* synthetic */ void zzf(zzzm zzzmVar, int i) {
        zzzmVar.zzh = i - 1;
        zzzmVar.zzb |= 4;
    }
