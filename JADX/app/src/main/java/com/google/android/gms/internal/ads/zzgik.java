...
class zzgik<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgig zzgigVarRemove = this.zzb.remove(i2 - 1);
            zzn().put(zzgigVarRemove.zza(), zzgigVarRemove.getValue());
        }
