...
public final class zzdlm implements zzdmu {
    ...
    private final boolean zzE(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        ...
        try {
            ...
            DisplayMetrics displayMetricsZzy = com.google.android.gms.ads.internal.util.zzs.zzy((WindowManager) context.getSystemService("window"));
            zzdll zzdllVar = null;
            try {
                jSONObject7.put("width", zzber.zza().zza(context, displayMetricsZzy.widthPixels));
                jSONObject7.put("height", zzber.zza().zza(context, displayMetricsZzy.heightPixels));
            } catch (JSONException unused) {
                jSONObject7 = null;
            }
            jSONObject6.put("screen", jSONObject7);
            if (((Boolean) zzbet.zzc().zzc(zzbjl.zzgc)).booleanValue()) {
                this.zzd.zze("/clickRecorded", new zzdlj(this, zzdllVar));
            } else {
                this.zzd.zze("/logScionEvent", new zzdli(this, zzdllVar));
            }
            this.zzd.zze("/nativeImpression", new zzdlk(this, zzdllVar));
    ...
    public final void zzd(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, View.OnTouchListener onTouchListener, View.OnClickListener onClickListener) {
        ...
        this.zzm.zzk(this);
        boolean zZza = com.google.android.gms.ads.internal.util.zzca.zza(this.zzk.zzc);
        if (map != null) {
    ...
    public final void zzf(View view, View view2, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        JSONObject jSONObjectZze = com.google.android.gms.ads.internal.util.zzca.zze(this.zza, map, map2, view2);
        JSONObject jSONObjectZzb = com.google.android.gms.ads.internal.util.zzca.zzb(this.zza, view2);
        JSONObject jSONObjectZzc = com.google.android.gms.ads.internal.util.zzca.zzc(view2);
        JSONObject jSONObjectZzd = com.google.android.gms.ads.internal.util.zzca.zzd(this.zza, view2);
        String strZzC = zzC(view, map);
        zzl(true == ((Boolean) zzbet.zzc().zzc(zzbjl.zzcb)).booleanValue() ? view2 : view, jSONObjectZzb, jSONObjectZze, jSONObjectZzc, jSONObjectZzd, strZzC, com.google.android.gms.ads.internal.util.zzca.zzf(strZzC, this.zza, this.zzw, this.zzv), null, z, false);
    }
    ...
    public final void zzi(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        ...
        JSONObject jSONObjectZze = com.google.android.gms.ads.internal.util.zzca.zze(this.zza, map, map2, view);
        JSONObject jSONObjectZzb = com.google.android.gms.ads.internal.util.zzca.zzb(this.zza, view);
        JSONObject jSONObjectZzc = com.google.android.gms.ads.internal.util.zzca.zzc(view);
        JSONObject jSONObjectZzd = com.google.android.gms.ads.internal.util.zzca.zzd(this.zza, view);
        String strZzC = zzC(null, map);
        zzl(view, jSONObjectZzb, jSONObjectZze, jSONObjectZzc, jSONObjectZzd, strZzC, com.google.android.gms.ads.internal.util.zzca.zzf(strZzC, this.zza, this.zzw, this.zzv), null, z, true);
    }
    ...
    protected final void zzl(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) {
        ...
        try {
            ...
            try {
                ...
                strZzm = this.zzf.zzb().zzm(this.zza, jSONObjectOptJSONObject.optString("click_string"), view);
            } catch (Exception e) {
                com.google.android.gms.ads.internal.util.zze.zzg("Exception obtaining click signals", e);
                strZzm = null;
            }
            jSONObject8.put("click_signals", strZzm);
            ...
            jSONObject9.put("time_from_last_touch_down", jCurrentTimeMillis - this.zzx);
            jSONObject9.put("time_from_last_touch", jCurrentTimeMillis - this.zzy);
    ...
    public final void zzm(View view, MotionEvent motionEvent, View view2) {
        ...
        if (motionEvent.getAction() == 0) {
            this.zzx = jCurrentTimeMillis;
            this.zzw = this.zzv;
        }
        MotionEvent motionEventObtain = MotionEvent.obtain(motionEvent);
        motionEventObtain.setLocation(this.zzv.x, this.zzv.y);
    ...
    public final JSONObject zzp(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2) {
        JSONObject jSONObjectZzo = zzo(view, map, map2);
        JSONObject jSONObject = new JSONObject();
        try {
            if (this.zzu && zzD()) {
            ...
            if (jSONObjectZzo != null) {
                jSONObject.put("nas", jSONObjectZzo);
            }
        } catch (JSONException e) {
    ...
    public final void zzx(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2) {
        ...
        if (((Boolean) zzbet.zzc().zzc(zzbjl.zzca)).booleanValue()) {
            try {
                strZzo = this.zzf.zzb().zzo(this.zza, view, null);
        ...
        zzE(jSONObjectZzb, jSONObjectZze, jSONObjectZzc, jSONObjectZzd, strZzo, null, com.google.android.gms.ads.internal.util.zzca.zzi(this.zza, this.zzj));
    }
