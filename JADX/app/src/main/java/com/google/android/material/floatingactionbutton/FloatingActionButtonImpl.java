...
class FloatingActionButtonImpl {
    ...
    void hide(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            if (motionSpec != null) {
                ...
                animatorSetCreateDefaultAnimator = createDefaultAnimator(0.0f, 0.4f, 0.4f);
            }
    ...
    void show(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            if (motionSpec != null) {
                ...
                animatorSetCreateDefaultAnimator = createDefaultAnimator(1.0f, 1.0f, 1.0f);
            }
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), C1218R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C1218R.integer.material_motion_duration_long_1)));
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C1218R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
