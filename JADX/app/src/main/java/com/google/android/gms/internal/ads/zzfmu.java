...
final class zzfmu extends zzfmx implements NavigableMap {
    ...
    zzfmu(zzfnd zzfndVar, NavigableMap navigableMap) {
    ...
    final Map.Entry zzc(Iterator<Map.Entry> it) {
        ...
        Collection collectionZzc = this.zzc.zzc();
        collectionZzc.addAll((Collection) next.getValue());
        it.remove();
        return new zzfof(next.getKey(), this.zzc.zza(collectionZzc));
    }
