...
public final class zzbbn extends zzgga<zzbbn, zzbbj> implements zzghj {
    ...
    static /* synthetic */ void zzd(zzbbn zzbbnVar, Iterable iterable) {
    ...
    static /* synthetic */ void zze(zzbbn zzbbnVar, int i) {
        zzbbnVar.zzb |= 1;
        zzbbnVar.zzf = i;
    }

    static /* synthetic */ void zzf(zzbbn zzbbnVar, int i) {
        zzbbnVar.zzb |= 2;
        zzbbnVar.zzg = i;
    }

    static /* synthetic */ void zzg(zzbbn zzbbnVar, long j) {
        zzbbnVar.zzb |= 4;
        zzbbnVar.zzh = j;
    }

    static /* synthetic */ void zzh(zzbbn zzbbnVar, String str) {
        str.getClass();
        zzbbnVar.zzb |= 8;
        zzbbnVar.zzi = str;
    }

    static /* synthetic */ void zzi(zzbbn zzbbnVar, String str) {
        str.getClass();
        zzbbnVar.zzb |= 16;
        zzbbnVar.zzj = str;
    }

    static /* synthetic */ void zzj(zzbbn zzbbnVar, long j) {
        zzbbnVar.zzb |= 32;
        zzbbnVar.zzk = j;
    }
