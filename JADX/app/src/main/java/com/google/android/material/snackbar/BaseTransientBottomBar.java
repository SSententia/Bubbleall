...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C1218R.attr.snackbarStyle};
    ...
    protected int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1218R.layout.mtrl_layout_snackbar : C1218R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C1218R.styleable.SnackbarLayout);
            if (typedArrayObtainStyledAttributes.hasValue(C1218R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1218R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = typedArrayObtainStyledAttributes.getInt(C1218R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1218R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1218R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1218R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = typedArrayObtainStyledAttributes.getFloat(C1218R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            this.maxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1218R.styleable.SnackbarLayout_android_maxWidth, -1);
            this.maxInlineActionWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1218R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
            typedArrayObtainStyledAttributes.recycle();
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C1218R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C1218R.attr.colorSurface, C1218R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
