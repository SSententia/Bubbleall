...
public final class zzdxl implements zzgla<zzdxk> {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        Executor executorZzb = this.zza.zzb();
        Context contextZza = ((zzcoo) this.zzb).zza();
        WeakReference<Context> weakReferenceZza = ((zzcop) this.zzc).zza();
        zzfsn zzfsnVar = zzchg.zza;
        zzgli.zzb(zzfsnVar);
        return new zzdxk(executorZzb, contextZza, weakReferenceZza, zzfsnVar, this.zze.zzb(), this.zzf.zzb(), this.zzg.zzb(), ((zzcox) this.zzh).zza(), ((zzdhu) this.zzi).zzb());
    }
}
