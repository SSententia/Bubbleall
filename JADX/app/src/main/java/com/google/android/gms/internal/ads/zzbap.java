...
public final class zzbap extends zzgga<zzbap, zzbao> implements zzghj {
    ...
    static /* synthetic */ void zzg(zzbap zzbapVar, String str) {
        str.getClass();
        zzbapVar.zzb |= 2;
        zzbapVar.zzf = str;
    }

    static /* synthetic */ void zzh(zzbap zzbapVar, Iterable iterable) {
        zzggi zzggiVar = zzbapVar.zzj;
        if (!zzggiVar.zza()) {
            int size = zzggiVar.size();
            zzbapVar.zzj = zzggiVar.zze(size == 0 ? 10 : size + size);
        }
        zzgeg.zzar(iterable, zzbapVar.zzj);
    }

    static /* synthetic */ void zzj(zzbap zzbapVar, zzbah zzbahVar) {
        zzbahVar.getClass();
        zzbapVar.zzk = zzbahVar;
        zzbapVar.zzb |= 32;
    }

    static /* synthetic */ void zzk(zzbap zzbapVar, zzazl zzazlVar) {
        zzazlVar.getClass();
        zzbapVar.zzn = zzazlVar;
        zzbapVar.zzb |= 256;
    }

    static /* synthetic */ void zzl(zzbap zzbapVar, zzbbn zzbbnVar) {
        zzbbnVar.getClass();
        zzbapVar.zzo = zzbbnVar;
        zzbapVar.zzb |= 512;
    }

    static /* synthetic */ void zzm(zzbap zzbapVar, zzbcu zzbcuVar) {
        zzbcuVar.getClass();
        zzbapVar.zzp = zzbcuVar;
        zzbapVar.zzb |= 1024;
    }

    static /* synthetic */ void zzn(zzbap zzbapVar, zzazu zzazuVar) {
        zzazuVar.getClass();
