...
public abstract class zzbfi extends zzadk implements zzbfj {
    ...
    protected final boolean zzbz(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                zzbfg zzbfgVarZze = zze();
                parcel2.writeNoException();
                zzadl.zzf(parcel2, zzbfgVarZze);
                return true;
            case 2:
            ...
            case 7:
                ...
                if (strongBinder2 != null) {
                    ...
                    zzbfyVar = iInterfaceQueryLocalInterface2 instanceof zzbfy ? (zzbfy) iInterfaceQueryLocalInterface2 : new zzbfy(strongBinder2);
                }
                zzq(zzbfyVar);
                parcel2.writeNoException();
                return true;
