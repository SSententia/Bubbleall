...
public final class zzegw implements zzegq<zzdmh> {
    ...
    private final zzfsm<zzdmh> zzg(final zzfal zzfalVar, final zzezz zzezzVar, final JSONObject jSONObject) {
        final zzfsm<zzdrh> zzfsmVarZzb = this.zzd.zzb();
        final zzfsm<zzdmm> zzfsmVarZza = this.zzc.zza(zzfalVar, zzezzVar, jSONObject);
        return zzfsd.zzn(zzfsmVarZzb, zzfsmVarZza).zza(new Callable(this, zzfsmVarZza, zzfsmVarZzb, zzfalVar, zzezzVar, jSONObject) { // from class: com.google.android.gms.internal.ads.zzegv
    ...
    final /* synthetic */ zzdmh zzc(zzfsm zzfsmVar, zzfsm zzfsmVar2, zzfal zzfalVar, zzezz zzezzVar, JSONObject jSONObject) throws Exception {
        zzdmm zzdmmVar = (zzdmm) zzfsmVar.get();
        zzdrh zzdrhVar = (zzdrh) zzfsmVar2.get();
        zzdmn zzdmnVarZzT = this.zza.zzT(new zzcxv(zzfalVar, zzezzVar, null), new zzdmy(zzdmmVar), new zzdlo(jSONObject, zzdrhVar));
        zzdmnVarZzT.zzi().zzb();
        zzdmnVarZzT.zzj().zza(zzdrhVar);
        zzdmnVarZzT.zzk().zza(zzdmmVar.zzR());
        zzdmnVarZzT.zzl().zza(this.zze);
        return zzdmnVarZzT.zzh();
    }

    final /* synthetic */ zzfsm zzd(zzdrh zzdrhVar, JSONObject jSONObject) throws Exception {
    ...
    final /* synthetic */ zzfsm zze(zzfal zzfalVar, zzezz zzezzVar, JSONArray jSONArray) throws Exception {
    ...
    final /* synthetic */ zzfsm zzf(zzezz zzezzVar, final zzdrh zzdrhVar) throws Exception {
