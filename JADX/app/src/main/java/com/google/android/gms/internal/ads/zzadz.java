...
public final class zzadz {
    ...
    /* synthetic */ zzadz(float f, float f2, long j, float f3, long j2, long j3, float f4, zzady zzadyVar) {
        this.zza = j2;
        this.zzb = j3;
    }
    ...
    public final float zzd(long j, long j2) {
        ...
        if (this.zzh > j6) {
            float fZzb = zzadx.zzb(1000L);
            long[] jArr = {j6, this.zze, this.zzh - (((long) ((this.zzk - 1.0f) * fZzb)) + ((long) ((this.zzi - 1.0f) * fZzb)))};
            j3 = jArr[0];
            for (int i = 1; i < 3; i++) {
                long j7 = jArr[i];
                if (j7 > j3) {
            ...
            long jZzy = zzamq.zzy(j - ((long) (Math.max(0.0f, this.zzk - 1.0f) / 1.0E-7f)), this.zzh, j6);
            this.zzh = jZzy;
            long j8 = this.zzg;
            if (j8 == -9223372036854775807L || jZzy <= j8) {
                j3 = jZzy;
            } else {
                this.zzh = j8;
                j3 = j8;
        ...
        float fZzz = zzamq.zzz((j9 * 1.0E-7f) + 1.0f, this.zzj, this.zzi);
        this.zzk = fZzz;
        return fZzz;
    }
}
