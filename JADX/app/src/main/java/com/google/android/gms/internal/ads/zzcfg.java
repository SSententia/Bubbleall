...
final class zzcfg {
    ...
    zzcfg(Context context, zzced zzcedVar) {
        this.zzc = context;
        this.zzd = zzcedVar;
    }

    final synchronized void zzb(zzcff zzcffVar) {
    ...
    final /* synthetic */ void zzd(Map map, SharedPreferences sharedPreferences, String str, String str2) {
