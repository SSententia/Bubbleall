...
public final class GmsLogger {
    ...
    public void m467d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zza(str2));
        }
    }
    ...
    public void m469e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zza(str2));
        }
    }
    ...
    public void m471i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zza(str2));
        }
    }
    ...
    public void m473v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zza(str2));
        }
    }
    ...
    public void m475w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zza(str2));
        }
    }
    ...
    /* JADX INFO: renamed from: d */
    public void m468d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* JADX INFO: renamed from: e */
    public void m470e(String str, String str2, Throwable th) {
        if (canLog(6)) {
            Log.e(str, zza(str2), th);
        }
    }
    ...
    /* JADX INFO: renamed from: i */
    public void m472i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* JADX INFO: renamed from: v */
    public void m474v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* JADX INFO: renamed from: w */
    public void m476w(String str, String str2, Throwable th) {
        if (canLog(5)) {
