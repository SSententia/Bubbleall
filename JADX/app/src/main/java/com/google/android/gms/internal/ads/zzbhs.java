...
public final class zzbhs {
    ...
    static /* synthetic */ boolean zzb(zzbhs zzbhsVar, boolean z) {
        zzbhsVar.zze = false;
        return false;
    }

    static /* synthetic */ boolean zzc(zzbhs zzbhsVar, boolean z) {
        zzbhsVar.zzf = true;
        return true;
    }
    ...
    public final void zzf(Context context, @Nullable String str, @Nullable final OnInitializationCompleteListener onInitializationCompleteListener) {
        synchronized (this.zzb) {
            ...
            try {
                ...
                zzw(context);
                if (onInitializationCompleteListener != null) {
                    this.zzd.zzp(new zzbhr(this, zzbhpVar));
                }
    ...
    public final void zzt(WebView webView) {
        ...
        synchronized (this.zzb) {
            ...
            zzcfn zzcfnVarZza = zzcah.zza(webView.getContext());
            if (zzcfnVarZza == null) {
                zzcgt.zzi("Internal error, query info generator is null.");
                return;
            }
            try {
                zzcfnVarZza.zzj(ObjectWrapper.wrap(webView));
            } catch (RemoteException e) {
                zzcgt.zzg("", e);
            }
        }
