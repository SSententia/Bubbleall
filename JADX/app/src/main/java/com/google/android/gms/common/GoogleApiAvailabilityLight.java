...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        ...
        Uri.Builder builderAppendQueryParameter = Uri.parse("market://details").buildUpon().appendQueryParameter(MediaConstants.MEDIA_URI_QUERY_ID, "com.google.android.gms");
