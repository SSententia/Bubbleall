...
public final class zzctg implements zzgla<zzctf> {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        zzgli.zzb(zzfsnVar);
        return new zzctf(contextZza, zzfsnVar, this.zzc.zzb(), this.zzd.zzb(), ((zzcxz) this.zze).zza(), ((zzcxw) this.zzf).zza(), this.zzg.zzb(), this.zzh.zzb(), this.zzi.zzb(), this.zzj.zzb(), this.zzk.zzb(), new zzbkm(), null);
    }
}
