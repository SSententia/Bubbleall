...
public final class zzekl extends zzbfi {
    ...
    public final zzbfg zze() {
        zzdmx zzdmxVarZzg = this.zzb.zzg();
        this.zza.zzC(zzdmxVarZzg.zzh());
        this.zza.zzD(zzdmxVarZzg.zzi());
        zzfap zzfapVar = this.zza;
        if (zzfapVar.zzv() == null) {
            zzfapVar.zzt(zzbdl.zzb());
        }
        return new zzekm(this.zzc, this.zzd, this.zza, zzdmxVarZzg, this.zze);
    }
