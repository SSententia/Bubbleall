...
public final class zzejj implements zzeec<zzcvh> {
    ...
    public final zzfsm<zzcvh> zzb(zzfal zzfalVar, zzezz zzezzVar) {
        zzcvi zzcviVarZzaa = this.zzb.zzaa(new zzcxv(zzfalVar, zzezzVar, null), new zzejh(this, new View(this.zza), null, zzejf.zza, zzezzVar.zzu.get(0)));
        zzeji zzejiVarZzk = zzcviVarZzaa.zzk();
        zzfae zzfaeVar = zzezzVar.zzs;
        final zzbkb zzbkbVar = new zzbkb(zzejiVarZzk, zzfaeVar.zzb, zzfaeVar.zza);
        ...
        }, this.zzd, zzfem.CUSTOM_RENDER_SYN, zzfesVar).zzj(zzfem.CUSTOM_RENDER_ACK).zze(zzfsd.zza(zzcviVarZzaa.zzh())).zzi();
    }

    final /* synthetic */ void zzc(zzbkb zzbkbVar) throws Exception {
