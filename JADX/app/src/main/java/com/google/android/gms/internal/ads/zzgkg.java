...
public final class zzgkg extends zzgga<zzgkg, zzgji> implements zzghj {
    ...
    static /* synthetic */ void zzg(zzgkg zzgkgVar, String str) {
        str.getClass();
        zzgkgVar.zzb |= 4;
        zzgkgVar.zzg = str;
    }

    static /* synthetic */ void zzh(zzgkg zzgkgVar, String str) {
        str.getClass();
        zzgkgVar.zzb |= 8;
        zzgkgVar.zzh = str;
    }

    static /* synthetic */ void zzi(zzgkg zzgkgVar, zzgjk zzgjkVar) {
        zzgjkVar.getClass();
        zzgkgVar.zzj = zzgjkVar;
        zzgkgVar.zzb |= 32;
    }

    static /* synthetic */ void zzj(zzgkg zzgkgVar, zzgkd zzgkdVar) {
        zzgkdVar.getClass();
    ...
    static /* synthetic */ void zzk(zzgkg zzgkgVar, String str) {
        zzgkgVar.zzb |= 64;
        zzgkgVar.zzl = str;
    }

    static /* synthetic */ void zzl(zzgkg zzgkgVar) {
        zzgkgVar.zzb &= -65;
        zzgkgVar.zzl = zzx.zzl;
    }

    static /* synthetic */ void zzm(zzgkg zzgkgVar, zzgjx zzgjxVar) {
        zzgjxVar.getClass();
        zzgkgVar.zzm = zzgjxVar;
        zzgkgVar.zzb |= 128;
    }

    static /* synthetic */ void zzn(zzgkg zzgkgVar, zzgkf zzgkfVar) {
        zzgkfVar.getClass();
        zzgkgVar.zzt = zzgkfVar;
        zzgkgVar.zzb |= 8192;
    }

    static /* synthetic */ void zzo(zzgkg zzgkgVar, Iterable iterable) {
    ...
    static /* synthetic */ void zzp(zzgkg zzgkgVar, Iterable iterable) {
    ...
    static /* synthetic */ void zzq(zzgkg zzgkgVar, int i) {
        zzgkgVar.zze = i - 1;
        zzgkgVar.zzb |= 1;
    }
