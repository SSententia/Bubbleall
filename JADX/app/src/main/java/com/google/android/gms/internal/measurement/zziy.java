...
final class zziy {
    static String zza(zziw zziwVar, String str) {
    ...
    private static void zzc(zziw zziwVar, StringBuilder sb, int i) {
        boolean zEquals;
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzd(strConcat), zzhr.zzbA(method2, zziwVar, new Object[0]));
                }
            }
            if (strSubstring.endsWith("Map") && !strSubstring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzd(strConcat2), zzhr.zzbA(method3, zziwVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZzbA = zzhr.zzbA(method4, zziwVar, new Object[0]);
                    if (method5 == null) {
                        if (objZzbA instanceof Boolean) {
                            ...
                            } else if (objZzbA instanceof zzgr) {
                                zEquals = objZzbA.equals(zzgr.zzb);
                            } else if (objZzbA instanceof zziw) {
                                if (objZzbA != ((zziw) objZzbA).zzbK()) {
                                    zzb(sb, i, zzd(strConcat3), objZzbA);
                                }
