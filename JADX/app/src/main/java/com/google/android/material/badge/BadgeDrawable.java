...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C1218R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C1218R.attr.badgeStyle;
    ...
    private BadgeDrawable(Context context, int i, int i2, int i3, BadgeState.State state) {
        ...
        setTextAppearanceResource(C1218R.style.TextAppearance_MaterialComponents_Badge);
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C1218R.id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C1218R.id.mtrl_anchor_parent);
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        if (hasNumber()) {
            i = C1218R.dimen.mtrl_badge_text_horizontal_edge_offset;
        } else {
            i = C1218R.dimen.mtrl_badge_horizontal_edge_offset;
        }
    ...
    private String getBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C1218R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
