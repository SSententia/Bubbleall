...
final class zzgfe extends zzgfh {
    private final byte[] zzb;
    private final int zzc;
    private int zzd;

    zzgfe(byte[] bArr, int i, int i2) {
        super(null);
        if (bArr == null) {
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (iZzx2 != iZzx) {
                ...
                byte[] bArr = this.zzb;
                int i2 = this.zzd;
                this.zzd = zzgjd.zzh(str, bArr, i2, this.zzc - i2);
                return;
            }
            int i3 = i + iZzx2;
            this.zzd = i3;
            int iZzh = zzgjd.zzh(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((iZzh - i) - iZzx2);
            this.zzd = iZzh;
        } catch (zzgjc e) {
    ...
    public final void zzn(long j) throws IOException {
        if (zzgfh.zzc && this.zzc - this.zzd >= 10) {
            while ((j & (-128)) != 0) {
                byte[] bArr = this.zzb;
                int i = this.zzd;
                this.zzd = i + 1;
