...
public final class zzedq extends SQLiteOpenHelper {
    ...
    static final /* synthetic */ void zzg(SQLiteDatabase sQLiteDatabase, String str, zzcgy zzcgyVar) {
    ...
    static final /* synthetic */ Void zzh(zzcgy zzcgyVar, SQLiteDatabase sQLiteDatabase) throws Exception {
        zzj(sQLiteDatabase, zzcgyVar);
        return null;
    }
    ...
    private static void zzj(SQLiteDatabase sQLiteDatabase, zzcgy zzcgyVar) {
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                int columnIndex = cursorQuery.getColumnIndex(ImagesContract.URL);
                if (columnIndex != -1) {
                    strArr2[i] = cursorQuery.getString(columnIndex);
                }
                i++;
            }
            cursorQuery.close();
    ...
    final void zza(zzfdw<SQLiteDatabase, Void> zzfdwVar) {
    ...
    final void zzb(final SQLiteDatabase sQLiteDatabase, final zzcgy zzcgyVar, final String str) {
    ...
    final /* synthetic */ Void zzf(zzeds zzedsVar, SQLiteDatabase sQLiteDatabase) throws Exception {
        ContentValues contentValues = new ContentValues();
        ...
        com.google.android.gms.ads.internal.util.zzbu zzbuVarZzD = com.google.android.gms.ads.internal.util.zzs.zzD(this.zza);
        if (zzbuVarZzD != null) {
            try {
                zzbuVarZzD.zzf(ObjectWrapper.wrap(this.zza));
