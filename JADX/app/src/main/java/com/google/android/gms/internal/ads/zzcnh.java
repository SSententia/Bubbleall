...
public final class zzcnh extends zzbhb {
    ...
    private final void zzw(String str, Map<String, String> map) {
        ...
        map2.put("action", str);
        zzchg.zze.execute(new Runnable(this, map2) { // from class: com.google.android.gms.internal.ads.zzcnf
    ...
    /* JADX WARN: Code duplicated, block: B:42:0x004f A[Catch: RemoteException -> 0x0039, all -> 0x006c, TryCatch #0 {RemoteException -> 0x0039, blocks: (B:28:0x0031, B:30:0x0035, B:34:0x003d, B:36:0x0041, B:38:0x0046, B:40:0x004a, B:42:0x004f, B:44:0x0053, B:45:0x0056, B:47:0x005d, B:49:0x0061), top: B:57:0x0031, outer: #1 }] */
    /* JADX WARN: Code duplicated, block: B:44:0x0053 A[Catch: RemoteException -> 0x0039, all -> 0x006c, TryCatch #0 {RemoteException -> 0x0039, blocks: (B:28:0x0031, B:30:0x0035, B:34:0x003d, B:36:0x0041, B:38:0x0046, B:40:0x004a, B:42:0x004f, B:44:0x0053, B:45:0x0056, B:47:0x005d, B:49:0x0061), top: B:57:0x0031, outer: #1 }] */
        ...
        synchronized (this.zzb) {
            ...
            if (z3) {
                try {
                    ...
                    if (z4 && (zzbhfVar4 = this.zzf) != null) {
                        zzbhfVar4.zzf();
                    }
                    if (z6 && (zzbhfVar3 = this.zzf) != null) {
                        zzbhfVar3.zzg();
                    }
                    if (z7) {
                        zzbhfVar2 = this.zzf;
