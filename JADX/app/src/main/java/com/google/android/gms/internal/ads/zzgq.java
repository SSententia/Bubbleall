...
public abstract class zzgq<T> extends zzgi {
    ...
    @Override // com.google.android.gms.internal.ads.zzgi
    protected void zza(zzay zzayVar) {
        this.zzc = zzayVar;
    ...
    public void zzu() throws IOException {
        Iterator<zzgp<T>> it = this.zza.values().iterator();
        while (it.hasNext()) {
            it.next().zza.zzu();
        }
    }

    protected abstract void zzv(T t, zzhh zzhhVar, zzaiq zzaiqVar);

    protected final void zzw(final T t, zzhh zzhhVar) {
    ...
    protected zzhf zzx(T t, zzhf zzhfVar) {
        throw null;
    }
}
