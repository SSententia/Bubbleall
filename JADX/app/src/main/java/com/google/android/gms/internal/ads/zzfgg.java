...
public final class zzfgg extends zzfgc {
    ...
    zzfgg(zzfgd zzfgdVar, zzfge zzfgeVar) {
        this.zzc = zzfgdVar;
        this.zzb = zzfgeVar;
        zzk(null);
    ...
    public final void zzb(View view) {
        ...
        zzk(view);
        this.zzf.zzk();
        Collection<zzfgg> collectionZze = zzfgr.zza().zze();
        if (collectionZze == null || collectionZze.size() <= 0) {
            return;
        }
        for (zzfgg zzfggVar : collectionZze) {
