...
public final class zzayn extends AbstractSafeParcelable {
    ...
    zzayn(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzayn zza(Uri uri) {
        try {
            ...
            return new zzayn(queryParameter, j, host, str, str2, bundle, zEquals, 0L, "", 0);
