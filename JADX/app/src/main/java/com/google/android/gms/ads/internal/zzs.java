...
public final class zzs extends zzbfm {
    ...
    static /* synthetic */ String zzV(zzs zzsVar, String str) {
        if (zzsVar.zzh == null) {
            return str;
        }
        Uri uriZze = Uri.parse(str);
        try {
            uriZze = zzsVar.zzh.zze(uriZze, zzsVar.zzd, null, null);
        } catch (zzaat e) {
            com.google.android.gms.ads.internal.util.zze.zzj("Unable to process ad data", e);
        }
        return uriZze.toString();
    }

    static /* synthetic */ void zzW(zzs zzsVar, String str) {
    ...
    final String zzT() {
        ...
        Map<String, String> mapZze = this.zze.zze();
        for (String str : mapZze.keySet()) {
            builder.appendQueryParameter(str, mapZze.get(str));
        }
        Uri uriBuild = builder.build();
        zzaas zzaasVar = this.zzh;
        if (zzaasVar != null) {
            try {
                uriBuild = zzaasVar.zzc(uriBuild, this.zzd);
            } catch (zzaat e) {
                com.google.android.gms.ads.internal.util.zze.zzj("Unable to process ad data", e);
            }
        }
        ...
        StringBuilder sb = new StringBuilder(strZzU.length() + 1 + String.valueOf(encodedQuery).length());
        sb.append(strZzU);
        sb.append("#");
    ...
    final String zzU() {
        ...
        String strZze = zzbkp.zzd.zze();
        StringBuilder sb = new StringBuilder(String.valueOf(strZza).length() + 8 + String.valueOf(strZze).length());
        sb.append("https://");
        sb.append(strZza);
        sb.append(strZze);
        return sb.toString();
