...
public final class FramedTransport implements Transport {
    ...
    public void writeRequestHeaders(Request request) throws IOException {
        ...
        boolean zPermitsRequestBody = this.httpEngine.permitsRequestBody();
        ...
        FramedStream framedStreamNewStream = framedConnection.newStream(writeNameValueBlock(request, framedConnection.getProtocol(), strVersion), zPermitsRequestBody, true);
