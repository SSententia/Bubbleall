...
public class OkHttpClient implements Cloneable {
    ...
    static {
        Internal.instance = new Internal() { // from class: com.squareup.okhttp.OkHttpClient.1
            ...
            @Override // com.squareup.okhttp.internal.Internal
            public void connectAndSetOwner(OkHttpClient okHttpClient, Connection connection, HttpEngine httpEngine, Request request) throws Throwable {
    ...
    public OkHttpClient() {
        ...
        this.connectTimeout = SessionCommand.COMMAND_CODE_PLAYER_PLAY;
        this.readTimeout = SessionCommand.COMMAND_CODE_PLAYER_PLAY;
        this.writeTimeout = SessionCommand.COMMAND_CODE_PLAYER_PLAY;
