        ...
        private CacheStrategy getCandidate() {
            ...
            if (!cacheControl2.noCache()) {
                ...
                if (j < millis + jComputeFreshnessLifetime) {
                    ...
                    return new CacheStrategy(b7 == true ? 1 : 0, builderNewBuilder.build());
                }
            }
            ...
            return hasConditions(requestBuild) ? new CacheStrategy(requestBuild, this.cacheResponse) : new CacheStrategy(requestBuild, b4 == true ? 1 : 0);
        }
