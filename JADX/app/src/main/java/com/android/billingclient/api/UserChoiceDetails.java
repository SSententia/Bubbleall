...
public final class UserChoiceDetails {
    ...
    public static class Product {
        ...
        private Product(JSONObject jSONObject) {
            this.f150id = jSONObject.optString("productId");
        ...
        public boolean equals(Object obj) {
            ...
            return this.f150id.equals(product.getId()) && this.type.equals(product.getType()) && Objects.equals(this.offerToken, product.getOfferToken());
        }
        ...
        public int hashCode() {
            return Objects.hash(this.f150id, this.type, this.offerToken);
        }

        public String toString() {
            return String.format("{id: %s, type: %s, offer token: %s}", this.f150id, this.type, this.offerToken);
        }
    }
