...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    private static final String f171ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f171ID.getBytes(CHARSET);
