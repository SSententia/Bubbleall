...
class StrictLineReader implements Closeable {
    ...
    private static final byte f151CR = 13;

    /* JADX INFO: renamed from: LF */
    private static final byte f152LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* JADX INFO: renamed from: in */
    private final InputStream f153in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f153in;
        byte[] bArr = this.buf;
