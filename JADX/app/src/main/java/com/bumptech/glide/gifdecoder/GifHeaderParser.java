...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f156ix = readShort();
        this.header.currentFrame.f157iy = readShort();
        this.header.currentFrame.f155iw = readShort();
        this.header.currentFrame.f154ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
