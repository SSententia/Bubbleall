...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    public Resource<Bitmap> decode(InputStream inputStream, int i, int i2, Options options) throws IOException {
        ...
        try {
            return this.downsampler.decode(new MarkEnforcingInputStream(exceptionCatchingInputStreamObtain), i, i2, options, new UntrustedCallbacks(recyclableBufferedInputStream, exceptionCatchingInputStreamObtain));
        } finally {
