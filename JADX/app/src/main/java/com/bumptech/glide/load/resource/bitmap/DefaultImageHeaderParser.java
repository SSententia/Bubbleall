...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    private ImageHeaderParser.ImageType getType(Reader reader) throws IOException {
        ...
        int uInt17 = ((uInt16 << 16) & SupportMenu.CATEGORY_MASK) | (reader.getUInt16() & SupportMenu.USER_MASK);
        ...
        int uInt18 = ((reader.getUInt16() << 16) & SupportMenu.CATEGORY_MASK) | (reader.getUInt16() & SupportMenu.USER_MASK);
        if ((uInt18 & (-256)) != VP8_HEADER) {
            return ImageHeaderParser.ImageType.UNKNOWN;
        }
        int i = uInt18 & 255;
    ...
    private static final class StreamReader implements Reader {
        ...
        public int getUInt16() throws IOException {
            return ((this.f169is.read() << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | (this.f169is.read() & 255);
        }

        @Override // com.bumptech.glide.load.resource.bitmap.DefaultImageHeaderParser.Reader
        public short getUInt8() throws IOException {
            return (short) (this.f169is.read() & 255);
        }
        ...
        public long skip(long j) throws IOException {
            ...
            long j2 = j;
            while (j2 > 0) {
                long jSkip = this.f169is.skip(j2);
                if (jSkip <= 0) {
                    if (this.f169is.read() == -1) {
                        break;
                    }
                    jSkip = 1;
                }
        ...
        public int read(byte[] bArr, int i) throws IOException {
            int i2 = i;
            while (i2 > 0) {
                int i3 = this.f169is.read(bArr, i - i2, i2);
                if (i3 == -1) {
                    break;
                }
                i2 -= i3;
