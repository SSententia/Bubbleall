...
public final class DeflaterSink implements Sink {
    ...
    private void deflate(boolean z) throws IOException {
        ...
        while (true) {
            ...
            if (z) {
                iDeflate = this.deflater.deflate(segmentWritableSegment.data, segmentWritableSegment.limit, 2048 - segmentWritableSegment.limit, 2);
            } else {
                iDeflate = this.deflater.deflate(segmentWritableSegment.data, segmentWritableSegment.limit, 2048 - segmentWritableSegment.limit);
            }
            if (iDeflate > 0) {
