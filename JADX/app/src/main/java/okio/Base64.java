...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        if (length2 == 1) {
            ...
            int i7 = i + 3;
            bArr3[i + 2] = kotlin.p006io.encoding.Base64.padSymbol;
            i += 4;
            bArr3[i7] = kotlin.p006io.encoding.Base64.padSymbol;
        } else if (length2 == 2) {
            bArr3[i] = bArr2[(bArr[length] & UByte.MAX_VALUE) >> 2];
            int i8 = (bArr[length] & 3) << 4;
            int i9 = length + 1;
            bArr3[i + 1] = bArr2[((bArr[i9] & UByte.MAX_VALUE) >> 4) | i8];
            int i10 = i + 3;
            bArr3[i + 2] = bArr2[(bArr[i9] & 15) << 2];
            i += 4;
            bArr3[i10] = kotlin.p006io.encoding.Base64.padSymbol;
        }
        try {
