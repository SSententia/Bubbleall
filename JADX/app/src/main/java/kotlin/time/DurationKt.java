...
public final class DurationKt {
    ...
    private static final long m2208timesmvk6XK0(int i, long j) {
        return Duration.m2119timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2207timeskIfJnKk(double d, long j) {
        return Duration.m2118timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2184getZEROUwyO8pc = Duration.INSTANCE.m2184getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str2.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2117plusLRDsOJo = Duration.m2117plusLRDsOJo(jM2184getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2184getZEROUwyO8pc = Duration.m2117plusLRDsOJo(jM2117plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2184getZEROUwyO8pc = Duration.m2117plusLRDsOJo(jM2184getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z6 = z6;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM2184getZEROUwyO8pc = Duration.INSTANCE.m2182getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                if (z4 && str2.charAt(length2) == '(' && StringsKt.last(str2) == ')') {
                    length2++;
                    int i5 = length - 1;
                    if (length2 == i5) {
                        throw new IllegalArgumentException("No components");
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2117plusLRDsOJo2 = Duration.m2117plusLRDsOJo(jM2184getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2184getZEROUwyO8pc = Duration.m2117plusLRDsOJo(jM2117plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2184getZEROUwyO8pc = Duration.m2117plusLRDsOJo(jM2184getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m2134unaryMinusUwyO8pc(jM2184getZEROUwyO8pc) : jM2184getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2081constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2081constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2081constructorimpl((j << 1) + ((long) i));
    }
