    ...
    public final R runCallLoop() throws Throwable {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m753equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m751constructorimpl(objWrapWithContinuationImpl));
                        }
                    } catch (Throwable th) {
