...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream it = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m541m((Object) directoryStreamNewDirectoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, StreamsKt$$ExternalSyntheticApiModelOutline0.m608m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, "V");
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, StreamsKt$$ExternalSyntheticApiModelOutline0.m608m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) StreamsKt$$ExternalSyntheticApiModelOutline0.m622m(fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
        PathsKt.fileAttributeViewNotAvailable(path, StreamsKt$$ExternalSyntheticApiModelOutline0.m608m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m533m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(this, A::class.java, *options)");
        return (A) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m579m((Object) attributes);
    }
