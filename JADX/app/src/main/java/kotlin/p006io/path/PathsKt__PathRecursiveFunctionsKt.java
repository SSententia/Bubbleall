...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function4 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path3), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path4));
                }
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$3();
            throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m555m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if ((!z2 || !Files.isSameFile(path, target)) && Intrinsics.areEqual(path.getFileSystem(), target.getFileSystem()) && (!z2 ? !((parent = target.getParent()) == null || !Files.exists(parent, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) || !parent.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0]))) : target.toRealPath(new LinkOption[0]).startsWith(path.toRealPath(new LinkOption[0])))) {
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1961m$1();
                throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m548m(path.toString(), target.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
            }
        }
        PathsKt.visitFileTree$default(path, 0, z, new Function1<FileVisitorBuilder, Unit>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5
            ...
            /* synthetic */ class AnonymousClass1 extends FunctionReferenceImpl implements Function2<Path, BasicFileAttributes, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, BasicFileAttributes basicFileAttributes) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m579m((Object) basicFileAttributes));
                }
            ...
            public final void invoke2(FileVisitorBuilder visitFileTree) {
                ...
                visitFileTree.onPostVisitDirectory(new Function2<Path, IOException, FileVisitResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.5.4
                    ...
                    public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path4, IOException iOException) {
                        return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path4), iOException);
                    }
            ...
            /* synthetic */ class AnonymousClass3 extends FunctionReferenceImpl implements Function2<Path, Exception, FileVisitResult> {
                ...
                public /* bridge */ /* synthetic */ FileVisitResult invoke(Path path, Exception exc) {
                    return invoke2(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m((Object) path), exc);
                }
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        if (!listDeleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            FileSystemException fileSystemExceptionM547m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m547m("Failed to delete one or more files. See suppressed exceptions for details.");
            Iterator<T> it = listDeleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.iterator();
            while (it.hasNext()) {
                ExceptionsKt.addSuppressed(fileSystemExceptionM547m, (Exception) it.next());
            }
            throw fileSystemExceptionM547m;
        }
    }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) throws IOException {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    DirectoryStream directoryStreamM541m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m541m((Object) directoryStream);
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m596m((Object) directoryStreamM541m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM574m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m574m((Object) directoryStreamM541m);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "this.fileName");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM574m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            if (secureDirectoryStreamNewDirectoryStream != null) {
                ...
                try {
                    SecureDirectoryStream secureDirectoryStreamM574m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m574m((Object) secureDirectoryStream2);
                    Iterator it = secureDirectoryStreamM574m.iterator();
                    while (it.hasNext()) {
                        Path fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m(it.next()).getFileName();
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m578m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                DirectoryStream directoryStream = directoryStreamNewDirectoryStream;
                try {
                    Iterator it = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m541m((Object) directoryStream).iterator();
                    while (it.hasNext()) {
                        Path entry = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m556m(it.next());
