...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    /* JADX INFO: compiled from: Sequences.kt */
    @Metadata(m494d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlin/sequences/SequenceScope;"}, m496k = 3, m497mv = {1, 9, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlin.sequences.SequencesKt__SequencesKt$ifEmpty$1", m512f = "Sequences.kt", m513i = {}, m514l = {69, 71}, m515m = "invokeSuspend", m516n = {}, m517s = {})
    static final class C17371<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C17371(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C17371> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C17371 c17371 = new C17371(this.$this_ifEmpty, this.$defaultValue, continuation);
            c17371.L$0 = obj;
            return c17371;
        }
        ...
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C17371) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C17371(sequence, defaultValue, null));
    }
    ...
    public static final <T, R> Pair<List<T>, List<R>> unzip(Sequence<? extends Pair<? extends T, ? extends R>> sequence) {
        ...
        return TuplesKt.m502to(arrayList, arrayList2);
    }
    ...
    /* JADX INFO: compiled from: Sequences.kt */
    @Metadata(m494d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Lkotlin/sequences/SequenceScope;"}, m496k = 3, m497mv = {1, 9, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlin.sequences.SequencesKt__SequencesKt$shuffled$1", m512f = "Sequences.kt", m513i = {0, 0}, m514l = {Cea708CCParser.Const.CODE_C1_SPC}, m515m = "invokeSuspend", m516n = {"$this$sequence", "buffer"}, m517s = {"L$0", "L$1"})
    static final class C17381<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C17381(Sequence<? extends T> sequence, Random random, Continuation<? super C17381> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C17381 c17381 = new C17381(this.$this_shuffled, this.$random, continuation);
            c17381.L$0 = obj;
            return c17381;
        }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C17381(sequence, random, null));
    }

    /* JADX INFO: Add missing generic type declarations: [R] */
    /* JADX INFO: renamed from: kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1 */
    /* JADX INFO: compiled from: Sequences.kt */
    @Metadata(m494d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\b\u0012\u0004\u0012\u0002H\u00040\u0005H\u008a@"}, m495d2 = {"<anonymous>", "", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "C", "R", "Lkotlin/sequences/SequenceScope;"}, m496k = 3, m497mv = {1, 9, 0}, m499xi = 48)
    @DebugMetadata(m511c = "kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1", m512f = "Sequences.kt", m513i = {0, 0}, m514l = {332}, m515m = "invokeSuspend", m516n = {"$this$sequence", "index"}, m517s = {"L$0", "I$0"})
    static final class C17311<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C17311(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C17311> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C17311 c17311 = new C17311(this.$source, this.$transform, this.$iterator, continuation);
            c17311.L$0 = obj;
            return c17311;
        }
        ...
        public final Object invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C17311) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C17311(source, transform, iterator, null));
    }
