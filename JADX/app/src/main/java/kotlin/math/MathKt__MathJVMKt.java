...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m604ln(double d) {
        return Math.log(d);
    }
    ...
    /* JADX INFO: renamed from: ln */
    private static final float m605ln(float f) {
