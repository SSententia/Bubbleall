...
.method private static final listenerConfig$lambda$0(Lcom/alexmanzana/bubbleall/views/AddView;Landroid/content/Context;)V
    ...
    # pick-from-gallery row: theme tint on its texts and icon (v6 = saved Context)
    sget v7, Lcom/alexmanzana/bubbleall/R$id;->pickGalleryTitle:I
    ...
    sget v7, Lcom/alexmanzana/bubbleall/R$id;->pickGalleryDesc:I
    ...
    sget v7, Lcom/alexmanzana/bubbleall/R$id;->pickGalleryState:I
    ...
    sget v7, Lcom/alexmanzana/bubbleall/R$id;->pickGalleryImage:I
    ...
    # the toggle itself: button and state label in v7/v8, then the app's plain and current item
    # backgrounds -- the same contiguous five-register shape as the crop row just above, so this
    # adds no new outs_size to the method (see the outs trap in knowledge.md).
    sget v7, Lcom/alexmanzana/bubbleall/R$id;->pickGallery:I

    invoke-virtual {p0, v7}, Lcom/alexmanzana/bubbleall/views/AddView;->findViewById(I)Landroid/view/View;

    move-result-object v7

    sget v8, Lcom/alexmanzana/bubbleall/R$id;->pickGalleryState:I
    ...
    invoke-static {v6, v7, v8, v9, v10}, Lcom/alexmanzana/bubbleall/views/PickGalleryOption;->bind(Landroid/content/Context;Landroid/view/View;Landroid/view/View;II)V
