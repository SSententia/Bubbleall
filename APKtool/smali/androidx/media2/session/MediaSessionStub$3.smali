...
.method public run(Landroidx/media2/session/MediaSession$MediaSessionImpl;Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Integer;
    ...
    iget p2, p0, Landroidx/media2/session/MediaSessionStub$3;->val$value:I

    iget v0, p0, Landroidx/media2/session/MediaSessionStub$3;->val$flags:I

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/media/session/MediaControllerCompat;->setVolumeTo(II)V
...
.method public bridge synthetic run(Landroidx/media2/session/MediaSession$MediaSessionImpl;Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Object;
    ...
    .line 491
    invoke-virtual {p0, p1, p2}, Landroidx/media2/session/MediaSessionStub$3;->run(Landroidx/media2/session/MediaSession$MediaSessionImpl;Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Integer;
